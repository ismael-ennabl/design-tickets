var x0=Object.defineProperty;var xh=o=>{throw TypeError(o)};var S0=(o,l,i)=>l in o?x0(o,l,{enumerable:!0,configurable:!0,writable:!0,value:i}):o[l]=i;var je=(o,l,i)=>S0(o,typeof l!="symbol"?l+"":l,i),w0=(o,l,i)=>l.has(o)||xh("Cannot "+i);var Sh=(o,l,i)=>l.has(o)?xh("Cannot add the same private member more than once"):l instanceof WeakSet?l.add(o):l.set(o,i);var Ni=(o,l,i)=>(w0(o,l,"access private method"),i);(function(){const l=document.createElement("link").relList;if(l&&l.supports&&l.supports("modulepreload"))return;for(const u of document.querySelectorAll('link[rel="modulepreload"]'))s(u);new MutationObserver(u=>{for(const d of u)if(d.type==="childList")for(const f of d.addedNodes)f.tagName==="LINK"&&f.rel==="modulepreload"&&s(f)}).observe(document,{childList:!0,subtree:!0});function i(u){const d={};return u.integrity&&(d.integrity=u.integrity),u.referrerPolicy&&(d.referrerPolicy=u.referrerPolicy),u.crossOrigin==="use-credentials"?d.credentials="include":u.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function s(u){if(u.ep)return;u.ep=!0;const d=i(u);fetch(u.href,d)}})();function C0(o){return o&&o.__esModule&&Object.prototype.hasOwnProperty.call(o,"default")?o.default:o}var Yc={exports:{}},Ti={};/**
 * @license React
 ...
 */var wh;function N0(){if(wh)return Ti;wh=1;var o=Symbol.for("react.transitional.element"),l=Symbol.for("react.fragment");function i(s,u,d){var f=null;if(d!==void 0&&(f=""+d),u.key!==void 0&&(f=""+u.key),"key"in u){d={};for(var h in u)h!=="key"&&(d[h]=u[h])}else d=u;return u=d.ref,{$$typeof:o,type:s,key:f,ref:u!==void 0?u:null,props:d}}return Ti.Fragment=l,Ti.jsx=i,Ti.jsxs=i,Ti}var Ch;function T0(){return Ch||(Ch=1,Yc.exports=N0()),Yc.exports}var v=T0(),Gc={exports:{}},re={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Nh;function E0(){if(Nh)return re;Nh=1;var o=Symbol.for("react.transitional.element"),l=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),u=Symbol.for("react.profiler"),d=Symbol.for("react.consumer"),f=Symbol.for("react.context"),h=Symbol.for("react.forward_ref"),g=Symbol.for("react.suspense"),b=Symbol.for("react.memo"),y=Symbol.for("react.lazy"),x=Symbol.for("react.activity"),A=Symbol.iterator;function E(w){return w===null||typeof w!="object"?null:(w=A&&w[A]||w["@@iterator"],typeof w=="function"?w:null)}var _={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},z=Object.assign,V={};function B(w,j,Z){this.props=w,this.context=j,this.refs=V,this.updater=Z||_}B.prototype.isReactComponent={},B.prototype.setState=function(w,j){if(typeof w!="object"&&typeof w!="function"&&w!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,w,j,"setState")},B.prototype.forceUpdate=function(w){this.updater.enqueueForceUpdate(this,w,"forceUpdate")};function Q(){}Q.prototype=B.prototype;function K(w,j,Z){this.props=w,this.context=j,this.refs=V,this.updater=Z||_}var I=K.prototype=new Q;I.constructor=K,z(I,B.prototype),I.isPureReactComponent=!0;var X=Array.isArray;function G(){}var Y={H:null,A:null,T:null,S:null},J=Object.prototype.hasOwnProperty;function ne(w,j,Z){var $=Z.ref;return{$$typeof:o,type:w,key:j,ref:$!==void 0?$:null,props:Z}}function pe(w,j){return ne(w.type,j,w.props)}function oe(w){return typeof w=="object"&&w!==null&&w.$$typeof===o}function De(w){var j={"=":"=0",":":"=2"};return"$"+w.replace(/[=:]/g,function(Z){return j[Z]})}var Ge=/\/+/g;function He(w,j){return typeof w=="object"&&w!==null&&w.key!=null?De(""+w.key):j.toString(36)}function Fe(w){switch(w.status){case"fulfilled":return w.value;case"rejected":throw w.reason;default:switch(typeof w.status=="string"?w.then(G,G):(w.status="pending",w.then(function(j){w.status==="pending"&&(w.status="fulfilled",w.value=j)},function(j){w.status==="pending"&&(w.status="rejected",w.reason=j)})),w.status){case"fulfilled":return w.value;case"rejected":throw w.reason}}throw w}function M(w,j,Z,$,ie){var le=typeof w;(le==="undefined"||le==="boolean")&&(w=null);var me=!1;if(w===null)me=!0;else switch(le){case"bigint":case"string":case"number":me=!0;break;case"object":switch(w.$$typeof){case o:case l:me=!0;break;case y:return me=w._init,M(me(w._payload),j,Z,$,ie)}}if(me)return ie=ie(w),me=$===""?"."+He(w,0):$,X(ie)?(Z="",me!=null&&(Z=me.replace(Ge,"$&/")+"/"),M(ie,j,Z,"",function(ve){return ve})):ie!=null&&(oe(ie)&&(ie=pe(ie,Z+(ie.key==null||w&&w.key===ie.key?"":(""+ie.key).replace(Ge,"$&/")+"/")+me)),j.push(ie)),1;me=0;var Ue=$===""?".":$+":";if(X(w))for(var Se=0;Se<w.length;Se++)$=w[Se],le=Ue+He($,Se),me+=M($,j,Z,le,ie);else if(Se=E(w),typeof Se=="function")for(w=Se.call(w),Se=0;!($=w.next()).done;)$=$.value,le=Ue+He($,Se++),me+=M($,j,Z,le,ie);else if(le==="object"){if(typeof w.then=="function")return M(Fe(w),j,Z,$,ie);throw j=String(w),Error("Objects are not valid as a React child (found: "+(j==="[object Object]"?"object with keys {"+Object.keys(w).join(", ")+"}":j)+"). If you meant to render a collection of children, use an array instead.")}return me}function q(w,j,Z){if(w==null)return w;var $=[],ie=0;return M(w,$,"","",function(le){return j.call(Z,le,ie++)}),$}function F(w){if(w._status===-1){var j=w._result;j=j(),j.then(function(Z){(w._status===0||w._status===-1)&&(w._status=1,w._result=Z)},function(Z){(w._status===0||w._status===-1)&&(w._status=2,w._result=Z)}),w._status===-1&&(w._status=0,w._result=j)}if(w._status===1)return w._result.default;throw w._result}var ee=typeof reportError=="function"?reportError:function(w){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var j=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof w=="object"&&w!==null&&typeof w.message=="string"?String(w.message):String(w),error:w});if(!window.dispatchEvent(j))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",w);return}console.error(w)},se={map:q,forEach:function(w,j,Z){q(w,function(){j.apply(this,arguments)},Z)},count:function(w){var j=0;return q(w,function(){j++}),j},toArray:function(w){return q(w,function(j){return j})||[]},only:function(w){if(!oe(w))throw Error("React.Children.only expected to receive a single React element child.");return w}};return re.Activity=x,re.Children=se,re.Component=B,re.Fragment=i,re.Profiler=u,re.PureComponent=K,re.StrictMode=s,re.Suspense=g,re.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=Y,re.__COMPILER_RUNTIME={__proto__:null,c:function(w){return Y.H.useMemoCache(w)}},re.cache=function(w){return function(){return w.apply(null,arguments)}},re.cacheSignal=function(){return null},re.cloneElement=function(w,j,Z){if(w==null)throw Error("The argument must be a React element, but you passed "+w+".");var $=z({},w.props),ie=w.key;if(j!=null)for(le in j.key!==void 0&&(ie=""+j.key),j)!J.call(j,le)||le==="key"||le==="__self"||le==="__source"||le==="ref"&&j.ref===void 0||($[le]=j[le]);var le=arguments.length-2;if(le===1)$.children=Z;else if(1<le){for(var me=Array(le),Ue=0;Ue<le;Ue++)me[Ue]=arguments[Ue+2];$.children=me}return ne(w.type,ie,$)},re.createContext=function(w){return w={$$typeof:f,_currentValue:w,_currentValue2:w,_threadCount:0,Provider:null,Consumer:null},w.Provider=w,w.Consumer={$$typeof:d,_context:w},w},re.createElement=function(w,j,Z){var $,ie={},le=null;if(j!=null)for($ in j.key!==void 0&&(le=""+j.key),j)J.call(j,$)&&$!=="key"&&$!=="__self"&&$!=="__source"&&(ie[$]=j[$]);var me=arguments.length-2;if(me===1)ie.children=Z;else if(1<me){for(var Ue=Array(me),Se=0;Se<me;Se++)Ue[Se]=arguments[Se+2];ie.children=Ue}if(w&&w.defaultProps)for($ in me=w.defaultProps,me)ie[$]===void 0&&(ie[$]=me[$]);return ne(w,le,ie)},re.createRef=function(){return{current:null}},re.forwardRef=function(w){return{$$typeof:h,render:w}},re.isValidElement=oe,re.lazy=function(w){return{$$typeof:y,_payload:{_status:-1,_result:w},_init:F}},re.memo=function(w,j){return{$$typeof:b,type:w,compare:j===void 0?null:j}},re.startTransition=function(w){var j=Y.T,Z={};Y.T=Z;try{var $=w(),ie=Y.S;ie!==null&&ie(Z,$),typeof $=="object"&&$!==null&&typeof $.then=="function"&&$.then(G,ee)}catch(le){ee(le)}finally{j!==null&&Z.types!==null&&(j.types=Z.types),Y.T=j}},re.unstable_useCacheRefresh=function(){return Y.H.useCacheRefresh()},re.use=function(w){return Y.H.use(w)},re.useActionState=function(w,j,Z){return Y.H.useActionState(w,j,Z)},re.useCallback=function(w,j){return Y.H.useCallback(w,j)},re.useContext=function(w){return Y.H.useContext(w)},re.useDebugValue=function(){},re.useDeferredValue=function(w,j){return Y.H.useDeferredValue(w,j)},re.useEffect=function(w,j){return Y.H.useEffect(w,j)},re.useEffectEvent=function(w){return Y.H.useEffectEvent(w)},re.useId=function(){return Y.H.useId()},re.useImperativeHandle=function(w,j,Z){return Y.H.useImperativeHandle(w,j,Z)},re.useInsertionEffect=function(w,j){return Y.H.useInsertionEffect(w,j)},re.useLayoutEffect=function(w,j){return Y.H.useLayoutEffect(w,j)},re.useMemo=function(w,j){return Y.H.useMemo(w,j)},re.useOptimistic=function(w,j){return Y.H.useOptimistic(w,j)},re.useReducer=function(w,j,Z){return Y.H.useReducer(w,j,Z)},re.useRef=function(w){return Y.H.useRef(w)},re.useState=function(w){return Y.H.useState(w)},re.useSyncExternalStore=function(w,j,Z){return Y.H.useSyncExternalStore(w,j,Z)},re.useTransition=function(){return Y.H.useTransition()},re.version="19.2.6",re}var Th;function cu(){return Th||(Th=1,Gc.exports=E0()),Gc.exports}var N=cu();const qe=C0(N);var Xc={exports:{}},Ei={},Vc={exports:{}},Qc={};/**
 * @license React
...
`)}}}fences(l){const i=this.rules.block.fences.exec(l);if(i){const s=i[0],u=B0(s,i[3]||"");return{type:"code",raw:s,lang:i[2]?i[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):i[2],text:u}}}heading(l){const i=this.rules.block.heading.exec(l);if(i){let s=i[2].trim();if(/#$/.test(s)){const u=Di(s,"#");(this.options.pedantic||!u||/ $/.test(u))&&(s=u.trim())}return{type:"heading",raw:i[0],depth:i[1].length,text:s,tokens:this.lexer.inline(s)}}}hr(l){const i=this.rules.block.hr.exec(l);if(i)return{type:"hr",raw:Di(i[0],`
...
`,l=l.substring(A.length+1),g=!0),!g){const B=new RegExp(`^ {0,${Math.min(3,_-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),Q=new RegExp(`^ {0,${Math.min(3,_-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),K=new RegExp(`^ {0,${Math.min(3,_-1)}}(?:\`\`\`|~~~)`),I=new RegExp(`^ {0,${Math.min(3,_-1)}}#`);for(;l;){const X=l.split(`
`,1)[0];if(A=X,this.options.pedantic&&(A=A.replace(/^ {1,4}(?=( {4})*[^ ])/g,"  ")),K.test(A)||I.test(A)||B.test(A)||Q.test(l))break;if(A.search(/[^ ]/)>=_||!A.trim())y+=`
`+A.slice(_);else{if(E||x.search(/[^ ]/)>=4||K.test(x)||I.test(x)||Q.test(x))break;y+=`
`+A}!E&&!A.trim()&&(E=!0),b+=X+`
...
`,mv=`// Icons used across the prototype — small inline SVGs matching Ennabl's icon style
...
`,bv=`// Template picker — trigger button + dropdown menu with search,
...
`,vv=`// Modals — Save-as-template dialog, Save-changes confirm, Manage modal.
...
`,yv=`// Step 3 body — Producer Team table + Additional Information block.
...
`,xv=hv.replace(/@font-face\s*\{[^}]*\}/g,""),Sv=`
<script>
...
<\/script>`;function wv(o){return`<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
...
${o.code}
`,u=new Blob([s],{type:"text/plain"}),d=URL.createObjectURL(u);Object.assign(document.createElement("a"),{href:d,download:i}).click(),URL.revokeObjectURL(d)}function Av(o){const l=Math.floor((Date.now()-new Date(o))/6e4);if(l<1)return"just now";if(l<60)return`${l}m ago`;const i=Math.floor(l/60);return i<24?`${i}h ago`:`${Math.floor(i/24)}d ago`}function Rv(o){return o.split(`
`).slice(0,3).join(`
`).slice(0,140)}function kv({entries:o,onClear:l}){const[i,s]=N.useState(null);function u(d){navigator.clipboard.writeText(d.code),s(d.id),setTimeout(()=>s(null),2e3)}return o.length===0?v.jsxs("div",{className:"sb-empty",children:[v.jsx("p",{children:"No components yet"}),v.jsx("span",{children:"Each generated UI is logged here. Download or copy the JSX to use in your codebase."})]}):v.jsxs("div",{className:"sb-tab",children:[v.jsxs("div",{className:"sb-toolbar",children:[v.jsxs("span",{className:"sb-count",children:[o.length," snapshot",o.length!==1?"s":""]}),v.jsx("button",{className:"sb-clear",onClick:l,children:"clear all"})]}),v.jsx("div",{className:"sb-list",children:o.map(d=>v.jsxs("div",{className:"sb-entry",children:[v.jsxs("div",{className:"sb-entry-top",children:[v.jsx("span",{className:"sb-entry-name",children:d.prdName.replace(/\.md$/i,"")}),v.jsxs("span",{className:"sb-entry-badge",children:["v",d.iteration]}),v.jsx("span",{className:"sb-entry-time",children:Av(d.timestamp)})]}),v.jsx("pre",{className:"sb-entry-code",children:Rv(d.code)}),v.jsxs("div",{className:"sb-entry-actions",children:[v.jsx("button",{className:"sb-btn",onClick:()=>u(d),children:i===d.id?"✓ copied":"copy"}),v.jsx("button",{className:"sb-btn sb-btn--primary",onClick:()=>Dv(d),children:"↓ .jsx"})]})]},d.id))})]})}function Ov({entries:o}){return v.jsx("div",{className:"figma-tab",children:v.jsxs("div",{className:"figma-coming",children:[v.jsx("div",{className:"figma-icon",children:"◈"}),v.jsx("p",{children:"Figma sync"}),v.jsx("span",{children:"Will push each generated component into your Figma file as a frame — auto-named by PRD and iteration, grouped in a dedicated page. Requires a Figma access token."}),v.jsx("div",{className:"figma-queue",children:o.length>0?v.jsxs(v.Fragment,{children:[v.jsxs("span",{className:"figma-queue-label",children:[o.length," snapshot",o.length!==1?"s":""," queued"]}),v.jsx("button",{className:"figma-btn",disabled:!0,children:"Connect Figma to push"})]}):v.jsx("span",{className:"figma-queue-label",children:"Generate a UI first"})})]})})}function zv({code:o,prd:l,history:i,onHistoryClear:s,onInitDesign:u}){const[d,f]=N.useState("design");return v.jsxs("div",{className:"left-panel",children:[v.jsxs("div",{className:"left-tabs",children:[v.jsx("button",{className:`left-tab ${d==="design"?"left-tab--active":""}`,onClick:()=>f("design"),children:"Design"}),v.jsx("button",{className:`left-tab ${d==="prd"?"left-tab--active":""} ${l?"":"left-tab--disabled"}`,onClick:()=>l&&f("prd"),children:l?l.name:"PRD"}),v.jsxs("button",{className:`left-tab ${d==="storybook"?"left-tab--active":""}`,onClick:()=>f("storybook"),children:["Storybook",i.length>0&&v.jsx("span",{className:"left-tab-count",children:i.length})]}),v.jsx("button",{className:`left-tab ${d==="figma"?"left-tab--active":""}`,onClick:()=>f("figma"),children:"Figma"})]}),v.jsxs("div",{className:"left-content",children:[v.jsx("div",{className:`left-canvas-wrap ${d!=="design"?"left-canvas-wrap--hidden":""}`,children:v.jsx(Cv,{code:o,prd:l,onInitDesign:u})}),d==="prd"&&l&&v.jsx("div",{className:"prd-view",dangerouslySetInnerHTML:{__html:Ee.parse(l.content)}}),d==="prd"&&!l&&v.jsx("div",{className:"prd-empty",children:"No PRD loaded"}),d==="storybook"&&v.jsx(kv,{entries:i,onClear:s}),d==="figma"&&v.jsx(Ov,{entries:i})]})]})}const Sg="ennabl_builder_api_key",wg=()=>localStorage.getItem(Sg)||"",jv=o=>localStorage.setItem(Sg,o.trim()),Cg="ennabl_builder_model",Mv=[{id:"claude-haiku-4-5-20251001",label:"Haiku",note:"dev / fast"},{id:"claude-sonnet-4-6",label:"Sonnet",note:"balanced"},{id:"claude-opus-4-7",label:"Opus",note:"prod / best"}],_v="claude-haiku-4-5-20251001",Ng=()=>localStorage.getItem(Cg)||_v,Uv=o=>localStorage.setItem(Cg,o),Lv=`# ennabl Design Tokens
...
`,Bv=`You are an expert UI engineer for ennabl, an insurance analytics platform for insurance agencies and brokers.
...
The generated code runs inside a Vite + React app. The ennabl design system CSS (colors_and_type.css + styles.css) is already loaded globally — you can use all \`--en-*\` variables and \`.en-*\` classes directly without importing them.`,Yv="https://api.anthropic.com/v1/messages";function Gv(o){return o==="claude-opus-4-7"?{max_tokens:8192,thinking:{type:"enabled",budget_tokens:5e3}}:{max_tokens:8192}}async function Xv({messages:o,onText:l,onDone:i}){var y,x,A,E,_,z,V;const s=Ng(),u=await fetch(Yv,{method:"POST",headers:{"Content-Type":"application/json","x-api-key":wg(),"anthropic-version":"2023-06-01","anthropic-dangerous-direct-browser-access":"true"},body:JSON.stringify({model:s,...Gv(s),system:[{type:"text",text:Bv,cache_control:{type:"ephemeral"}}],messages:o,stream:!0})});if(!u.ok){const B=await u.json().catch(()=>({}));throw new Error(((y=B.error)==null?void 0:y.message)||`API error ${u.status}`)}const d=u.body.getReader(),f=new TextDecoder;let h=0,g=0,b=0;for(;;){const{done:B,value:Q}=await d.read();if(B)break;const K=f.decode(Q).split(`
`);for(const I of K){if(!I.startsWith("data: "))continue;const X=I.slice(6).trim();if(!(!X||X==="[DONE]"))try{const G=JSON.parse(X);G.type==="message_start"&&(h=((A=(x=G.message)==null?void 0:x.usage)==null?void 0:A.input_tokens)??0,b=((_=(E=G.message)==null?void 0:E.usage)==null?void 0:_.cache_read_input_tokens)??0),G.type==="content_block_delta"&&((z=G.delta)==null?void 0:z.type)==="text_delta"&&l(G.delta.text),G.type==="message_delta"&&(g=((V=G.usage)==null?void 0:V.output_tokens)??0)}catch{}}}i({inputTokens:h,outputTokens:g,cacheReadTokens:b})}const Tg="ennabl_builder_reports",Kc={input:15/1e6,output:75/1e6,cacheRead:1.5/1e6};function Vv({inputTokens:o=0,outputTokens:l=0,cacheReadTokens:i=0}){return Math.max(0,o-i)*Kc.input+i*Kc.cacheRead+l*Kc.output}function Qv(o){return{id:`s_${Date.now()}`,prdName:o,startedAt:new Date().toISOString(),iterations:0,inputTokens:0,outputTokens:0,cacheReadTokens:0,cost:0,componentsUsed:[],rating:null,accepted:!1}}function Eg(){try{return JSON.parse(localStorage.getItem(Tg)||"{}")}catch{return{}}}function Zv(o){localStorage.setItem(Tg,JSON.stringify(o))}function nu(o){const l=Eg(),i=o.prdName;l[i]||(l[i]=[]);const s=l[i].findIndex(u=>u.id===o.id);s>=0?l[i][s]=o:l[i].unshift(o),Zv(l)}function Ic(o){return Eg()[o]||[]}function Kv(o){return o?["CollapsibleSection","EditableField","TemplatePicker","SaveTemplateDialog","UpdateTemplateDialog","ManageModal","DeleteConfirm","Step3Body","ProducerTable"].filter(i=>o.includes(i)):[]}function Iv(o){if(!o.length)return null;const l=o.filter(i=>i.accepted&&i.iterations<=2).length;return Math.round(l/o.length*100)}function Jv(o){const l=o.match(/```(?:jsx?|tsx?|javascript|typescript)?\n([\s\S]*?)```/);return l?l[1].trim():null}function $v({prd:o,messages:l,setMessages:i,onCodeGenerated:s,onSwitchToPrd:u,onIterationComplete:d,initTrigger:f}){const[h,g]=N.useState(""),[b,y]=N.useState(!1),[x,A]=N.useState(Ng),E=N.useRef(null),_=N.useRef(null);N.useEffect(()=>{var B;(B=E.current)==null||B.scrollIntoView({behavior:"smooth"})},[l]),N.useEffect(()=>{f>0&&o&&!b&&z("Build a complete UI from this PRD.")},[f]);async function z(B){const Q=(B??h).trim();if(!Q||b)return;const K={role:"user",content:Q},I=o?`
...
`,status:"doing",createdAt:new Date(Date.now()-1440*60*1e3).toISOString(),updatedAt:new Date(Date.now()-7200*1e3).toISOString()}];function iu(){try{return JSON.parse(localStorage.getItem(jg)||"[]")}catch{return[]}}function ur(o){localStorage.setItem(jg,JSON.stringify(o))}function Kh(){iu().length===0&&ur(Dy)}function Ug(o){return Mg.find(l=>l.id===o)||null}function Ay({prds:o=[],onSelect:l}){const[i,s]=N.useState(""),[u,d]=N.useState([]),[f,h]=N.useState(!1),[g,b]=N.useState(0),y=N.useRef(),x=N.useRef();N.useEffect(()=>{if(!i.trim()){d([]),h(!1);return}const E=i.toLowerCase(),_=o.filter(z=>z.title.toLowerCase().includes(E)).slice(0,8);d(_),h(_.length>0),b(0)},[i,o]),N.useEffect(()=>{function E(_){f&&(_.key==="ArrowDown"&&(_.preventDefault(),b(z=>Math.min(z+1,u.length-1))),_.key==="ArrowUp"&&(_.preventDefault(),b(z=>Math.max(z-1,0))),_.key==="Enter"&&(_.preventDefault(),u[g]&&A(u[g])),_.key==="Escape"&&h(!1))}return window.addEventListener("keydown",E),()=>window.removeEventListener("keydown",E)},[f,u,g]),N.useEffect(()=>{function E(_){var z,V;!((z=x.current)!=null&&z.contains(_.target))&&!((V=y.current)!=null&&V.contains(_.target))&&h(!1)}return document.addEventListener("mousedown",E),()=>document.removeEventListener("mousedown",E)},[]);function A(E){var _;l(E),s(""),h(!1),(_=y.current)==null||_.blur()}return v.jsxs("div",{className:"prd-search",children:[v.jsxs("div",{className:"prd-search-input-wrap",children:[v.jsx("span",{className:"prd-search-icon",children:"⌕"}),v.jsx("input",{ref:y,className:"prd-search-input",type:"text",placeholder:"Search PRDs…",value:i,onChange:E=>s(E.target.value),onFocus:()=>{u.length&&h(!0)}}),i&&v.jsx("button",{className:"prd-search-clear",onClick:()=>{s(""),h(!1)},children:"✕"})]}),f&&v.jsx("div",{ref:x,className:"prd-search-dropdown",children:u.map((E,_)=>{const z=Ug(E.projectId);return v.jsxs("button",{className:`prd-search-result ${_===g?"prd-search-result--active":""}`,onMouseEnter:()=>b(_),onClick:()=>A(E),children:[v.jsx("span",{className:"prd-search-result-title",children:E.title}),v.jsxs("span",{className:"prd-search-result-project",children:[z==null?void 0:z.icon," ",z==null?void 0:z.name]})]},E.id)})})]})}function Ry({prds:o,onNavigate:l}){return v.jsxs("div",{className:"projects-page",children:[v.jsx("header",{className:"projects-header",children:v.jsxs("div",{className:"projects-logo",children:[v.jsx("span",{className:"projects-logo-name",children:"ennabl"}),v.jsx("span",{className:"projects-logo-suffix",children:"builder"})]})}),v.jsxs("main",{className:"projects-main",children:[v.jsx("h1",{className:"projects-title",children:"Projects"}),v.jsx("div",{className:"projects-grid",children:Mg.map(i=>{const s=o.filter(d=>d.projectId===i.id),u=s.filter(d=>d.status==="doing").length;return v.jsxs("button",{className:"project-card",onClick:()=>l({page:"project",projectId:i.id}),children:[v.jsx("div",{className:"project-card-icon",children:i.icon}),v.jsx("div",{className:"project-card-name",children:i.name}),v.jsx("div",{className:"project-card-meta",children:s.length>0?v.jsxs(v.Fragment,{children:[v.jsxs("span",{className:"project-card-count",children:[s.length," PRD",s.length!==1?"s":""]}),u>0&&v.jsxs("span",{className:"project-card-doing",children:[u," doing"]})]}):v.jsx("span",{className:"project-card-empty",children:"No PRDs yet"})})]},i.id)})})]})]})}var Ri=rg();function ky(){for(var o=arguments.length,l=new Array(o),i=0;i<o;i++)l[i]=arguments[i];return N.useMemo(()=>s=>{l.forEach(u=>u(s))},l)}const Cr=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";function kl(o){const l=Object.prototype.toString.call(o);return l==="[object Window]"||l==="[object global]"}function wu(o){return"nodeType"in o}function vt(o){var l,i;return o?kl(o)?o:wu(o)&&(l=(i=o.ownerDocument)==null?void 0:i.defaultView)!=null?l:window:window}function Cu(o){const{Document:l}=vt(o);return o instanceof l}function Hi(o){return kl(o)?!1:o instanceof vt(o).HTMLElement}function Lg(o){return o instanceof vt(o).SVGElement}function Ol(o){return o?kl(o)?o.document:wu(o)?Cu(o)?o:Hi(o)||Lg(o)?o.ownerDocument:document:document:document}const on=Cr?N.useLayoutEffect:N.useEffect;function Nr(o){const l=N.useRef(o);return on(()=>{l.current=o}),N.useCallback(function(){for(var i=arguments.length,s=new Array(i),u=0;u<i;u++)s[u]=arguments[u];return l.current==null?void 0:l.current(...s)},[])}function Oy(){const o=N.useRef(null),l=N.useCallback((s,u)=>{o.current=setInterval(s,u)},[]),i=N.useCallback(()=>{o.current!==null&&(clearInterval(o.current),o.current=null)},[]);return[l,i]}function _i(o,l){l===void 0&&(l=[o]);const i=N.useRef(o);return on(()=>{i.current!==o&&(i.current=o)},l),i}function Bi(o,l){const i=N.useRef();return N.useMemo(()=>{const s=o(i.current);return i.current=s,s},[...l])}function gr(o){const l=Nr(o),i=N.useRef(null),s=N.useCallback(u=>{u!==i.current&&(l==null||l(u,i.current)),i.current=u},[]);return[i,s]}function mr(o){const l=N.useRef();return N.useEffect(()=>{l.current=o},[o]),l.current}let $c={};function Yi(o,l){return N.useMemo(()=>{if(l)return l;const i=$c[o]==null?0:$c[o]+1;return $c[o]=i,o+"-"+i},[o,l])}function qg(o){return function(l){for(var i=arguments.length,s=new Array(i>1?i-1:0),u=1;u<i;u++)s[u-1]=arguments[u];return s.reduce((d,f)=>{const h=Object.entries(f);for(const[g,b]of h){const y=d[g];y!=null&&(d[g]=y+o*b)}return d},{...l})}}const Rl=qg(1),br=qg(-1);function zy(o){return"clientX"in o&&"clientY"in o}function Tr(o){if(!o)return!1;const{KeyboardEvent:l}=vt(o.target);return l&&o instanceof l}function jy(o){if(!o)return!1;const{TouchEvent:l}=vt(o.target);return l&&o instanceof l}function vr(o){if(jy(o)){if(o.touches&&o.touches.length){const{clientX:l,clientY:i}=o.touches[0];return{x:l,y:i}}else if(o.changedTouches&&o.changedTouches.length){const{clientX:l,clientY:i}=o.changedTouches[0];return{x:l,y:i}}}return zy(o)?{x:o.clientX,y:o.clientY}:null}const ba=Object.freeze({Translate:{toString(o){if(!o)return;const{x:l,y:i}=o;return"translate3d("+(l?Math.round(l):0)+"px, "+(i?Math.round(i):0)+"px, 0)"}},Scale:{toString(o){if(!o)return;const{scaleX:l,scaleY:i}=o;return"scaleX("+l+") scaleY("+i+")"}},Transform:{toString(o){if(o)return[ba.Translate.toString(o),ba.Scale.toString(o)].join(" ")}},Transition:{toString(o){let{property:l,duration:i,easing:s}=o;return l+" "+i+"ms "+s}}}),Ih="a,frame,iframe,input:not([type=hidden]):not(:disabled),select:not(:disabled),textarea:not(:disabled),button:not(:disabled),*[tabindex]";function My(o){return o.matches(Ih)?o:o.querySelector(Ih)}const _y={display:"none"};function Uy(o){let{id:l,value:i}=o;return qe.createElement("div",{id:l,style:_y},i)}function Ly(o){let{id:l,announcement:i,ariaLiveType:s="assertive"}=o;const u={position:"fixed",top:0,left:0,width:1,height:1,margin:-1,border:0,padding:0,overflow:"hidden",clip:"rect(0 0 0 0)",clipPath:"inset(100%)",whiteSpace:"nowrap"};return qe.createElement("div",{id:l,style:u,role:"status","aria-live":s,"aria-atomic":!0},i)}function qy(){const[o,l]=N.useState("");return{announce:N.useCallback(s=>{s!=null&&l(s)},[]),announcement:o}}const Hg=N.createContext(null);function Hy(o){const l=N.useContext(Hg);N.useEffect(()=>{if(!l)throw new Error("useDndMonitor must be used within a children of <DndContext>");return l(o)},[o,l])}function By(){const[o]=N.useState(()=>new Set),l=N.useCallback(s=>(o.add(s),()=>o.delete(s)),[o]);return[N.useCallback(s=>{let{type:u,event:d}=s;o.forEach(f=>{var h;return(h=f[u])==null?void 0:h.call(f,d)})},[o]),l]}const Yy={draggable:`
    To pick up a draggable item, press the space bar.
    While dragging, use the arrow keys to move the item.
    Press space again to drop the item in its new position, or press escape to cancel.
  `},Gy={onDragStart(o){let{active:l}=o;return"Picked up draggable item "+l.id+"."},onDragOver(o){let{active:l,over:i}=o;return i?"Draggable item "+l.id+" was moved over droppable area "+i.id+".":"Draggable item "+l.id+" is no longer over a droppable area."},onDragEnd(o){let{active:l,over:i}=o;return i?"Draggable item "+l.id+" was dropped over droppable area "+i.id:"Draggable item "+l.id+" was dropped."},onDragCancel(o){let{active:l}=o;return"Dragging was cancelled. Draggable item "+l.id+" was dropped."}};function Xy(o){let{announcements:l=Gy,container:i,hiddenTextDescribedById:s,screenReaderInstructions:u=Yy}=o;const{announce:d,announcement:f}=qy(),h=Yi("DndLiveRegion"),[g,b]=N.useState(!1);if(N.useEffect(()=>{b(!0)},[]),Hy(N.useMemo(()=>({onDragStart(x){let{active:A}=x;d(l.onDragStart({active:A}))},onDragMove(x){let{active:A,over:E}=x;l.onDragMove&&d(l.onDragMove({active:A,over:E}))},onDragOver(x){let{active:A,over:E}=x;d(l.onDragOver({active:A,over:E}))},onDragEnd(x){let{active:A,over:E}=x;d(l.onDragEnd({active:A,over:E}))},onDragCancel(x){let{active:A,over:E}=x;d(l.onDragCancel({active:A,over:E}))}}),[d,l])),!g)return null;const y=qe.createElement(qe.Fragment,null,qe.createElement(Uy,{id:s,value:u.draggable}),qe.createElement(Ly,{id:h,announcement:f}));return i?Ri.createPortal(y,i):y}var et;(function(o){o.DragStart="dragStart",o.DragMove="dragMove",o.DragEnd="dragEnd",o.DragCancel="dragCancel",o.DragOver="dragOver",o.RegisterDroppable="registerDroppable",o.SetDroppableDisabled="setDroppableDisabled",o.UnregisterDroppable="unregisterDroppable"})(et||(et={}));function yr(){}function Vy(o,l){return N.useMemo(()=>({sensor:o,options:l??{}}),[o,l])}function Qy(){for(var o=arguments.length,l=new Array(o),i=0;i<o;i++)l[i]=arguments[i];return N.useMemo(()=>[...l].filter(s=>s!=null),[...l])}const cn=Object.freeze({x:0,y:0});function Zy(o,l){return Math.sqrt(Math.pow(o.x-l.x,2)+Math.pow(o.y-l.y,2))}function Ky(o,l){const i=vr(o);if(!i)return"0 0";const s={x:(i.x-l.left)/l.width*100,y:(i.y-l.top)/l.height*100};return s.x+"% "+s.y+"%"}function Iy(o,l){let{data:{value:i}}=o,{data:{value:s}}=l;return i-s}function Jy(o,l){let{data:{value:i}}=o,{data:{value:s}}=l;return s-i}function Jh(o){let{left:l,top:i,height:s,width:u}=o;return[{x:l,y:i},{x:l+u,y:i},{x:l,y:i+s},{x:l+u,y:i+s}]}function $y(o,l){if(!o||o.length===0)return null;const[i]=o;return i[l]}const Fy=o=>{let{collisionRect:l,droppableRects:i,droppableContainers:s}=o;const u=Jh(l),d=[];for(const f of s){const{id:h}=f,g=i.get(h);if(g){const b=Jh(g),y=u.reduce((A,E,_)=>A+Zy(b[_],E),0),x=Number((y/4).toFixed(4));d.push({id:h,data:{droppableContainer:f,value:x}})}}return d.sort(Iy)};function Wy(o,l){const i=Math.max(l.top,o.top),s=Math.max(l.left,o.left),u=Math.min(l.left+l.width,o.left+o.width),d=Math.min(l.top+l.height,o.top+o.height),f=u-s,h=d-i;if(s<u&&i<d){const g=l.width*l.height,b=o.width*o.height,y=f*h,x=y/(g+b-y);return Number(x.toFixed(4))}return 0}const Py=o=>{let{collisionRect:l,droppableRects:i,droppableContainers:s}=o;const u=[];for(const d of s){const{id:f}=d,h=i.get(f);if(h){const g=Wy(h,l);g>0&&u.push({id:f,data:{droppableContainer:d,value:g}})}}return u.sort(Jy)};function e1(o,l,i){return{...o,scaleX:l&&i?l.width/i.width:1,scaleY:l&&i?l.height/i.height:1}}function Bg(o,l){return o&&l?{x:o.left-l.left,y:o.top-l.top}:cn}function t1(o){return function(i){for(var s=arguments.length,u=new Array(s>1?s-1:0),d=1;d<s;d++)u[d-1]=arguments[d];return u.reduce((f,h)=>({...f,top:f.top+o*h.y,bottom:f.bottom+o*h.y,left:f.left+o*h.x,right:f.right+o*h.x}),{...i})}}const n1=t1(1);function Yg(o){if(o.startsWith("matrix3d(")){const l=o.slice(9,-1).split(/, /);return{x:+l[12],y:+l[13],scaleX:+l[0],scaleY:+l[5]}}else if(o.startsWith("matrix(")){const l=o.slice(7,-1).split(/, /);return{x:+l[4],y:+l[5],scaleX:+l[0],scaleY:+l[3]}}return null}function a1(o,l,i){const s=Yg(l);if(!s)return o;const{scaleX:u,scaleY:d,x:f,y:h}=s,g=o.left-f-(1-u)*parseFloat(i),b=o.top-h-(1-d)*parseFloat(i.slice(i.indexOf(" ")+1)),y=u?o.width/u:o.width,x=d?o.height/d:o.height;return{width:y,height:x,top:b,right:g+y,bottom:b+x,left:g}}const l1={ignoreTransform:!1};function zl(o,l){l===void 0&&(l=l1);let i=o.getBoundingClientRect();if(l.ignoreTransform){const{transform:b,transformOrigin:y}=vt(o).getComputedStyle(o);b&&(i=a1(i,b,y))}const{top:s,left:u,width:d,height:f,bottom:h,right:g}=i;return{top:s,left:u,width:d,height:f,bottom:h,right:g}}function $h(o){return zl(o,{ignoreTransform:!0})}function i1(o){const l=o.innerWidth,i=o.innerHeight;return{top:0,left:0,right:l,bottom:i,width:l,height:i}}function s1(o,l){return l===void 0&&(l=vt(o).getComputedStyle(o)),l.position==="fixed"}function r1(o,l){l===void 0&&(l=vt(o).getComputedStyle(o));const i=/(auto|scroll|overlay)/;return["overflow","overflowX","overflowY"].some(u=>{const d=l[u];return typeof d=="string"?i.test(d):!1})}function Nu(o,l){const i=[];function s(u){if(l!=null&&i.length>=l||!u)return i;if(Cu(u)&&u.scrollingElement!=null&&!i.includes(u.scrollingElement))return i.push(u.scrollingElement),i;if(!Hi(u)||Lg(u)||i.includes(u))return i;const d=vt(o).getComputedStyle(u);return u!==o&&r1(u,d)&&i.push(u),s1(u,d)?i:s(u.parentNode)}return o?s(o):i}function Gg(o){const[l]=Nu(o,1);return l??null}function Fc(o){return!Cr||!o?null:kl(o)?o:wu(o)?Cu(o)||o===Ol(o).scrollingElement?window:Hi(o)?o:null:null}function Xg(o){return kl(o)?o.scrollX:o.scrollLeft}function Vg(o){return kl(o)?o.scrollY:o.scrollTop}function su(o){return{x:Xg(o),y:Vg(o)}}var lt;(function(o){o[o.Forward=1]="Forward",o[o.Backward=-1]="Backward"})(lt||(lt={}));function Qg(o){return!Cr||!o?!1:o===document.scrollingElement}function Zg(o){const l={x:0,y:0},i=Qg(o)?{height:window.innerHeight,width:window.innerWidth}:{height:o.clientHeight,width:o.clientWidth},s={x:o.scrollWidth-i.width,y:o.scrollHeight-i.height},u=o.scrollTop<=l.y,d=o.scrollLeft<=l.x,f=o.scrollTop>=s.y,h=o.scrollLeft>=s.x;return{isTop:u,isLeft:d,isBottom:f,isRight:h,maxScroll:s,minScroll:l}}const o1={x:.2,y:.2};function c1(o,l,i,s,u){let{top:d,left:f,right:h,bottom:g}=i;s===void 0&&(s=10),u===void 0&&(u=o1);const{isTop:b,isBottom:y,isLeft:x,isRight:A}=Zg(o),E={x:0,y:0},_={x:0,y:0},z={height:l.height*u.y,width:l.width*u.x};return!b&&d<=l.top+z.height?(E.y=lt.Backward,_.y=s*Math.abs((l.top+z.height-d)/z.height)):!y&&g>=l.bottom-z.height&&(E.y=lt.Forward,_.y=s*Math.abs((l.bottom-z.height-g)/z.height)),!A&&h>=l.right-z.width?(E.x=lt.Forward,_.x=s*Math.abs((l.right-z.width-h)/z.width)):!x&&f<=l.left+z.width&&(E.x=lt.Backward,_.x=s*Math.abs((l.left+z.width-f)/z.width)),{direction:E,speed:_}}function u1(o){if(o===document.scrollingElement){const{innerWidth:d,innerHeight:f}=window;return{top:0,left:0,right:d,bottom:f,width:d,height:f}}const{top:l,left:i,right:s,bottom:u}=o.getBoundingClientRect();return{top:l,left:i,right:s,bottom:u,width:o.clientWidth,height:o.clientHeight}}function Kg(o){return o.reduce((l,i)=>Rl(l,su(i)),cn)}function d1(o){return o.reduce((l,i)=>l+Xg(i),0)}function f1(o){return o.reduce((l,i)=>l+Vg(i),0)}function Ig(o,l){if(l===void 0&&(l=zl),!o)return;const{top:i,left:s,bottom:u,right:d}=l(o);Gg(o)&&(u<=0||d<=0||i>=window.innerHeight||s>=window.innerWidth)&&o.scrollIntoView({block:"center",inline:"center"})}const p1=[["x",["left","right"],d1],["y",["top","bottom"],f1]];class Tu{constructor(l,i){this.rect=void 0,this.width=void 0,this.height=void 0,this.top=void 0,this.bottom=void 0,this.right=void 0,this.left=void 0;const s=Nu(i),u=Kg(s);this.rect={...l},this.width=l.width,this.height=l.height;for(const[d,f,h]of p1)for(const g of f)Object.defineProperty(this,g,{get:()=>{const b=h(s),y=u[d]-b;return this.rect[g]+y},enumerable:!0});Object.defineProperty(this,"rect",{enumerable:!1})}}class zi{constructor(l){this.target=void 0,this.listeners=[],this.removeAll=()=>{this.listeners.forEach(i=>{var s;return(s=this.target)==null?void 0:s.removeEventListener(...i)})},this.target=l}add(l,i,s){var u;(u=this.target)==null||u.addEventListener(l,i,s),this.listeners.push([l,i,s])}}function h1(o){const{EventTarget:l}=vt(o);return o instanceof l?o:Ol(o)}function Wc(o,l){const i=Math.abs(o.x),s=Math.abs(o.y);return typeof l=="number"?Math.sqrt(i**2+s**2)>l:"x"in l&&"y"in l?i>l.x&&s>l.y:"x"in l?i>l.x:"y"in l?s>l.y:!1}var en;(function(o){o.Click="click",o.DragStart="dragstart",o.Keydown="keydown",o.ContextMenu="contextmenu",o.Resize="resize",o.SelectionChange="selectionchange",o.VisibilityChange="visibilitychange"})(en||(en={}));function Fh(o){o.preventDefault()}function g1(o){o.stopPropagation()}var Ce;(function(o){o.Space="Space",o.Down="ArrowDown",o.Right="ArrowRight",o.Left="ArrowLeft",o.Up="ArrowUp",o.Esc="Escape",o.Enter="Enter",o.Tab="Tab"})(Ce||(Ce={}));const Jg={start:[Ce.Space,Ce.Enter],cancel:[Ce.Esc],end:[Ce.Space,Ce.Enter,Ce.Tab]},m1=(o,l)=>{let{currentCoordinates:i}=l;switch(o.code){case Ce.Right:return{...i,x:i.x+25};case Ce.Left:return{...i,x:i.x-25};case Ce.Down:return{...i,y:i.y+25};case Ce.Up:return{...i,y:i.y-25}}};class $g{constructor(l){this.props=void 0,this.autoScrollEnabled=!1,this.referenceCoordinates=void 0,this.listeners=void 0,this.windowListeners=void 0,this.props=l;const{event:{target:i}}=l;this.props=l,this.listeners=new zi(Ol(i)),this.windowListeners=new zi(vt(i)),this.handleKeyDown=this.handleKeyDown.bind(this),this.handleCancel=this.handleCancel.bind(this),this.attach()}attach(){this.handleStart(),this.windowListeners.add(en.Resize,this.handleCancel),this.windowListeners.add(en.VisibilityChange,this.handleCancel),setTimeout(()=>this.listeners.add(en.Keydown,this.handleKeyDown))}handleStart(){const{activeNode:l,onStart:i}=this.props,s=l.node.current;s&&Ig(s),i(cn)}handleKeyDown(l){if(Tr(l)){const{active:i,context:s,options:u}=this.props,{keyboardCodes:d=Jg,coordinateGetter:f=m1,scrollBehavior:h="smooth"}=u,{code:g}=l;if(d.end.includes(g)){this.handleEnd(l);return}if(d.cancel.includes(g)){this.handleCancel(l);return}const{collisionRect:b}=s.current,y=b?{x:b.left,y:b.top}:cn;this.referenceCoordinates||(this.referenceCoordinates=y);const x=f(l,{active:i,context:s.current,currentCoordinates:y});if(x){const A=br(x,y),E={x:0,y:0},{scrollableAncestors:_}=s.current;for(const z of _){const V=l.code,{isTop:B,isRight:Q,isLeft:K,isBottom:I,maxScroll:X,minScroll:G}=Zg(z),Y=u1(z),J={x:Math.min(V===Ce.Right?Y.right-Y.width/2:Y.right,Math.max(V===Ce.Right?Y.left:Y.left+Y.width/2,x.x)),y:Math.min(V===Ce.Down?Y.bottom-Y.height/2:Y.bottom,Math.max(V===Ce.Down?Y.top:Y.top+Y.height/2,x.y))},ne=V===Ce.Right&&!Q||V===Ce.Left&&!K,pe=V===Ce.Down&&!I||V===Ce.Up&&!B;if(ne&&J.x!==x.x){const oe=z.scrollLeft+A.x,De=V===Ce.Right&&oe<=X.x||V===Ce.Left&&oe>=G.x;if(De&&!A.y){z.scrollTo({left:oe,behavior:h});return}De?E.x=z.scrollLeft-oe:E.x=V===Ce.Right?z.scrollLeft-X.x:z.scrollLeft-G.x,E.x&&z.scrollBy({left:-E.x,behavior:h});break}else if(pe&&J.y!==x.y){const oe=z.scrollTop+A.y,De=V===Ce.Down&&oe<=X.y||V===Ce.Up&&oe>=G.y;if(De&&!A.x){z.scrollTo({top:oe,behavior:h});return}De?E.y=z.scrollTop-oe:E.y=V===Ce.Down?z.scrollTop-X.y:z.scrollTop-G.y,E.y&&z.scrollBy({top:-E.y,behavior:h});break}}this.handleMove(l,Rl(br(x,this.referenceCoordinates),E))}}}handleMove(l,i){const{onMove:s}=this.props;l.preventDefault(),s(i)}handleEnd(l){const{onEnd:i}=this.props;l.preventDefault(),this.detach(),i()}handleCancel(l){const{onCancel:i}=this.props;l.preventDefault(),this.detach(),i()}detach(){this.listeners.removeAll(),this.windowListeners.removeAll()}}$g.activators=[{eventName:"onKeyDown",handler:(o,l,i)=>{let{keyboardCodes:s=Jg,onActivation:u}=l,{active:d}=i;const{code:f}=o.nativeEvent;if(s.start.includes(f)){const h=d.activatorNode.current;return h&&o.target!==h?!1:(o.preventDefault(),u==null||u({event:o.nativeEvent}),!0)}return!1}}];function Wh(o){return!!(o&&"distance"in o)}function Ph(o){return!!(o&&"delay"in o)}class Eu{constructor(l,i,s){var u;s===void 0&&(s=h1(l.event.target)),this.props=void 0,this.events=void 0,this.autoScrollEnabled=!0,this.document=void 0,this.activated=!1,this.initialCoordinates=void 0,this.timeoutId=null,this.listeners=void 0,this.documentListeners=void 0,this.windowListeners=void 0,this.props=l,this.events=i;const{event:d}=l,{target:f}=d;this.props=l,this.events=i,this.document=Ol(f),this.documentListeners=new zi(this.document),this.listeners=new zi(s),this.windowListeners=new zi(vt(f)),this.initialCoordinates=(u=vr(d))!=null?u:cn,this.handleStart=this.handleStart.bind(this),this.handleMove=this.handleMove.bind(this),this.handleEnd=this.handleEnd.bind(this),this.handleCancel=this.handleCancel.bind(this),this.handleKeydown=this.handleKeydown.bind(this),this.removeTextSelection=this.removeTextSelection.bind(this),this.attach()}attach(){const{events:l,props:{options:{activationConstraint:i,bypassActivationConstraint:s}}}=this;if(this.listeners.add(l.move.name,this.handleMove,{passive:!1}),this.listeners.add(l.end.name,this.handleEnd),l.cancel&&this.listeners.add(l.cancel.name,this.handleCancel),this.windowListeners.add(en.Resize,this.handleCancel),this.windowListeners.add(en.DragStart,Fh),this.windowListeners.add(en.VisibilityChange,this.handleCancel),this.windowListeners.add(en.ContextMenu,Fh),this.documentListeners.add(en.Keydown,this.handleKeydown),i){if(s!=null&&s({event:this.props.event,activeNode:this.props.activeNode,options:this.props.options}))return this.handleStart();if(Ph(i)){this.timeoutId=setTimeout(this.handleStart,i.delay),this.handlePending(i);return}if(Wh(i)){this.handlePending(i);return}}this.handleStart()}detach(){this.listeners.removeAll(),this.windowListeners.removeAll(),setTimeout(this.documentListeners.removeAll,50),this.timeoutId!==null&&(clearTimeout(this.timeoutId),this.timeoutId=null)}handlePending(l,i){const{active:s,onPending:u}=this.props;u(s,l,this.initialCoordinates,i)}handleStart(){const{initialCoordinates:l}=this,{onStart:i}=this.props;l&&(this.activated=!0,this.documentListeners.add(en.Click,g1,{capture:!0}),this.removeTextSelection(),this.documentListeners.add(en.SelectionChange,this.removeTextSelection),i(l))}handleMove(l){var i;const{activated:s,initialCoordinates:u,props:d}=this,{onMove:f,options:{activationConstraint:h}}=d;if(!u)return;const g=(i=vr(l))!=null?i:cn,b=br(u,g);if(!s&&h){if(Wh(h)){if(h.tolerance!=null&&Wc(b,h.tolerance))return this.handleCancel();if(Wc(b,h.distance))return this.handleStart()}if(Ph(h)&&Wc(b,h.tolerance))return this.handleCancel();this.handlePending(h,b);return}l.cancelable&&l.preventDefault(),f(g)}handleEnd(){const{onAbort:l,onEnd:i}=this.props;this.detach(),this.activated||l(this.props.active),i()}handleCancel(){const{onAbort:l,onCancel:i}=this.props;this.detach(),this.activated||l(this.props.active),i()}handleKeydown(l){l.code===Ce.Esc&&this.handleCancel()}removeTextSelection(){var l;(l=this.document.getSelection())==null||l.removeAllRanges()}}const b1={cancel:{name:"pointercancel"},move:{name:"pointermove"},end:{name:"pointerup"}};class Du extends Eu{constructor(l){const{event:i}=l,s=Ol(i.target);super(l,b1,s)}}Du.activators=[{eventName:"onPointerDown",handler:(o,l)=>{let{nativeEvent:i}=o,{onActivation:s}=l;return!i.isPrimary||i.button!==0?!1:(s==null||s({event:i}),!0)}}];const v1={move:{name:"mousemove"},end:{name:"mouseup"}};var ru;(function(o){o[o.RightClick=2]="RightClick"})(ru||(ru={}));class y1 extends Eu{constructor(l){super(l,v1,Ol(l.event.target))}}y1.activators=[{eventName:"onMouseDown",handler:(o,l)=>{let{nativeEvent:i}=o,{onActivation:s}=l;return i.button===ru.RightClick?!1:(s==null||s({event:i}),!0)}}];const Pc={cancel:{name:"touchcancel"},move:{name:"touchmove"},end:{name:"touchend"}};class x1 extends Eu{constructor(l){super(l,Pc)}static setup(){return window.addEventListener(Pc.move.name,l,{capture:!1,passive:!1}),function(){window.removeEventListener(Pc.move.name,l)};function l(){}}}x1.activators=[{eventName:"onTouchStart",handler:(o,l)=>{let{nativeEvent:i}=o,{onActivation:s}=l;const{touches:u}=i;return u.length>1?!1:(s==null||s({event:i}),!0)}}];var ji;(function(o){o[o.Pointer=0]="Pointer",o[o.DraggableRect=1]="DraggableRect"})(ji||(ji={}));var xr;(function(o){o[o.TreeOrder=0]="TreeOrder",o[o.ReversedTreeOrder=1]="ReversedTreeOrder"})(xr||(xr={}));function S1(o){let{acceleration:l,activator:i=ji.Pointer,canScroll:s,draggingRect:u,enabled:d,interval:f=5,order:h=xr.TreeOrder,pointerCoordinates:g,scrollableAncestors:b,scrollableAncestorRects:y,delta:x,threshold:A}=o;const E=C1({delta:x,disabled:!d}),[_,z]=Oy(),V=N.useRef({x:0,y:0}),B=N.useRef({x:0,y:0}),Q=N.useMemo(()=>{switch(i){case ji.Pointer:return g?{top:g.y,bottom:g.y,left:g.x,right:g.x}:null;case ji.DraggableRect:return u}},[i,u,g]),K=N.useRef(null),I=N.useCallback(()=>{const G=K.current;if(!G)return;const Y=V.current.x*B.current.x,J=V.current.y*B.current.y;G.scrollBy(Y,J)},[]),X=N.useMemo(()=>h===xr.TreeOrder?[...b].reverse():b,[h,b]);N.useEffect(()=>{if(!d||!b.length||!Q){z();return}for(const G of X){if((s==null?void 0:s(G))===!1)continue;const Y=b.indexOf(G),J=y[Y];if(!J)continue;const{direction:ne,speed:pe}=c1(G,J,Q,l,A);for(const oe of["x","y"])E[oe][ne[oe]]||(pe[oe]=0,ne[oe]=0);if(pe.x>0||pe.y>0){z(),K.current=G,_(I,f),V.current=pe,B.current=ne;return}}V.current={x:0,y:0},B.current={x:0,y:0},z()},[l,I,s,z,d,f,JSON.stringify(Q),JSON.stringify(E),_,b,X,y,JSON.stringify(A)])}const w1={x:{[lt.Backward]:!1,[lt.Forward]:!1},y:{[lt.Backward]:!1,[lt.Forward]:!1}};function C1(o){let{delta:l,disabled:i}=o;const s=mr(l);return Bi(u=>{if(i||!s||!u)return w1;const d={x:Math.sign(l.x-s.x),y:Math.sign(l.y-s.y)};return{x:{[lt.Backward]:u.x[lt.Backward]||d.x===-1,[lt.Forward]:u.x[lt.Forward]||d.x===1},y:{[lt.Backward]:u.y[lt.Backward]||d.y===-1,[lt.Forward]:u.y[lt.Forward]||d.y===1}}},[i,l,s])}function N1(o,l){const i=l!=null?o.get(l):void 0,s=i?i.node.current:null;return Bi(u=>{var d;return l==null?null:(d=s??u)!=null?d:null},[s,l])}function T1(o,l){return N.useMemo(()=>o.reduce((i,s)=>{const{sensor:u}=s,d=u.activators.map(f=>({eventName:f.eventName,handler:l(f.handler,s)}));return[...i,...d]},[]),[o,l])}var Ui;(function(o){o[o.Always=0]="Always",o[o.BeforeDragging=1]="BeforeDragging",o[o.WhileDragging=2]="WhileDragging"})(Ui||(Ui={}));var ou;(function(o){o.Optimized="optimized"})(ou||(ou={}));const eg=new Map;function E1(o,l){let{dragging:i,dependencies:s,config:u}=l;const[d,f]=N.useState(null),{frequency:h,measure:g,strategy:b}=u,y=N.useRef(o),x=V(),A=_i(x),E=N.useCallback(function(B){B===void 0&&(B=[]),!A.current&&f(Q=>Q===null?B:Q.concat(B.filter(K=>!Q.includes(K))))},[A]),_=N.useRef(null),z=Bi(B=>{if(x&&!i)return eg;if(!B||B===eg||y.current!==o||d!=null){const Q=new Map;for(let K of o){if(!K)continue;if(d&&d.length>0&&!d.includes(K.id)&&K.rect.current){Q.set(K.id,K.rect.current);continue}const I=K.node.current,X=I?new Tu(g(I),I):null;K.rect.current=X,X&&Q.set(K.id,X)}return Q}return B},[o,d,i,x,g]);return N.useEffect(()=>{y.current=o},[o]),N.useEffect(()=>{x||E()},[i,x]),N.useEffect(()=>{d&&d.length>0&&f(null)},[JSON.stringify(d)]),N.useEffect(()=>{x||typeof h!="number"||_.current!==null||(_.current=setTimeout(()=>{E(),_.current=null},h))},[h,x,E,...s]),{droppableRects:z,measureDroppableContainers:E,measuringScheduled:d!=null};function V(){switch(b){case Ui.Always:return!1;case Ui.BeforeDragging:return i;default:return!i}}}function Au(o,l){return Bi(i=>o?i||(typeof l=="function"?l(o):o):null,[l,o])}function D1(o,l){return Au(o,l)}function A1(o){let{callback:l,disabled:i}=o;const s=Nr(l),u=N.useMemo(()=>{if(i||typeof window>"u"||typeof window.MutationObserver>"u")return;const{MutationObserver:d}=window;return new d(s)},[s,i]);return N.useEffect(()=>()=>u==null?void 0:u.disconnect(),[u]),u}function Er(o){let{callback:l,disabled:i}=o;const s=Nr(l),u=N.useMemo(()=>{if(i||typeof window>"u"||typeof window.ResizeObserver>"u")return;const{ResizeObserver:d}=window;return new d(s)},[i]);return N.useEffect(()=>()=>u==null?void 0:u.disconnect(),[u]),u}function R1(o){return new Tu(zl(o),o)}function tg(o,l,i){l===void 0&&(l=R1);const[s,u]=N.useState(null);function d(){u(g=>{if(!o)return null;if(o.isConnected===!1){var b;return(b=g??i)!=null?b:null}const y=l(o);return JSON.stringify(g)===JSON.stringify(y)?g:y})}const f=A1({callback(g){if(o)for(const b of g){const{type:y,target:x}=b;if(y==="childList"&&x instanceof HTMLElement&&x.contains(o)){d();break}}}}),h=Er({callback:d});return on(()=>{d(),o?(h==null||h.observe(o),f==null||f.observe(document.body,{childList:!0,subtree:!0})):(h==null||h.disconnect(),f==null||f.disconnect())},[o]),s}function k1(o){const l=Au(o);return Bg(o,l)}const ng=[];function O1(o){const l=N.useRef(o),i=Bi(s=>o?s&&s!==ng&&o&&l.current&&o.parentNode===l.current.parentNode?s:Nu(o):ng,[o]);return N.useEffect(()=>{l.current=o},[o]),i}function z1(o){const[l,i]=N.useState(null),s=N.useRef(o),u=N.useCallback(d=>{const f=Fc(d.target);f&&i(h=>h?(h.set(f,su(f)),new Map(h)):null)},[]);return N.useEffect(()=>{const d=s.current;if(o!==d){f(d);const h=o.map(g=>{const b=Fc(g);return b?(b.addEventListener("scroll",u,{passive:!0}),[b,su(b)]):null}).filter(g=>g!=null);i(h.length?new Map(h):null),s.current=o}return()=>{f(o),f(d)};function f(h){h.forEach(g=>{const b=Fc(g);b==null||b.removeEventListener("scroll",u)})}},[u,o]),N.useMemo(()=>o.length?l?Array.from(l.values()).reduce((d,f)=>Rl(d,f),cn):Kg(o):cn,[o,l])}function ag(o,l){l===void 0&&(l=[]);const i=N.useRef(null);return N.useEffect(()=>{i.current=null},l),N.useEffect(()=>{const s=o!==cn;s&&!i.current&&(i.current=o),!s&&i.current&&(i.current=null)},[o]),i.current?br(o,i.current):cn}function j1(o){N.useEffect(()=>{if(!Cr)return;const l=o.map(i=>{let{sensor:s}=i;return s.setup==null?void 0:s.setup()});return()=>{for(const i of l)i==null||i()}},o.map(l=>{let{sensor:i}=l;return i}))}function M1(o,l){return N.useMemo(()=>o.reduce((i,s)=>{let{eventName:u,handler:d}=s;return i[u]=f=>{d(f,l)},i},{}),[o,l])}function Fg(o){return N.useMemo(()=>o?i1(o):null,[o])}const lg=[];function _1(o,l){l===void 0&&(l=zl);const[i]=o,s=Fg(i?vt(i):null),[u,d]=N.useState(lg);function f(){d(()=>o.length?o.map(g=>Qg(g)?s:new Tu(l(g),g)):lg)}const h=Er({callback:f});return on(()=>{h==null||h.disconnect(),f(),o.forEach(g=>h==null?void 0:h.observe(g))},[o]),u}function Wg(o){if(!o)return null;if(o.children.length>1)return o;const l=o.children[0];return Hi(l)?l:o}function U1(o){let{measure:l}=o;const[i,s]=N.useState(null),u=N.useCallback(b=>{for(const{target:y}of b)if(Hi(y)){s(x=>{const A=l(y);return x?{...x,width:A.width,height:A.height}:A});break}},[l]),d=Er({callback:u}),f=N.useCallback(b=>{const y=Wg(b);d==null||d.disconnect(),y&&(d==null||d.observe(y)),s(y?l(y):null)},[l,d]),[h,g]=gr(f);return N.useMemo(()=>({nodeRef:h,rect:i,setRef:g}),[i,h,g])}const L1=[{sensor:Du,options:{}},{sensor:$g,options:{}}],q1={current:{}},dr={draggable:{measure:$h},droppable:{measure:$h,strategy:Ui.WhileDragging,frequency:ou.Optimized},dragOverlay:{measure:zl}};class Mi extends Map{get(l){var i;return l!=null&&(i=super.get(l))!=null?i:void 0}toArray(){return Array.from(this.values())}getEnabled(){return this.toArray().filter(l=>{let{disabled:i}=l;return!i})}getNodeFor(l){var i,s;return(i=(s=this.get(l))==null?void 0:s.node.current)!=null?i:void 0}}const H1={activatorEvent:null,active:null,activeNode:null,activeNodeRect:null,collisions:null,containerNodeRect:null,draggableNodes:new Map,droppableRects:new Map,droppableContainers:new Mi,over:null,dragOverlay:{nodeRef:{current:null},rect:null,setRef:yr},scrollableAncestors:[],scrollableAncestorRects:[],measuringConfiguration:dr,measureDroppableContainers:yr,windowRect:null,measuringScheduled:!1},Pg={activatorEvent:null,activators:[],active:null,activeNodeRect:null,ariaDescribedById:{draggable:""},dispatch:yr,draggableNodes:new Map,over:null,measureDroppableContainers:yr},Gi=N.createContext(Pg),em=N.createContext(H1);function B1(){return{draggable:{active:null,initialCoordinates:{x:0,y:0},nodes:new Map,translate:{x:0,y:0}},droppable:{containers:new Mi}}}function Y1(o,l){switch(l.type){case et.DragStart:return{...o,draggable:{...o.draggable,initialCoordinates:l.initialCoordinates,active:l.active}};case et.DragMove:return o.draggable.active==null?o:{...o,draggable:{...o.draggable,translate:{x:l.coordinates.x-o.draggable.initialCoordinates.x,y:l.coordinates.y-o.draggable.initialCoordinates.y}}};case et.DragEnd:case et.DragCancel:return{...o,draggable:{...o.draggable,active:null,initialCoordinates:{x:0,y:0},translate:{x:0,y:0}}};case et.RegisterDroppable:{const{element:i}=l,{id:s}=i,u=new Mi(o.droppable.containers);return u.set(s,i),{...o,droppable:{...o.droppable,containers:u}}}case et.SetDroppableDisabled:{const{id:i,key:s,disabled:u}=l,d=o.droppable.containers.get(i);if(!d||s!==d.key)return o;const f=new Mi(o.droppable.containers);return f.set(i,{...d,disabled:u}),{...o,droppable:{...o.droppable,containers:f}}}case et.UnregisterDroppable:{const{id:i,key:s}=l,u=o.droppable.containers.get(i);if(!u||s!==u.key)return o;const d=new Mi(o.droppable.containers);return d.delete(i),{...o,droppable:{...o.droppable,containers:d}}}default:return o}}function G1(o){let{disabled:l}=o;const{active:i,activatorEvent:s,draggableNodes:u}=N.useContext(Gi),d=mr(s),f=mr(i==null?void 0:i.id);return N.useEffect(()=>{if(!l&&!s&&d&&f!=null){if(!Tr(d)||document.activeElement===d.target)return;const h=u.get(f);if(!h)return;const{activatorNode:g,node:b}=h;if(!g.current&&!b.current)return;requestAnimationFrame(()=>{for(const y of[g.current,b.current]){if(!y)continue;const x=My(y);if(x){x.focus();break}}})}},[s,l,u,f,d]),null}function tm(o,l){let{transform:i,...s}=l;return o!=null&&o.length?o.reduce((u,d)=>d({transform:u,...s}),i):i}function X1(o){return N.useMemo(()=>({draggable:{...dr.draggable,...o==null?void 0:o.draggable},droppable:{...dr.droppable,...o==null?void 0:o.droppable},dragOverlay:{...dr.dragOverlay,...o==null?void 0:o.dragOverlay}}),[o==null?void 0:o.draggable,o==null?void 0:o.droppable,o==null?void 0:o.dragOverlay])}function V1(o){let{activeNode:l,measure:i,initialRect:s,config:u=!0}=o;const d=N.useRef(!1),{x:f,y:h}=typeof u=="boolean"?{x:u,y:u}:u;on(()=>{if(!f&&!h||!l){d.current=!1;return}if(d.current||!s)return;const b=l==null?void 0:l.node.current;if(!b||b.isConnected===!1)return;const y=i(b),x=Bg(y,s);if(f||(x.x=0),h||(x.y=0),d.current=!0,Math.abs(x.x)>0||Math.abs(x.y)>0){const A=Gg(b);A&&A.scrollBy({top:x.y,left:x.x})}},[l,f,h,s,i])}const Dr=N.createContext({...cn,scaleX:1,scaleY:1});var ma;(function(o){o[o.Uninitialized=0]="Uninitialized",o[o.Initializing=1]="Initializing",o[o.Initialized=2]="Initialized"})(ma||(ma={}));const Q1=N.memo(function(l){var i,s,u,d;let{id:f,accessibility:h,autoScroll:g=!0,children:b,sensors:y=L1,collisionDetection:x=Py,measuring:A,modifiers:E,..._}=l;const z=N.useReducer(Y1,void 0,B1),[V,B]=z,[Q,K]=By(),[I,X]=N.useState(ma.Uninitialized),G=I===ma.Initialized,{draggable:{active:Y,nodes:J,translate:ne},droppable:{containers:pe}}=V,oe=Y!=null?J.get(Y):null,De=N.useRef({initial:null,translated:null}),Ge=N.useMemo(()=>{var Xe;return Y!=null?{id:Y,data:(Xe=oe==null?void 0:oe.data)!=null?Xe:q1,rect:De}:null},[Y,oe]),He=N.useRef(null),[Fe,M]=N.useState(null),[q,F]=N.useState(null),ee=_i(_,Object.values(_)),se=Yi("DndDescribedBy",f),w=N.useMemo(()=>pe.getEnabled(),[pe]),j=X1(A),{droppableRects:Z,measureDroppableContainers:$,measuringScheduled:ie}=E1(w,{dragging:G,dependencies:[ne.x,ne.y],config:j.droppable}),le=N1(J,Y),me=N.useMemo(()=>q?vr(q):null,[q]),Ue=Ga(),Se=D1(le,j.draggable.measure);V1({activeNode:Y!=null?J.get(Y):null,config:Ue.layoutShiftCompensation,initialRect:Se,measure:j.draggable.measure});const ve=tg(le,j.draggable.measure,Se),un=tg(le?le.parentElement:null),yt=N.useRef({activatorEvent:null,active:null,activeNode:le,collisionRect:null,collisions:null,droppableRects:Z,draggableNodes:J,draggingNode:null,draggingNodeRect:null,droppableContainers:pe,over:null,scrollableAncestors:[],scrollAdjustedTranslate:null}),xn=pe.getNodeFor((i=yt.current.over)==null?void 0:i.id),it=U1({measure:j.dragOverlay.measure}),dn=(s=it.nodeRef.current)!=null?s:le,fn=G?(u=it.rect)!=null?u:ve:null,Xi=!!(it.nodeRef.current&&it.rect),jl=k1(Xi?null:ve),va=Fg(dn?vt(dn):null),Ht=O1(G?xn??le:null),Vn=_1(Ht),Ba=tm(E,{transform:{x:ne.x-jl.x,y:ne.y-jl.y,scaleX:1,scaleY:1},activatorEvent:q,active:Ge,activeNodeRect:ve,containerNodeRect:un,draggingNodeRect:fn,over:yt.current.over,overlayNodeRect:it.rect,scrollableAncestors:Ht,scrollableAncestorRects:Vn,windowRect:va}),Vi=me?Rl(me,ne):null,dt=z1(Ht),Ar=ag(dt),Qi=ag(dt,[ve]),Sn=Rl(Ba,Ar),tn=fn?n1(fn,Ba):null,ya=Ge&&tn?x({active:Ge,collisionRect:tn,droppableRects:Z,droppableContainers:w,pointerCoordinates:Vi}):null,Ml=$y(ya,"id"),[pn,Zi]=N.useState(null),xa=Xi?Ba:Rl(Ba,Qi),gt=e1(xa,(d=pn==null?void 0:pn.rect)!=null?d:null,ve),Bt=N.useRef(null),ft=N.useCallback((Xe,Ve)=>{let{sensor:tt,options:xt}=Ve;if(He.current==null)return;const St=J.get(He.current);if(!St)return;const pt=Xe.nativeEvent,wt=new tt({active:He.current,activeNode:St,event:pt,options:xt,context:yt,onAbort(We){if(!J.get(We))return;const{onDragAbort:kt}=ee.current,Gt={id:We};kt==null||kt(Gt),Q({type:"onDragAbort",event:Gt})},onPending(We,nn,kt,Gt){if(!J.get(We))return;const{onDragPending:Cn}=ee.current,an={id:We,constraint:nn,initialCoordinates:kt,offset:Gt};Cn==null||Cn(an),Q({type:"onDragPending",event:an})},onStart(We){const nn=He.current;if(nn==null)return;const kt=J.get(nn);if(!kt)return;const{onDragStart:Gt}=ee.current,wn={activatorEvent:pt,active:{id:nn,data:kt.data,rect:De}};Ri.unstable_batchedUpdates(()=>{Gt==null||Gt(wn),X(ma.Initializing),B({type:et.DragStart,initialCoordinates:We,active:nn}),Q({type:"onDragStart",event:wn}),M(Bt.current),F(pt)})},onMove(We){B({type:et.DragMove,coordinates:We})},onEnd:Yt(et.DragEnd),onCancel:Yt(et.DragCancel)});Bt.current=wt;function Yt(We){return async function(){const{active:kt,collisions:Gt,over:wn,scrollAdjustedTranslate:Cn}=yt.current;let an=null;if(kt&&Cn){const{cancelDrop:Qn}=ee.current;an={activatorEvent:pt,active:kt,collisions:Gt,delta:Cn,over:wn},We===et.DragEnd&&typeof Qn=="function"&&await Promise.resolve(Qn(an))&&(We=et.DragCancel)}He.current=null,Ri.unstable_batchedUpdates(()=>{B({type:We}),X(ma.Uninitialized),Zi(null),M(null),F(null),Bt.current=null;const Qn=We===et.DragEnd?"onDragEnd":"onDragCancel";if(an){const Xt=ee.current[Qn];Xt==null||Xt(an),Q({type:Qn,event:an})}})}}},[J]),Rr=N.useCallback((Xe,Ve)=>(tt,xt)=>{const St=tt.nativeEvent,pt=J.get(xt);if(He.current!==null||!pt||St.dndKit||St.defaultPrevented)return;const wt={active:pt};Xe(tt,Ve.options,wt)===!0&&(St.dndKit={capturedBy:Ve.sensor},He.current=xt,ft(tt,Ve))},[J,ft]),Ki=T1(y,Rr);j1(y),on(()=>{ve&&I===ma.Initializing&&X(ma.Initialized)},[ve,I]),N.useEffect(()=>{const{onDragMove:Xe}=ee.current,{active:Ve,activatorEvent:tt,collisions:xt,over:St}=yt.current;if(!Ve||!tt)return;const pt={active:Ve,activatorEvent:tt,collisions:xt,delta:{x:Sn.x,y:Sn.y},over:St};Ri.unstable_batchedUpdates(()=>{Xe==null||Xe(pt),Q({type:"onDragMove",event:pt})})},[Sn.x,Sn.y]),N.useEffect(()=>{const{active:Xe,activatorEvent:Ve,collisions:tt,droppableContainers:xt,scrollAdjustedTranslate:St}=yt.current;if(!Xe||He.current==null||!Ve||!St)return;const{onDragOver:pt}=ee.current,wt=xt.get(Ml),Yt=wt&&wt.rect.current?{id:wt.id,rect:wt.rect.current,data:wt.data,disabled:wt.disabled}:null,We={active:Xe,activatorEvent:Ve,collisions:tt,delta:{x:St.x,y:St.y},over:Yt};Ri.unstable_batchedUpdates(()=>{Zi(Yt),pt==null||pt(We),Q({type:"onDragOver",event:We})})},[Ml]),on(()=>{yt.current={activatorEvent:q,active:Ge,activeNode:le,collisionRect:tn,collisions:ya,droppableRects:Z,draggableNodes:J,draggingNode:dn,draggingNodeRect:fn,droppableContainers:pe,over:pn,scrollableAncestors:Ht,scrollAdjustedTranslate:Sn},De.current={initial:fn,translated:tn}},[Ge,le,ya,tn,J,dn,fn,Z,pe,pn,Ht,Sn]),S1({...Ue,delta:ne,draggingRect:tn,pointerCoordinates:Vi,scrollableAncestors:Ht,scrollableAncestorRects:Vn});const kr=N.useMemo(()=>({active:Ge,activeNode:le,activeNodeRect:ve,activatorEvent:q,collisions:ya,containerNodeRect:un,dragOverlay:it,draggableNodes:J,droppableContainers:pe,droppableRects:Z,over:pn,measureDroppableContainers:$,scrollableAncestors:Ht,scrollableAncestorRects:Vn,measuringConfiguration:j,measuringScheduled:ie,windowRect:va}),[Ge,le,ve,q,ya,un,it,J,pe,Z,pn,$,Ht,Vn,j,ie,va]),Ya=N.useMemo(()=>({activatorEvent:q,activators:Ki,active:Ge,activeNodeRect:ve,ariaDescribedById:{draggable:se},dispatch:B,draggableNodes:J,over:pn,measureDroppableContainers:$}),[q,Ki,Ge,ve,B,se,J,pn,$]);return qe.createElement(Hg.Provider,{value:K},qe.createElement(Gi.Provider,{value:Ya},qe.createElement(em.Provider,{value:kr},qe.createElement(Dr.Provider,{value:gt},b)),qe.createElement(G1,{disabled:(h==null?void 0:h.restoreFocus)===!1})),qe.createElement(Xy,{...h,hiddenTextDescribedById:se}));function Ga(){const Xe=(Fe==null?void 0:Fe.autoScrollEnabled)===!1,Ve=typeof g=="object"?g.enabled===!1:g===!1,tt=G&&!Xe&&!Ve;return typeof g=="object"?{...g,enabled:tt}:{enabled:tt}}}),Z1=N.createContext(null),ig="button",K1="Draggable";function I1(o){let{id:l,data:i,disabled:s=!1,attributes:u}=o;const d=Yi(K1),{activators:f,activatorEvent:h,active:g,activeNodeRect:b,ariaDescribedById:y,draggableNodes:x,over:A}=N.useContext(Gi),{role:E=ig,roleDescription:_="draggable",tabIndex:z=0}=u??{},V=(g==null?void 0:g.id)===l,B=N.useContext(V?Dr:Z1),[Q,K]=gr(),[I,X]=gr(),G=M1(f,l),Y=_i(i);on(()=>(x.set(l,{id:l,key:d,node:Q,activatorNode:I,data:Y}),()=>{const ne=x.get(l);ne&&ne.key===d&&x.delete(l)}),[x,l]);const J=N.useMemo(()=>({role:E,tabIndex:z,"aria-disabled":s,"aria-pressed":V&&E===ig?!0:void 0,"aria-roledescription":_,"aria-describedby":y.draggable}),[s,E,z,V,_,y.draggable]);return{active:g,activatorEvent:h,activeNodeRect:b,attributes:J,isDragging:V,listeners:s?void 0:G,node:Q,over:A,setNodeRef:K,setActivatorNodeRef:X,transform:B}}function nm(){return N.useContext(em)}const J1="Droppable",$1={timeout:25};function F1(o){let{data:l,disabled:i=!1,id:s,resizeObserverConfig:u}=o;const d=Yi(J1),{active:f,dispatch:h,over:g,measureDroppableContainers:b}=N.useContext(Gi),y=N.useRef({disabled:i}),x=N.useRef(!1),A=N.useRef(null),E=N.useRef(null),{disabled:_,updateMeasurementsFor:z,timeout:V}={...$1,...u},B=_i(z??s),Q=N.useCallback(()=>{if(!x.current){x.current=!0;return}E.current!=null&&clearTimeout(E.current),E.current=setTimeout(()=>{b(Array.isArray(B.current)?B.current:[B.current]),E.current=null},V)},[V]),K=Er({callback:Q,disabled:_||!f}),I=N.useCallback((J,ne)=>{K&&(ne&&(K.unobserve(ne),x.current=!1),J&&K.observe(J))},[K]),[X,G]=gr(I),Y=_i(l);return N.useEffect(()=>{!K||!X.current||(K.disconnect(),x.current=!1,K.observe(X.current))},[X,K]),N.useEffect(()=>(h({type:et.RegisterDroppable,element:{id:s,key:d,disabled:i,node:X,rect:A,data:Y}}),()=>h({type:et.UnregisterDroppable,key:d,id:s})),[s]),N.useEffect(()=>{i!==y.current.disabled&&(h({type:et.SetDroppableDisabled,id:s,key:d,disabled:i}),y.current.disabled=i)},[s,d,i,h]),{active:f,rect:A,isOver:(g==null?void 0:g.id)===s,node:X,over:g,setNodeRef:G}}function W1(o){let{animation:l,children:i}=o;const[s,u]=N.useState(null),[d,f]=N.useState(null),h=mr(i);return!i&&!s&&h&&u(h),on(()=>{if(!d)return;const g=s==null?void 0:s.key,b=s==null?void 0:s.props.id;if(g==null||b==null){u(null);return}Promise.resolve(l(b,d)).then(()=>{u(null)})},[l,s,d]),qe.createElement(qe.Fragment,null,i,s?N.cloneElement(s,{ref:f}):null)}const P1={x:0,y:0,scaleX:1,scaleY:1};function ex(o){let{children:l}=o;return qe.createElement(Gi.Provider,{value:Pg},qe.createElement(Dr.Provider,{value:P1},l))}const tx={position:"fixed",touchAction:"none"},nx=o=>Tr(o)?"transform 250ms ease":void 0,ax=N.forwardRef((o,l)=>{let{as:i,activatorEvent:s,adjustScale:u,children:d,className:f,rect:h,style:g,transform:b,transition:y=nx}=o;if(!h)return null;const x=u?b:{...b,scaleX:1,scaleY:1},A={...tx,width:h.width,height:h.height,top:h.top,left:h.left,transform:ba.Transform.toString(x),transformOrigin:u&&s?Ky(s,h):void 0,transition:typeof y=="function"?y(s):y,...g};return qe.createElement(i,{className:f,style:A,ref:l},d)}),lx=o=>l=>{let{active:i,dragOverlay:s}=l;const u={},{styles:d,className:f}=o;if(d!=null&&d.active)for(const[h,g]of Object.entries(d.active))g!==void 0&&(u[h]=i.node.style.getPropertyValue(h),i.node.style.setProperty(h,g));if(d!=null&&d.dragOverlay)for(const[h,g]of Object.entries(d.dragOverlay))g!==void 0&&s.node.style.setProperty(h,g);return f!=null&&f.active&&i.node.classList.add(f.active),f!=null&&f.dragOverlay&&s.node.classList.add(f.dragOverlay),function(){for(const[g,b]of Object.entries(u))i.node.style.setProperty(g,b);f!=null&&f.active&&i.node.classList.remove(f.active)}},ix=o=>{let{transform:{initial:l,final:i}}=o;return[{transform:ba.Transform.toString(l)},{transform:ba.Transform.toString(i)}]},sx={duration:250,easing:"ease",keyframes:ix,sideEffects:lx({styles:{active:{opacity:"0"}}})};function rx(o){let{config:l,draggableNodes:i,droppableContainers:s,measuringConfiguration:u}=o;return Nr((d,f)=>{if(l===null)return;const h=i.get(d);if(!h)return;const g=h.node.current;if(!g)return;const b=Wg(f);if(!b)return;const{transform:y}=vt(f).getComputedStyle(f),x=Yg(y);if(!x)return;const A=typeof l=="function"?l:ox(l);return Ig(g,u.draggable.measure),A({active:{id:d,data:h.data,node:g,rect:u.draggable.measure(g)},draggableNodes:i,dragOverlay:{node:f,rect:u.dragOverlay.measure(b)},droppableContainers:s,measuringConfiguration:u,transform:x})})}function ox(o){const{duration:l,easing:i,sideEffects:s,keyframes:u}={...sx,...o};return d=>{let{active:f,dragOverlay:h,transform:g,...b}=d;if(!l)return;const y={x:h.rect.left-f.rect.left,y:h.rect.top-f.rect.top},x={scaleX:g.scaleX!==1?f.rect.width*g.scaleX/h.rect.width:1,scaleY:g.scaleY!==1?f.rect.height*g.scaleY/h.rect.height:1},A={x:g.x-y.x,y:g.y-y.y,...x},E=u({...b,active:f,dragOverlay:h,transform:{initial:g,final:A}}),[_]=E,z=E[E.length-1];if(JSON.stringify(_)===JSON.stringify(z))return;const V=s==null?void 0:s({active:f,dragOverlay:h,...b}),B=h.node.animate(E,{duration:l,easing:i,fill:"forwards"});return new Promise(Q=>{B.onfinish=()=>{V==null||V(),Q()}})}}let sg=0;function cx(o){return N.useMemo(()=>{if(o!=null)return sg++,sg},[o])}const ux=qe.memo(o=>{let{adjustScale:l=!1,children:i,dropAnimation:s,style:u,transition:d,modifiers:f,wrapperElement:h="div",className:g,zIndex:b=999}=o;const{activatorEvent:y,active:x,activeNodeRect:A,containerNodeRect:E,draggableNodes:_,droppableContainers:z,dragOverlay:V,over:B,measuringConfiguration:Q,scrollableAncestors:K,scrollableAncestorRects:I,windowRect:X}=nm(),G=N.useContext(Dr),Y=cx(x==null?void 0:x.id),J=tm(f,{activatorEvent:y,active:x,activeNodeRect:A,containerNodeRect:E,draggingNodeRect:V.rect,over:B,overlayNodeRect:V.rect,scrollableAncestors:K,scrollableAncestorRects:I,transform:G,windowRect:X}),ne=Au(A),pe=rx({config:s,draggableNodes:_,droppableContainers:z,measuringConfiguration:Q}),oe=ne?V.setRef:void 0;return qe.createElement(ex,null,qe.createElement(W1,{animation:pe},x&&Y?qe.createElement(ax,{key:Y,id:x.id,ref:oe,as:h,activatorEvent:y,adjustScale:l,className:g,transition:d,rect:ne,style:{zIndex:b,...u},transform:J},i):null))});function am(o,l,i){const s=o.slice();return s.splice(i<0?s.length+i:i,0,s.splice(l,1)[0]),s}function dx(o,l){return o.reduce((i,s,u)=>{const d=l.get(s);return d&&(i[u]=d),i},Array(o.length))}function or(o){return o!==null&&o>=0}function fx(o,l){if(o===l)return!0;if(o.length!==l.length)return!1;for(let i=0;i<o.length;i++)if(o[i]!==l[i])return!1;return!0}function px(o){return typeof o=="boolean"?{draggable:o,droppable:o}:o}const lm=o=>{let{rects:l,activeIndex:i,overIndex:s,index:u}=o;const d=am(l,s,i),f=l[u],h=d[u];return!h||!f?null:{x:h.left-f.left,y:h.top-f.top,scaleX:h.width/f.width,scaleY:h.height/f.height}},cr={scaleX:1,scaleY:1},hx=o=>{var l;let{activeIndex:i,activeNodeRect:s,index:u,rects:d,overIndex:f}=o;const h=(l=d[i])!=null?l:s;if(!h)return null;if(u===i){const b=d[f];return b?{x:0,y:i<f?b.top+b.height-(h.top+h.height):b.top-h.top,...cr}:null}const g=gx(d,u,i);return u>i&&u<=f?{x:0,y:-h.height-g,...cr}:u<i&&u>=f?{x:0,y:h.height+g,...cr}:{x:0,y:0,...cr}};function gx(o,l,i){const s=o[l],u=o[l-1],d=o[l+1];return s?i<l?u?s.top-(u.top+u.height):d?d.top-(s.top+s.height):0:d?d.top-(s.top+s.height):u?s.top-(u.top+u.height):0:0}const im="Sortable",sm=qe.createContext({activeIndex:-1,containerId:im,disableTransforms:!1,items:[],overIndex:-1,useDragOverlay:!1,sortedRects:[],strategy:lm,disabled:{draggable:!1,droppable:!1}});function mx(o){let{children:l,id:i,items:s,strategy:u=lm,disabled:d=!1}=o;const{active:f,dragOverlay:h,droppableRects:g,over:b,measureDroppableContainers:y}=nm(),x=Yi(im,i),A=h.rect!==null,E=N.useMemo(()=>s.map(G=>typeof G=="object"&&"id"in G?G.id:G),[s]),_=f!=null,z=f?E.indexOf(f.id):-1,V=b?E.indexOf(b.id):-1,B=N.useRef(E),Q=!fx(E,B.current),K=V!==-1&&z===-1||Q,I=px(d);on(()=>{Q&&_&&y(E)},[Q,E,_,y]),N.useEffect(()=>{B.current=E},[E]);const X=N.useMemo(()=>({activeIndex:z,containerId:x,disabled:I,disableTransforms:K,items:E,overIndex:V,useDragOverlay:A,sortedRects:dx(E,g),strategy:u}),[z,x,I.draggable,I.droppable,K,E,V,g,A,u]);return qe.createElement(sm.Provider,{value:X},l)}const bx=o=>{let{id:l,items:i,activeIndex:s,overIndex:u}=o;return am(i,s,u).indexOf(l)},vx=o=>{let{containerId:l,isSorting:i,wasDragging:s,index:u,items:d,newIndex:f,previousItems:h,previousContainerId:g,transition:b}=o;return!b||!s||h!==d&&u===f?!1:i?!0:f!==u&&l===g},yx={duration:200,easing:"ease"},rm="transform",xx=ba.Transition.toString({property:rm,duration:0,easing:"linear"}),Sx={roleDescription:"sortable"};function wx(o){let{disabled:l,index:i,node:s,rect:u}=o;const[d,f]=N.useState(null),h=N.useRef(i);return on(()=>{if(!l&&i!==h.current&&s.current){const g=u.current;if(g){const b=zl(s.current,{ignoreTransform:!0}),y={x:g.left-b.left,y:g.top-b.top,scaleX:g.width/b.width,scaleY:g.height/b.height};(y.x||y.y)&&f(y)}}i!==h.current&&(h.current=i)},[l,i,s,u]),N.useEffect(()=>{d&&f(null)},[d]),d}function Cx(o){let{animateLayoutChanges:l=vx,attributes:i,disabled:s,data:u,getNewIndex:d=bx,id:f,strategy:h,resizeObserverConfig:g,transition:b=yx}=o;const{items:y,containerId:x,activeIndex:A,disabled:E,disableTransforms:_,sortedRects:z,overIndex:V,useDragOverlay:B,strategy:Q}=N.useContext(sm),K=Nx(s,E),I=y.indexOf(f),X=N.useMemo(()=>({sortable:{containerId:x,index:I,items:y},...u}),[x,u,I,y]),G=N.useMemo(()=>y.slice(y.indexOf(f)),[y,f]),{rect:Y,node:J,isOver:ne,setNodeRef:pe}=F1({id:f,data:X,disabled:K.droppable,resizeObserverConfig:{updateMeasurementsFor:G,...g}}),{active:oe,activatorEvent:De,activeNodeRect:Ge,attributes:He,setNodeRef:Fe,listeners:M,isDragging:q,over:F,setActivatorNodeRef:ee,transform:se}=I1({id:f,data:X,attributes:{...Sx,...i},disabled:K.draggable}),w=ky(pe,Fe),j=!!oe,Z=j&&!_&&or(A)&&or(V),$=!B&&q,ie=$&&Z?se:null,me=Z?ie??(h??Q)({rects:z,activeNodeRect:Ge,activeIndex:A,overIndex:V,index:I}):null,Ue=or(A)&&or(V)?d({id:f,items:y,activeIndex:A,overIndex:V}):I,Se=oe==null?void 0:oe.id,ve=N.useRef({activeId:Se,items:y,newIndex:Ue,containerId:x}),un=y!==ve.current.items,yt=l({active:oe,containerId:x,isDragging:q,isSorting:j,id:f,index:I,items:y,newIndex:ve.current.newIndex,previousItems:ve.current.items,previousContainerId:ve.current.containerId,transition:b,wasDragging:ve.current.activeId!=null}),xn=wx({disabled:!yt,index:I,node:J,rect:Y});return N.useEffect(()=>{j&&ve.current.newIndex!==Ue&&(ve.current.newIndex=Ue),x!==ve.current.containerId&&(ve.current.containerId=x),y!==ve.current.items&&(ve.current.items=y)},[j,Ue,x,y]),N.useEffect(()=>{if(Se===ve.current.activeId)return;if(Se!=null&&ve.current.activeId==null){ve.current.activeId=Se;return}const dn=setTimeout(()=>{ve.current.activeId=Se},50);return()=>clearTimeout(dn)},[Se]),{active:oe,activeIndex:A,attributes:He,data:X,rect:Y,index:I,newIndex:Ue,items:y,isOver:ne,isSorting:j,isDragging:q,listeners:M,node:J,overIndex:V,over:F,setNodeRef:w,setActivatorNodeRef:ee,setDroppableNodeRef:pe,setDraggableNodeRef:Fe,transform:xn??me,transition:it()};function it(){if(xn||un&&ve.current.newIndex===I)return xx;if(!($&&!Tr(De)||!b)&&(j||yt))return ba.Transition.toString({...b,property:rm})}}function Nx(o,l){var i,s;return typeof o=="boolean"?{draggable:o,droppable:!1}:{draggable:(i=o==null?void 0:o.draggable)!=null?i:l.draggable,droppable:(s=o==null?void 0:o.droppable)!=null?s:l.droppable}}Ce.Down,Ce.Right,Ce.Up,Ce.Left;function Tx({prd:o,projectId:l,onClose:i,onSave:s}){const[u,d]=N.useState((o==null?void 0:o.title)??""),[f,h]=N.useState((o==null?void 0:o.content)??""),g=N.useRef();function b(x){const A=x.target.files[0];if(!A)return;const E=A.name.replace(/\.md$/i,"").replace(/[-_]/g," "),_=new FileReader;_.onload=z=>{u||d(E),h(z.target.result)},_.readAsText(A)}function y(){const x=u.trim();x&&s({title:x,content:f})}return v.jsx("div",{className:"prd-editor-scrim",onClick:x=>x.target===x.currentTarget&&i(),children:v.jsxs("div",{className:"prd-editor-modal",children:[v.jsxs("div",{className:"prd-editor-header",children:[v.jsx("span",{className:"prd-editor-title",children:o?"Edit PRD":"New PRD"}),v.jsx("button",{className:"prd-editor-close",onClick:i,children:"✕"})]}),v.jsxs("div",{className:"prd-editor-body",children:[v.jsxs("div",{className:"prd-editor-field",children:[v.jsx("label",{className:"prd-editor-label",children:"Title"}),v.jsx("input",{className:"prd-editor-input",type:"text",placeholder:"e.g. Producer Filter Modal",value:u,onChange:x=>d(x.target.value),autoFocus:!0})]}),v.jsxs("div",{className:"prd-editor-field prd-editor-field--grow",children:[v.jsxs("div",{className:"prd-editor-label-row",children:[v.jsx("label",{className:"prd-editor-label",children:"Content"}),v.jsx("button",{className:"prd-editor-load-file",onClick:()=>g.current.click(),children:"Load from .md file"}),v.jsx("input",{ref:g,type:"file",accept:".md,.txt",style:{display:"none"},onChange:b})]}),v.jsx("textarea",{className:"prd-editor-textarea",placeholder:"Paste your PRD markdown here…",value:f,onChange:x=>h(x.target.value)})]})]}),v.jsxs("div",{className:"prd-editor-footer",children:[v.jsx("button",{className:"prd-editor-btn prd-editor-btn--cancel",onClick:i,children:"Cancel"}),v.jsx("button",{className:"prd-editor-btn prd-editor-btn--save",onClick:y,disabled:!u.trim(),children:o?"Save changes":"Create PRD"})]})]})})}function om(o){const l=Math.floor((Date.now()-new Date(o))/6e4);if(l<1)return"just now";if(l<60)return`${l}m ago`;const i=Math.floor(l/60);return i<24?`${i}h ago`:`${Math.floor(i/24)}d ago`}function Ex({status:o}){return v.jsx("span",{className:`prd-status prd-status--${o}`,children:_g[o]})}function Dx({prd:o,onEdit:l,onDelete:i,onOpen:s,isDragging:u}){const{attributes:d,listeners:f,setNodeRef:h,transform:g,transition:b}=Cx({id:o.id}),y={transform:ba.Transform.toString(g),transition:b,opacity:u?.4:1};return v.jsxs("div",{ref:h,style:y,className:"kanban-card",...d,...f,children:[v.jsx("div",{className:"kanban-card-title",children:o.title}),v.jsx("div",{className:"kanban-card-meta",children:om(o.updatedAt)}),v.jsxs("div",{className:"kanban-card-actions",onPointerDown:x=>x.stopPropagation(),children:[v.jsx("button",{className:"kanban-card-btn",onClick:()=>s(o),children:"Open →"}),v.jsx("button",{className:"kanban-card-btn",onClick:()=>l(o),children:"Edit"}),v.jsx("button",{className:"kanban-card-btn kanban-card-btn--danger",onClick:()=>i(o.id),children:"Delete"})]})]})}function Ax({status:o,prds:l,onEdit:i,onDelete:s,onOpen:u,activeId:d}){return v.jsxs("div",{className:"kanban-col",children:[v.jsxs("div",{className:"kanban-col-header",children:[v.jsx("span",{className:"kanban-col-title",children:_g[o]}),v.jsx("span",{className:"kanban-col-count",children:l.length})]}),v.jsx(mx,{items:l.map(f=>f.id),strategy:hx,children:v.jsxs("div",{className:"kanban-col-cards",children:[l.map(f=>v.jsx(Dx,{prd:f,onEdit:i,onDelete:s,onOpen:u,isDragging:d===f.id},f.id)),l.length===0&&v.jsx("div",{className:"kanban-col-empty",children:"Drop here"})]})})]})}function Rx({projectId:o,prds:l,onNavigate:i,onCreatePrd:s,onUpdatePrd:u,onDeletePrd:d}){const f=Ug(o),h=l.filter(X=>X.projectId===o),[g,b]=N.useState("kanban"),[y,x]=N.useState(!1),[A,E]=N.useState(null),[_,z]=N.useState(null),V=Qy(Vy(Du,{activationConstraint:{distance:6}}));function B({active:X}){z(X.id)}function Q({active:X,over:G}){if(z(null),!G||X.id===G.id)return;const Y=h.find(pe=>pe.id===X.id);if(!Y)return;const J=h.find(pe=>pe.id===G.id),ne=J?J.status:G.id;Zh.includes(ne)&&Y.status!==ne&&u(X.id,{status:ne})}function K({active:X,over:G}){if(!G)return;const Y=h.find(ne=>ne.id===X.id),J=h.find(ne=>ne.id===G.id);!Y||!J||Y.status!==J.status&&u(X.id,{status:J.status})}const I=_?h.find(X=>X.id===_):null;return v.jsxs("div",{className:"project-view",children:[v.jsxs("header",{className:"project-view-header",children:[v.jsx("button",{className:"project-back-btn",onClick:()=>i({page:"projects"}),children:"← Projects"}),v.jsxs("div",{className:"project-view-title",children:[v.jsx("span",{className:"project-view-icon",children:f==null?void 0:f.icon}),v.jsx("span",{className:"project-view-name",children:f==null?void 0:f.name})]}),v.jsxs("div",{className:"project-view-actions",children:[v.jsxs("div",{className:"view-toggle",children:[v.jsx("button",{className:`view-toggle-btn ${g==="list"?"active":""}`,onClick:()=>b("list"),children:"List"}),v.jsx("button",{className:`view-toggle-btn ${g==="kanban"?"active":""}`,onClick:()=>b("kanban"),children:"Kanban"})]}),v.jsx("button",{className:"new-prd-btn",onClick:()=>{E(null),x(!0)},children:"+ New PRD"})]})]}),v.jsx("div",{className:"project-view-body",children:g==="list"?v.jsx("div",{className:"prd-list",children:h.length===0?v.jsx("div",{className:"prd-list-empty",children:"No PRDs yet — create one to get started."}):v.jsxs("table",{className:"prd-table",children:[v.jsx("thead",{children:v.jsxs("tr",{children:[v.jsx("th",{children:"Title"}),v.jsx("th",{children:"Status"}),v.jsx("th",{children:"Updated"}),v.jsx("th",{})]})}),v.jsx("tbody",{children:h.map(X=>v.jsxs("tr",{children:[v.jsx("td",{className:"prd-table-title",children:X.title}),v.jsx("td",{children:v.jsx(Ex,{status:X.status})}),v.jsx("td",{className:"prd-table-date",children:om(X.updatedAt)}),v.jsxs("td",{className:"prd-table-actions",children:[v.jsx("button",{className:"prd-action-btn",onClick:()=>i({page:"builder",prdId:X.id}),children:"Open →"}),v.jsx("button",{className:"prd-action-btn",onClick:()=>{E(X),x(!0)},children:"Edit"}),v.jsx("button",{className:"prd-action-btn prd-action-btn--danger",onClick:()=>d(X.id),children:"Delete"})]})]},X.id))})]})}):v.jsxs(Q1,{sensors:V,collisionDetection:Fy,onDragStart:B,onDragOver:K,onDragEnd:Q,children:[v.jsx("div",{className:"kanban-board",children:Zh.map(X=>v.jsx(Ax,{status:X,prds:h.filter(G=>G.status===X),onEdit:G=>{E(G),x(!0)},onDelete:G=>d(G),onOpen:G=>i({page:"builder",prdId:G.id}),activeId:_},X))}),v.jsx(ux,{children:I?v.jsx("div",{className:"kanban-card kanban-card--overlay",children:v.jsx("div",{className:"kanban-card-title",children:I.title})}):null})]})}),y&&v.jsx(Tx,{prd:A,projectId:o,onClose:()=>x(!1),onSave:X=>{A?u(A.id,X):s(o,X),x(!1)}})]})}function kx(){const[o,l]=N.useState(()=>!!wg()),[i,s]=N.useState(Qh),[u,d]=N.useState(!1),[f,h]=N.useState({page:"projects"}),[g,b]=N.useState([]),[y,x]=N.useState(!1),[A,E]=N.useState(null),[_,z]=N.useState(null),[V,B]=N.useState([]),[Q,K]=N.useState(null),[I,X]=N.useState(Tv),[G,Y]=N.useState(0),J=i&&!u;N.useEffect(()=>{if(!o||!i&&!u)return;async function q(){if(J)try{const F=await wy();b(F)}catch{Kh(),b(iu())}else Kh(),b(iu());x(!0)}q()},[o,i,u]);function ne(q){if(q.page==="builder"&&q.prdId){const F=g.find(ee=>ee.id===q.prdId);F&&pe(F)}h(q)}function pe(q){E({id:q.id,name:q.title,content:q.content}),B([]),z(null),K(Qv(q.title))}async function oe(q,F){if(J){const ee=await Cy({projectId:q,...F});b(se=>[ee,...se])}else{const ee={id:`prd-${Date.now()}`,projectId:q,status:"backlog",createdAt:new Date().toISOString(),updatedAt:new Date().toISOString(),...F};b(se=>{const w=[ee,...se];return ur(w),w})}}async function De(q,F){if(J){const ee=await Ny(q,{...F,updated:new Date().toISOString()});b(se=>se.map(w=>w.id===q?ee:w))}else b(ee=>{const se=ee.map(w=>w.id===q?{...w,...F,updatedAt:new Date().toISOString()}:w);return ur(se),se})}async function Ge(q){J&&await Ty(q),b(F=>{const ee=F.filter(se=>se.id!==q);return J||ur(ee),ee})}function He(q){if(z(q),A){const ee=[Ev({prdName:A.name,code:q,iteration:((Q==null?void 0:Q.iterations)??0)+1}),...I].slice(0,50);X(ee),Lh(ee)}}function Fe({inputTokens:q,outputTokens:F,cacheReadTokens:ee,componentsUsed:se}){K(w=>{if(!w)return w;const j={...w,iterations:w.iterations+1,inputTokens:w.inputTokens+q,outputTokens:w.outputTokens+F,cacheReadTokens:w.cacheReadTokens+ee,componentsUsed:[...new Set([...w.componentsUsed,...se])]};return j.cost=Vv(j),nu(j),j})}function M(){X([]),Lh([])}return o?!i&&!u?v.jsx(Ey,{onDone:()=>{Qh()?s(!0):d(!0)}}):y?f.page==="projects"?v.jsx(Ry,{prds:g,onNavigate:ne}):f.page==="project"?v.jsx(Rx,{projectId:f.projectId,prds:g,onNavigate:ne,onCreatePrd:oe,onUpdatePrd:De,onDeletePrd:Ge}):v.jsxs("div",{className:"app",children:[v.jsxs("header",{className:"app-header",children:[v.jsxs("div",{className:"app-header-left",children:[v.jsx("button",{className:"app-back-btn",onClick:()=>ne({page:"projects"}),children:"← Projects"}),v.jsx("span",{className:"app-header-sep"}),v.jsx("span",{className:"app-logo",children:"ennabl"}),v.jsx("span",{className:"app-logo-suffix",children:"builder"}),A&&v.jsx("span",{className:"app-prd-badge",children:A.name})]}),v.jsx(Ay,{prds:g,onSelect:pe})]}),v.jsxs("main",{className:"app-panels",children:[v.jsx(zv,{code:_,prd:A,history:I,onHistoryClear:M,onInitDesign:()=>Y(q=>q+1)}),v.jsx("div",{className:"app-divider"}),v.jsx(ty,{prd:A,messages:V,setMessages:B,onCodeGenerated:He,onIterationComplete:Fe,session:Q,onSessionUpdate:K,initTrigger:G})]})]}):v.jsx("div",{style:{height:"100dvh",display:"flex",alignItems:"center",justifyContent:"center",background:"var(--bg)",color:"var(--text-muted)",fontSize:13},children:"Loading…"}):v.jsx(ny,{onDone:()=>l(!0)})}z0.createRoot(document.getElementById("root")).render(v.jsx(N.StrictMode,{children:v.jsx(kx,{})}));
