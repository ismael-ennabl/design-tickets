 ...
 */var wh;function T0(){if(wh)return Ti;wh=1;var o=Symbol.for("react.transitional.element"),l=Symbol.for("react.fragment");function i(s,u,d){var f=null;if(d!==void 0&&(f=""+d),u.key!==void 0&&(f=""+u.key),"key"in u){d={};for(var h in u)h!=="key"&&(d[h]=u[h])}else d=u;return u=d.ref,{$$typeof:o,type:s,key:f,ref:u!==void 0?u:null,props:d}}return Ti.Fragment=l,Ti.jsx=i,Ti.jsxs=i,Ti}var Ch;function E0(){return Ch||(Ch=1,Yc.exports=T0()),Yc.exports}var v=E0(),Gc={exports:{}},oe={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Nh;function D0(){if(Nh)return oe;Nh=1;var o=Symbol.for("react.transitional.element"),l=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),u=Symbol.for("react.profiler"),d=Symbol.for("react.consumer"),f=Symbol.for("react.context"),h=Symbol.for("react.forward_ref"),g=Symbol.for("react.suspense"),b=Symbol.for("react.memo"),y=Symbol.for("react.lazy"),x=Symbol.for("react.activity"),A=Symbol.iterator;function E(w){return w===null||typeof w!="object"?null:(w=A&&w[A]||w["@@iterator"],typeof w=="function"?w:null)}var _={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},z=Object.assign,V={};function B(w,j,K){this.props=w,this.context=j,this.refs=V,this.updater=K||_}B.prototype.isReactComponent={},B.prototype.setState=function(w,j){if(typeof w!="object"&&typeof w!="function"&&w!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,w,j,"setState")},B.prototype.forceUpdate=function(w){this.updater.enqueueForceUpdate(this,w,"forceUpdate")};function Q(){}Q.prototype=B.prototype;function Z(w,j,K){this.props=w,this.context=j,this.refs=V,this.updater=K||_}var I=Z.prototype=new Q;I.constructor=Z,z(I,B.prototype),I.isPureReactComponent=!0;var X=Array.isArray;function G(){}var Y={H:null,A:null,T:null,S:null},J=Object.prototype.hasOwnProperty;function ee(w,j,K){var $=K.ref;return{$$typeof:o,type:w,key:j,ref:$!==void 0?$:null,props:K}}function de(w,j){return ee(w.type,j,w.props)}function ie(w){return typeof w=="object"&&w!==null&&w.$$typeof===o}function De(w){var j={"=":"=0",":":"=2"};return"$"+w.replace(/[=:]/g,function(K){return j[K]})}var Ge=/\/+/g;function He(w,j){return typeof w=="object"&&w!==null&&w.key!=null?De(""+w.key):j.toString(36)}function Fe(w){switch(w.status){case"fulfilled":return w.value;case"rejected":throw w.reason;default:switch(typeof w.status=="string"?w.then(G,G):(w.status="pending",w.then(function(j){w.status==="pending"&&(w.status="fulfilled",w.value=j)},function(j){w.status==="pending"&&(w.status="rejected",w.reason=j)})),w.status){case"fulfilled":return w.value;case"rejected":throw w.reason}}throw w}function M(w,j,K,$,se){var le=typeof w;(le==="undefined"||le==="boolean")&&(w=null);var me=!1;if(w===null)me=!0;else switch(le){case"bigint":case"string":case"number":me=!0;break;case"object":switch(w.$$typeof){case o:case l:me=!0;break;case y:return me=w._init,M(me(w._payload),j,K,$,se)}}if(me)return se=se(w),me=$===""?"."+He(w,0):$,X(se)?(K="",me!=null&&(K=me.replace(Ge,"$&/")+"/"),M(se,j,K,"",function(ve){return ve})):se!=null&&(ie(se)&&(se=de(se,K+(se.key==null||w&&w.key===se.key?"":(""+se.key).replace(Ge,"$&/")+"/")+me)),j.push(se)),1;me=0;var Ue=$===""?".":$+":";if(X(w))for(var Se=0;Se<w.length;Se++)$=w[Se],le=Ue+He($,Se),me+=M($,j,K,le,se);else if(Se=E(w),typeof Se=="function")for(w=Se.call(w),Se=0;!($=w.next()).done;)$=$.value,le=Ue+He($,Se++),me+=M($,j,K,le,se);else if(le==="object"){if(typeof w.then=="function")return M(Fe(w),j,K,$,se);throw j=String(w),Error("Objects are not valid as a React child (found: "+(j==="[object Object]"?"object with keys {"+Object.keys(w).join(", ")+"}":j)+"). If you meant to render a collection of children, use an array instead.")}return me}function q(w,j,K){if(w==null)return w;var $=[],se=0;return M(w,$,"","",function(le){return j.call(K,le,se++)}),$}function F(w){if(w._status===-1){var j=w._result;j=j(),j.then(function(K){(w._status===0||w._status===-1)&&(w._status=1,w._result=K)},function(K){(w._status===0||w._status===-1)&&(w._status=2,w._result=K)}),w._status===-1&&(w._status=0,w._result=j)}if(w._status===1)return w._result.default;throw w._result}var te=typeof reportError=="function"?reportError:function(w){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var j=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof w=="object"&&w!==null&&typeof w.message=="string"?String(w.message):String(w),error:w});if(!window.dispatchEvent(j))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",w);return}console.error(w)},re={map:q,forEach:function(w,j,K){q(w,function(){j.apply(this,arguments)},K)},count:function(w){var j=0;return q(w,function(){j++}),j},toArray:function(w){return q(w,function(j){return j})||[]},only:function(w){if(!ie(w))throw Error("React.Children.only expected to receive a single React element child.");return w}};return oe.Activity=x,oe.Children=re,oe.Component=B,oe.Fragment=i,oe.Profiler=u,oe.PureComponent=Z,oe.StrictMode=s,oe.Suspense=g,oe.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=Y,oe.__COMPILER_RUNTIME={__proto__:null,c:function(w){return Y.H.useMemoCache(w)}},oe.cache=function(w){return function(){return w.apply(null,arguments)}},oe.cacheSignal=function(){return null},oe.cloneElement=function(w,j,K){if(w==null)throw Error("The argument must be a React element, but you passed "+w+".");var $=z({},w.props),se=w.key;if(j!=null)for(le in j.key!==void 0&&(se=""+j.key),j)!J.call(j,le)||le==="key"||le==="__self"||le==="__source"||le==="ref"&&j.ref===void 0||($[le]=j[le]);var le=arguments.length-2;if(le===1)$.children=K;else if(1<le){for(var me=Array(le),Ue=0;Ue<le;Ue++)me[Ue]=arguments[Ue+2];$.children=me}return ee(w.type,se,$)},oe.createContext=function(w){return w={$$typeof:f,_currentValue:w,_currentValue2:w,_threadCount:0,Provider:null,Consumer:null},w.Provider=w,w.Consumer={$$typeof:d,_context:w},w},oe.createElement=function(w,j,K){var $,se={},le=null;if(j!=null)for($ in j.key!==void 0&&(le=""+j.key),j)J.call(j,$)&&$!=="key"&&$!=="__self"&&$!=="__source"&&(se[$]=j[$]);var me=arguments.length-2;if(me===1)se.children=K;else if(1<me){for(var Ue=Array(me),Se=0;Se<me;Se++)Ue[Se]=arguments[Se+2];se.children=Ue}if(w&&w.defaultProps)for($ in me=w.defaultProps,me)se[$]===void 0&&(se[$]=me[$]);return ee(w,le,se)},oe.createRef=function(){return{current:null}},oe.forwardRef=function(w){return{$$typeof:h,render:w}},oe.isValidElement=ie,oe.lazy=function(w){return{$$typeof:y,_payload:{_status:-1,_result:w},_init:F}},oe.memo=function(w,j){return{$$typeof:b,type:w,compare:j===void 0?null:j}},oe.startTransition=function(w){var j=Y.T,K={};Y.T=K;try{var $=w(),se=Y.S;se!==null&&se(K,$),typeof $=="object"&&$!==null&&typeof $.then=="function"&&$.then(G,te)}catch(le){te(le)}finally{j!==null&&K.types!==null&&(j.types=K.types),Y.T=j}},oe.unstable_useCacheRefresh=function(){return Y.H.useCacheRefresh()},oe.use=function(w){return Y.H.use(w)},oe.useActionState=function(w,j,K){return Y.H.useActionState(w,j,K)},oe.useCallback=function(w,j){return Y.H.useCallback(w,j)},oe.useContext=function(w){return Y.H.useContext(w)},oe.useDebugValue=function(){},oe.useDeferredValue=function(w,j){return Y.H.useDeferredValue(w,j)},oe.useEffect=function(w,j){return Y.H.useEffect(w,j)},oe.useEffectEvent=function(w){return Y.H.useEffectEvent(w)},oe.useId=function(){return Y.H.useId()},oe.useImperativeHandle=function(w,j,K){return Y.H.useImperativeHandle(w,j,K)},oe.useInsertionEffect=function(w,j){return Y.H.useInsertionEffect(w,j)},oe.useLayoutEffect=function(w,j){return Y.H.useLayoutEffect(w,j)},oe.useMemo=function(w,j){return Y.H.useMemo(w,j)},oe.useOptimistic=function(w,j){return Y.H.useOptimistic(w,j)},oe.useReducer=function(w,j,K){return Y.H.useReducer(w,j,K)},oe.useRef=function(w){return Y.H.useRef(w)},oe.useState=function(w){return Y.H.useState(w)},oe.useSyncExternalStore=function(w,j,K){return Y.H.useSyncExternalStore(w,j,K)},oe.useTransition=function(){return Y.H.useTransition()},oe.version="19.2.6",oe}var Th;function cu(){return Th||(Th=1,Gc.exports=D0()),Gc.exports}var N=cu();const qe=N0(N);var Xc={exports:{}},Ei={},Vc={exports:{}},Qc={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Eh;function A0(){return Eh||(Eh=1,(function(o){function l(M,q){var F=M.length;M.push(q);e:for(;0<F;){var te=F-1>>>1,re=M[te];if(0<u(re,q))M[te]=q,M[F]=re,F=te;else break e}}function i(M){return M.length===0?null:M[0]}function s(M){if(M.length===0)return null;var q=M[0],F=M.pop();if(F!==q){M[0]=F;e:for(var te=0,re=M.length,w=re>>>1;te<w;){var j=2*(te+1)-1,K=M[j],$=j+1,se=M[$];if(0>u(K,F))$<re&&0>u(se,K)?(M[te]=se,M[$]=F,te=$):(M[te]=K,M[j]=F,te=j);else if($<re&&0>u(se,F))M[te]=se,M[$]=F,te=$;else break e}}return q}function u(M,q){var F=M.sortIndex-q.sortIndex;return F!==0?F:M.id-q.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var d=performance;o.unstable_now=function(){return d.now()}}else{var f=Date,h=f.now();o.unstable_now=function(){return f.now()-h}}var g=[],b=[],y=1,x=null,A=3,E=!1,_=!1,z=!1,V=!1,B=typeof setTimeout=="function"?setTimeout:null,Q=typeof clearTimeout=="function"?clearTimeout:null,Z=typeof setImmediate<"u"?setImmediate:null;function I(M){for(var q=i(b);q!==null;){if(q.callback===null)s(b);else if(q.startTime<=M)s(b),q.sortIndex=q.expirationTime,l(g,q);else break;q=i(b)}}function X(M){if(z=!1,I(M),!_)if(i(g)!==null)_=!0,G||(G=!0,De());else{var q=i(b);q!==null&&Fe(X,q.startTime-M)}}var G=!1,Y=-1,J=5,ee=-1;function de(){return V?!0:!(o.unstable_now()-ee<J)}function ie(){if(V=!1,G){var M=o.unstable_now();ee=M;var q=!0;try{e:{_=!1,z&&(z=!1,Q(Y),Y=-1),E=!0;var F=A;try{t:{for(I(M),x=i(g);x!==null&&!(x.expirationTime>M&&de());){var te=x.callback;if(typeof te=="function"){x.callback=null,A=x.priorityLevel;var re=te(x.expirationTime<=M);if(M=o.unstable_now(),typeof re=="function"){x.callback=re,I(M),q=!0;break t}x===i(g)&&s(g),I(M)}else s(g);x=i(g)}if(x!==null)q=!0;else{var w=i(b);w!==null&&Fe(X,w.startTime-M),q=!1}}break e}finally{x=null,A=F,E=!1}q=void 0}}finally{q?De():G=!1}}}var De;if(typeof Z=="function")De=function(){Z(ie)};else if(typeof MessageChannel<"u"){var Ge=new MessageChannel,He=Ge.port2;Ge.port1.onmessage=ie,De=function(){He.postMessage(null)}}else De=function(){B(ie,0)};function Fe(M,q){Y=B(function(){M(o.unstable_now())},q)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(M){M.callback=null},o.unstable_forceFrameRate=function(M){0>M||125<M?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):J=0<M?Math.floor(1e3/M):5},o.unstable_getCurrentPriorityLevel=function(){return A},o.unstable_next=function(M){switch(A){case 1:case 2:case 3:var q=3;break;default:q=A}var F=A;A=q;try{return M()}finally{A=F}},o.unstable_requestPaint=function(){V=!0},o.unstable_runWithPriority=function(M,q){switch(M){case 1:case 2:case 3:case 4:case 5:break;default:M=3}var F=A;A=M;try{return q()}finally{A=F}},o.unstable_scheduleCallback=function(M,q,F){var te=o.unstable_now();switch(typeof F=="object"&&F!==null?(F=F.delay,F=typeof F=="number"&&0<F?te+F:te):F=te,M){case 1:var re=-1;break;case 2:re=250;break;case 5:re=1073741823;break;case 4:re=1e4;break;default:re=5e3}return re=F+re,M={id:y++,callback:q,priorityLevel:M,startTime:F,expirationTime:re,sortIndex:-1},F>te?(M.sortIndex=F,l(b,M),i(g)===null&&M===i(b)&&(z?(Q(Y),Y=-1):z=!0,Fe(X,F-te))):(M.sortIndex=re,l(g,M),_||E||(_=!0,G||(G=!0,De()))),M},o.unstable_shouldYield=de,o.unstable_wrapCallback=function(M){var q=A;return function(){var F=A;A=q;try{return M.apply(this,arguments)}finally{A=F}}}})(Qc)),Qc}var Dh;function k0(){return Dh||(Dh=1,Vc.exports=A0()),Vc.exports}var Zc={exports:{}},ht={};/**
 * @license React
...
`,status:"doing",createdAt:new Date(Date.now()-1440*60*1e3).toISOString(),updatedAt:new Date(Date.now()-7200*1e3).toISOString()}];function iu(){try{return JSON.parse(localStorage.getItem(Mg)||"[]")}catch{return[]}}function ur(o){localStorage.setItem(Mg,JSON.stringify(o))}function Ih(){iu().length===0&&ur(jy)}function Lg(o){return _g.find(l=>l.id===o)||null}function My({prds:o=[],onSelect:l}){const[i,s]=N.useState(""),[u,d]=N.useState([]),[f,h]=N.useState(!1),[g,b]=N.useState(0),y=N.useRef(),x=N.useRef();N.useEffect(()=>{if(!i.trim()){d([]),h(!1);return}const E=i.toLowerCase(),_=o.filter(z=>z.title.toLowerCase().includes(E)).slice(0,8);d(_),h(_.length>0),b(0)},[i,o]),N.useEffect(()=>{function E(_){f&&(_.key==="ArrowDown"&&(_.preventDefault(),b(z=>Math.min(z+1,u.length-1))),_.key==="ArrowUp"&&(_.preventDefault(),b(z=>Math.max(z-1,0))),_.key==="Enter"&&(_.preventDefault(),u[g]&&A(u[g])),_.key==="Escape"&&h(!1))}return window.addEventListener("keydown",E),()=>window.removeEventListener("keydown",E)},[f,u,g]),N.useEffect(()=>{function E(_){var z,V;!((z=x.current)!=null&&z.contains(_.target))&&!((V=y.current)!=null&&V.contains(_.target))&&h(!1)}return document.addEventListener("mousedown",E),()=>document.removeEventListener("mousedown",E)},[]);function A(E){var _;l(E),s(""),h(!1),(_=y.current)==null||_.blur()}return v.jsxs("div",{className:"prd-search",children:[v.jsxs("div",{className:"prd-search-input-wrap",children:[v.jsx("span",{className:"prd-search-icon",children:"⌕"}),v.jsx("input",{ref:y,className:"prd-search-input",type:"text",placeholder:"Search PRDs…",value:i,onChange:E=>s(E.target.value),onFocus:()=>{u.length&&h(!0)}}),i&&v.jsx("button",{className:"prd-search-clear",onClick:()=>{s(""),h(!1)},children:"✕"})]}),f&&v.jsx("div",{ref:x,className:"prd-search-dropdown",children:u.map((E,_)=>{const z=Lg(E.projectId);return v.jsxs("button",{className:`prd-search-result ${_===g?"prd-search-result--active":""}`,onMouseEnter:()=>b(_),onClick:()=>A(E),children:[v.jsx("span",{className:"prd-search-result-title",children:E.title}),v.jsxs("span",{className:"prd-search-result-project",children:[z==null?void 0:z.icon," ",z==null?void 0:z.name]})]},E.id)})})]})}function _y({prds:o,onNavigate:l}){return v.jsxs("div",{className:"projects-page",children:[v.jsx("header",{className:"projects-header",children:v.jsxs("div",{className:"projects-logo",children:[v.jsx("span",{className:"projects-logo-name",children:"ennabl"}),v.jsx("span",{className:"projects-logo-suffix",children:"builder"})]})}),v.jsxs("main",{className:"projects-main",children:[v.jsx("h1",{className:"projects-title",children:"Projects"}),v.jsx("div",{className:"projects-grid",children:_g.map(i=>{const s=o.filter(d=>d.projectId===i.id),u=s.filter(d=>d.status==="doing").length;return v.jsxs("button",{className:"project-card",onClick:()=>l({page:"project",projectId:i.id}),children:[v.jsx("div",{className:"project-card-icon",children:i.icon}),v.jsx("div",{className:"project-card-name",children:i.name}),v.jsx("div",{className:"project-card-meta",children:s.length>0?v.jsxs(v.Fragment,{children:[v.jsxs("span",{className:"project-card-count",children:[s.length," PRD",s.length!==1?"s":""]}),u>0&&v.jsxs("span",{className:"project-card-doing",children:[u," doing"]})]}):v.jsx("span",{className:"project-card-empty",children:"No PRDs yet"})})]},i.id)})})]})]})}var ki=og();function Uy(){for(var o=arguments.length,l=new Array(o),i=0;i<o;i++)l[i]=arguments[i];return N.useMemo(()=>s=>{l.forEach(u=>u(s))},l)}const Cr=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";function Rl(o){const l=Object.prototype.toString.call(o);return l==="[object Window]"||l==="[object global]"}function wu(o){return"nodeType"in o}function vt(o){var l,i;return o?Rl(o)?o:wu(o)&&(l=(i=o.ownerDocument)==null?void 0:i.defaultView)!=null?l:window:window}function Cu(o){const{Document:l}=vt(o);return o instanceof l}function Hi(o){return Rl(o)?!1:o instanceof vt(o).HTMLElement}function qg(o){return o instanceof vt(o).SVGElement}function Ol(o){return o?Rl(o)?o.document:wu(o)?Cu(o)?o:Hi(o)||qg(o)?o.ownerDocument:document:document:document}const on=Cr?N.useLayoutEffect:N.useEffect;function Nr(o){const l=N.useRef(o);return on(()=>{l.current=o}),N.useCallback(function(){for(var i=arguments.length,s=new Array(i),u=0;u<i;u++)s[u]=arguments[u];return l.current==null?void 0:l.current(...s)},[])}function Ly(){const o=N.useRef(null),l=N.useCallback((s,u)=>{o.current=setInterval(s,u)},[]),i=N.useCallback(()=>{o.current!==null&&(clearInterval(o.current),o.current=null)},[]);return[l,i]}function _i(o,l){l===void 0&&(l=[o]);const i=N.useRef(o);return on(()=>{i.current!==o&&(i.current=o)},l),i}function Bi(o,l){const i=N.useRef();return N.useMemo(()=>{const s=o(i.current);return i.current=s,s},[...l])}function gr(o){const l=Nr(o),i=N.useRef(null),s=N.useCallback(u=>{u!==i.current&&(l==null||l(u,i.current)),i.current=u},[]);return[i,s]}function mr(o){const l=N.useRef();return N.useEffect(()=>{l.current=o},[o]),l.current}let $c={};function Yi(o,l){return N.useMemo(()=>{if(l)return l;const i=$c[o]==null?0:$c[o]+1;return $c[o]=i,o+"-"+i},[o,l])}function Hg(o){return function(l){for(var i=arguments.length,s=new Array(i>1?i-1:0),u=1;u<i;u++)s[u-1]=arguments[u];return s.reduce((d,f)=>{const h=Object.entries(f);for(const[g,b]of h){const y=d[g];y!=null&&(d[g]=y+o*b)}return d},{...l})}}const kl=Hg(1),br=Hg(-1);function qy(o){return"clientX"in o&&"clientY"in o}function Tr(o){if(!o)return!1;const{KeyboardEvent:l}=vt(o.target);return l&&o instanceof l}function Hy(o){if(!o)return!1;const{TouchEvent:l}=vt(o.target);return l&&o instanceof l}function vr(o){if(Hy(o)){if(o.touches&&o.touches.length){const{clientX:l,clientY:i}=o.touches[0];return{x:l,y:i}}else if(o.changedTouches&&o.changedTouches.length){const{clientX:l,clientY:i}=o.changedTouches[0];return{x:l,y:i}}}return qy(o)?{x:o.clientX,y:o.clientY}:null}const ba=Object.freeze({Translate:{toString(o){if(!o)return;const{x:l,y:i}=o;return"translate3d("+(l?Math.round(l):0)+"px, "+(i?Math.round(i):0)+"px, 0)"}},Scale:{toString(o){if(!o)return;const{scaleX:l,scaleY:i}=o;return"scaleX("+l+") scaleY("+i+")"}},Transform:{toString(o){if(o)return[ba.Translate.toString(o),ba.Scale.toString(o)].join(" ")}},Transition:{toString(o){let{property:l,duration:i,easing:s}=o;return l+" "+i+"ms "+s}}}),Jh="a,frame,iframe,input:not([type=hidden]):not(:disabled),select:not(:disabled),textarea:not(:disabled),button:not(:disabled),*[tabindex]";function By(o){return o.matches(Jh)?o:o.querySelector(Jh)}const Yy={display:"none"};function Gy(o){let{id:l,value:i}=o;return qe.createElement("div",{id:l,style:Yy},i)}function Xy(o){let{id:l,announcement:i,ariaLiveType:s="assertive"}=o;const u={position:"fixed",top:0,left:0,width:1,height:1,margin:-1,border:0,padding:0,overflow:"hidden",clip:"rect(0 0 0 0)",clipPath:"inset(100%)",whiteSpace:"nowrap"};return qe.createElement("div",{id:l,style:u,role:"status","aria-live":s,"aria-atomic":!0},i)}function Vy(){const[o,l]=N.useState("");return{announce:N.useCallback(s=>{s!=null&&l(s)},[]),announcement:o}}const Bg=N.createContext(null);function Qy(o){const l=N.useContext(Bg);N.useEffect(()=>{if(!l)throw new Error("useDndMonitor must be used within a children of <DndContext>");return l(o)},[o,l])}function Zy(){const[o]=N.useState(()=>new Set),l=N.useCallback(s=>(o.add(s),()=>o.delete(s)),[o]);return[N.useCallback(s=>{let{type:u,event:d}=s;o.forEach(f=>{var h;return(h=f[u])==null?void 0:h.call(f,d)})},[o]),l]}const Ky={draggable:`
    To pick up a draggable item, press the space bar.
    While dragging, use the arrow keys to move the item.
    Press space again to drop the item in its new position, or press escape to cancel.
  `},Iy={onDragStart(o){let{active:l}=o;return"Picked up draggable item "+l.id+"."},onDragOver(o){let{active:l,over:i}=o;return i?"Draggable item "+l.id+" was moved over droppable area "+i.id+".":"Draggable item "+l.id+" is no longer over a droppable area."},onDragEnd(o){let{active:l,over:i}=o;return i?"Draggable item "+l.id+" was dropped over droppable area "+i.id:"Draggable item "+l.id+" was dropped."},onDragCancel(o){let{active:l}=o;return"Dragging was cancelled. Draggable item "+l.id+" was dropped."}};function Jy(o){let{announcements:l=Iy,container:i,hiddenTextDescribedById:s,screenReaderInstructions:u=Ky}=o;const{announce:d,announcement:f}=Vy(),h=Yi("DndLiveRegion"),[g,b]=N.useState(!1);if(N.useEffect(()=>{b(!0)},[]),Qy(N.useMemo(()=>({onDragStart(x){let{active:A}=x;d(l.onDragStart({active:A}))},onDragMove(x){let{active:A,over:E}=x;l.onDragMove&&d(l.onDragMove({active:A,over:E}))},onDragOver(x){let{active:A,over:E}=x;d(l.onDragOver({active:A,over:E}))},onDragEnd(x){let{active:A,over:E}=x;d(l.onDragEnd({active:A,over:E}))},onDragCancel(x){let{active:A,over:E}=x;d(l.onDragCancel({active:A,over:E}))}}),[d,l])),!g)return null;const y=qe.createElement(qe.Fragment,null,qe.createElement(Gy,{id:s,value:u.draggable}),qe.createElement(Xy,{id:h,announcement:f}));return i?ki.createPortal(y,i):y}var et;(function(o){o.DragStart="dragStart",o.DragMove="dragMove",o.DragEnd="dragEnd",o.DragCancel="dragCancel",o.DragOver="dragOver",o.RegisterDroppable="registerDroppable",o.SetDroppableDisabled="setDroppableDisabled",o.UnregisterDroppable="unregisterDroppable"})(et||(et={}));function yr(){}function $y(o,l){return N.useMemo(()=>({sensor:o,options:l??{}}),[o,l])}function Fy(){for(var o=arguments.length,l=new Array(o),i=0;i<o;i++)l[i]=arguments[i];return N.useMemo(()=>[...l].filter(s=>s!=null),[...l])}const cn=Object.freeze({x:0,y:0});function Wy(o,l){return Math.sqrt(Math.pow(o.x-l.x,2)+Math.pow(o.y-l.y,2))}function Py(o,l){const i=vr(o);if(!i)return"0 0";const s={x:(i.x-l.left)/l.width*100,y:(i.y-l.top)/l.height*100};return s.x+"% "+s.y+"%"}function e1(o,l){let{data:{value:i}}=o,{data:{value:s}}=l;return i-s}function t1(o,l){let{data:{value:i}}=o,{data:{value:s}}=l;return s-i}function $h(o){let{left:l,top:i,height:s,width:u}=o;return[{x:l,y:i},{x:l+u,y:i},{x:l,y:i+s},{x:l+u,y:i+s}]}function n1(o,l){if(!o||o.length===0)return null;const[i]=o;return i[l]}const a1=o=>{let{collisionRect:l,droppableRects:i,droppableContainers:s}=o;const u=$h(l),d=[];for(const f of s){const{id:h}=f,g=i.get(h);if(g){const b=$h(g),y=u.reduce((A,E,_)=>A+Wy(b[_],E),0),x=Number((y/4).toFixed(4));d.push({id:h,data:{droppableContainer:f,value:x}})}}return d.sort(e1)};function l1(o,l){const i=Math.max(l.top,o.top),s=Math.max(l.left,o.left),u=Math.min(l.left+l.width,o.left+o.width),d=Math.min(l.top+l.height,o.top+o.height),f=u-s,h=d-i;if(s<u&&i<d){const g=l.width*l.height,b=o.width*o.height,y=f*h,x=y/(g+b-y);return Number(x.toFixed(4))}return 0}const i1=o=>{let{collisionRect:l,droppableRects:i,droppableContainers:s}=o;const u=[];for(const d of s){const{id:f}=d,h=i.get(f);if(h){const g=l1(h,l);g>0&&u.push({id:f,data:{droppableContainer:d,value:g}})}}return u.sort(t1)};function s1(o,l,i){return{...o,scaleX:l&&i?l.width/i.width:1,scaleY:l&&i?l.height/i.height:1}}function Yg(o,l){return o&&l?{x:o.left-l.left,y:o.top-l.top}:cn}function r1(o){return function(i){for(var s=arguments.length,u=new Array(s>1?s-1:0),d=1;d<s;d++)u[d-1]=arguments[d];return u.reduce((f,h)=>({...f,top:f.top+o*h.y,bottom:f.bottom+o*h.y,left:f.left+o*h.x,right:f.right+o*h.x}),{...i})}}const o1=r1(1);function Gg(o){if(o.startsWith("matrix3d(")){const l=o.slice(9,-1).split(/, /);return{x:+l[12],y:+l[13],scaleX:+l[0],scaleY:+l[5]}}else if(o.startsWith("matrix(")){const l=o.slice(7,-1).split(/, /);return{x:+l[4],y:+l[5],scaleX:+l[0],scaleY:+l[3]}}return null}function c1(o,l,i){const s=Gg(l);if(!s)return o;const{scaleX:u,scaleY:d,x:f,y:h}=s,g=o.left-f-(1-u)*parseFloat(i),b=o.top-h-(1-d)*parseFloat(i.slice(i.indexOf(" ")+1)),y=u?o.width/u:o.width,x=d?o.height/d:o.height;return{width:y,height:x,top:b,right:g+y,bottom:b+x,left:g}}const u1={ignoreTransform:!1};function zl(o,l){l===void 0&&(l=u1);let i=o.getBoundingClientRect();if(l.ignoreTransform){const{transform:b,transformOrigin:y}=vt(o).getComputedStyle(o);b&&(i=c1(i,b,y))}const{top:s,left:u,width:d,height:f,bottom:h,right:g}=i;return{top:s,left:u,width:d,height:f,bottom:h,right:g}}function Fh(o){return zl(o,{ignoreTransform:!0})}function d1(o){const l=o.innerWidth,i=o.innerHeight;return{top:0,left:0,right:l,bottom:i,width:l,height:i}}function f1(o,l){return l===void 0&&(l=vt(o).getComputedStyle(o)),l.position==="fixed"}function p1(o,l){l===void 0&&(l=vt(o).getComputedStyle(o));const i=/(auto|scroll|overlay)/;return["overflow","overflowX","overflowY"].some(u=>{const d=l[u];return typeof d=="string"?i.test(d):!1})}function Nu(o,l){const i=[];function s(u){if(l!=null&&i.length>=l||!u)return i;if(Cu(u)&&u.scrollingElement!=null&&!i.includes(u.scrollingElement))return i.push(u.scrollingElement),i;if(!Hi(u)||qg(u)||i.includes(u))return i;const d=vt(o).getComputedStyle(u);return u!==o&&p1(u,d)&&i.push(u),f1(u,d)?i:s(u.parentNode)}return o?s(o):i}function Xg(o){const[l]=Nu(o,1);return l??null}function Fc(o){return!Cr||!o?null:Rl(o)?o:wu(o)?Cu(o)||o===Ol(o).scrollingElement?window:Hi(o)?o:null:null}function Vg(o){return Rl(o)?o.scrollX:o.scrollLeft}function Qg(o){return Rl(o)?o.scrollY:o.scrollTop}function su(o){return{x:Vg(o),y:Qg(o)}}var lt;(function(o){o[o.Forward=1]="Forward",o[o.Backward=-1]="Backward"})(lt||(lt={}));function Zg(o){return!Cr||!o?!1:o===document.scrollingElement}function Kg(o){const l={x:0,y:0},i=Zg(o)?{height:window.innerHeight,width:window.innerWidth}:{height:o.clientHeight,width:o.clientWidth},s={x:o.scrollWidth-i.width,y:o.scrollHeight-i.height},u=o.scrollTop<=l.y,d=o.scrollLeft<=l.x,f=o.scrollTop>=s.y,h=o.scrollLeft>=s.x;return{isTop:u,isLeft:d,isBottom:f,isRight:h,maxScroll:s,minScroll:l}}const h1={x:.2,y:.2};function g1(o,l,i,s,u){let{top:d,left:f,right:h,bottom:g}=i;s===void 0&&(s=10),u===void 0&&(u=h1);const{isTop:b,isBottom:y,isLeft:x,isRight:A}=Kg(o),E={x:0,y:0},_={x:0,y:0},z={height:l.height*u.y,width:l.width*u.x};return!b&&d<=l.top+z.height?(E.y=lt.Backward,_.y=s*Math.abs((l.top+z.height-d)/z.height)):!y&&g>=l.bottom-z.height&&(E.y=lt.Forward,_.y=s*Math.abs((l.bottom-z.height-g)/z.height)),!A&&h>=l.right-z.width?(E.x=lt.Forward,_.x=s*Math.abs((l.right-z.width-h)/z.width)):!x&&f<=l.left+z.width&&(E.x=lt.Backward,_.x=s*Math.abs((l.left+z.width-f)/z.width)),{direction:E,speed:_}}function m1(o){if(o===document.scrollingElement){const{innerWidth:d,innerHeight:f}=window;return{top:0,left:0,right:d,bottom:f,width:d,height:f}}const{top:l,left:i,right:s,bottom:u}=o.getBoundingClientRect();return{top:l,left:i,right:s,bottom:u,width:o.clientWidth,height:o.clientHeight}}function Ig(o){return o.reduce((l,i)=>kl(l,su(i)),cn)}function b1(o){return o.reduce((l,i)=>l+Vg(i),0)}function v1(o){return o.reduce((l,i)=>l+Qg(i),0)}function Jg(o,l){if(l===void 0&&(l=zl),!o)return;const{top:i,left:s,bottom:u,right:d}=l(o);Xg(o)&&(u<=0||d<=0||i>=window.innerHeight||s>=window.innerWidth)&&o.scrollIntoView({block:"center",inline:"center"})}const y1=[["x",["left","right"],b1],["y",["top","bottom"],v1]];class Tu{constructor(l,i){this.rect=void 0,this.width=void 0,this.height=void 0,this.top=void 0,this.bottom=void 0,this.right=void 0,this.left=void 0;const s=Nu(i),u=Ig(s);this.rect={...l},this.width=l.width,this.height=l.height;for(const[d,f,h]of y1)for(const g of f)Object.defineProperty(this,g,{get:()=>{const b=h(s),y=u[d]-b;return this.rect[g]+y},enumerable:!0});Object.defineProperty(this,"rect",{enumerable:!1})}}class zi{constructor(l){this.target=void 0,this.listeners=[],this.removeAll=()=>{this.listeners.forEach(i=>{var s;return(s=this.target)==null?void 0:s.removeEventListener(...i)})},this.target=l}add(l,i,s){var u;(u=this.target)==null||u.addEventListener(l,i,s),this.listeners.push([l,i,s])}}function x1(o){const{EventTarget:l}=vt(o);return o instanceof l?o:Ol(o)}function Wc(o,l){const i=Math.abs(o.x),s=Math.abs(o.y);return typeof l=="number"?Math.sqrt(i**2+s**2)>l:"x"in l&&"y"in l?i>l.x&&s>l.y:"x"in l?i>l.x:"y"in l?s>l.y:!1}var en;(function(o){o.Click="click",o.DragStart="dragstart",o.Keydown="keydown",o.ContextMenu="contextmenu",o.Resize="resize",o.SelectionChange="selectionchange",o.VisibilityChange="visibilitychange"})(en||(en={}));function Wh(o){o.preventDefault()}function S1(o){o.stopPropagation()}var Ce;(function(o){o.Space="Space",o.Down="ArrowDown",o.Right="ArrowRight",o.Left="ArrowLeft",o.Up="ArrowUp",o.Esc="Escape",o.Enter="Enter",o.Tab="Tab"})(Ce||(Ce={}));const $g={start:[Ce.Space,Ce.Enter],cancel:[Ce.Esc],end:[Ce.Space,Ce.Enter,Ce.Tab]},w1=(o,l)=>{let{currentCoordinates:i}=l;switch(o.code){case Ce.Right:return{...i,x:i.x+25};case Ce.Left:return{...i,x:i.x-25};case Ce.Down:return{...i,y:i.y+25};case Ce.Up:return{...i,y:i.y-25}}};class Fg{constructor(l){this.props=void 0,this.autoScrollEnabled=!1,this.referenceCoordinates=void 0,this.listeners=void 0,this.windowListeners=void 0,this.props=l;const{event:{target:i}}=l;this.props=l,this.listeners=new zi(Ol(i)),this.windowListeners=new zi(vt(i)),this.handleKeyDown=this.handleKeyDown.bind(this),this.handleCancel=this.handleCancel.bind(this),this.attach()}attach(){this.handleStart(),this.windowListeners.add(en.Resize,this.handleCancel),this.windowListeners.add(en.VisibilityChange,this.handleCancel),setTimeout(()=>this.listeners.add(en.Keydown,this.handleKeyDown))}handleStart(){const{activeNode:l,onStart:i}=this.props,s=l.node.current;s&&Jg(s),i(cn)}handleKeyDown(l){if(Tr(l)){const{active:i,context:s,options:u}=this.props,{keyboardCodes:d=$g,coordinateGetter:f=w1,scrollBehavior:h="smooth"}=u,{code:g}=l;if(d.end.includes(g)){this.handleEnd(l);return}if(d.cancel.includes(g)){this.handleCancel(l);return}const{collisionRect:b}=s.current,y=b?{x:b.left,y:b.top}:cn;this.referenceCoordinates||(this.referenceCoordinates=y);const x=f(l,{active:i,context:s.current,currentCoordinates:y});if(x){const A=br(x,y),E={x:0,y:0},{scrollableAncestors:_}=s.current;for(const z of _){const V=l.code,{isTop:B,isRight:Q,isLeft:Z,isBottom:I,maxScroll:X,minScroll:G}=Kg(z),Y=m1(z),J={x:Math.min(V===Ce.Right?Y.right-Y.width/2:Y.right,Math.max(V===Ce.Right?Y.left:Y.left+Y.width/2,x.x)),y:Math.min(V===Ce.Down?Y.bottom-Y.height/2:Y.bottom,Math.max(V===Ce.Down?Y.top:Y.top+Y.height/2,x.y))},ee=V===Ce.Right&&!Q||V===Ce.Left&&!Z,de=V===Ce.Down&&!I||V===Ce.Up&&!B;if(ee&&J.x!==x.x){const ie=z.scrollLeft+A.x,De=V===Ce.Right&&ie<=X.x||V===Ce.Left&&ie>=G.x;if(De&&!A.y){z.scrollTo({left:ie,behavior:h});return}De?E.x=z.scrollLeft-ie:E.x=V===Ce.Right?z.scrollLeft-X.x:z.scrollLeft-G.x,E.x&&z.scrollBy({left:-E.x,behavior:h});break}else if(de&&J.y!==x.y){const ie=z.scrollTop+A.y,De=V===Ce.Down&&ie<=X.y||V===Ce.Up&&ie>=G.y;if(De&&!A.x){z.scrollTo({top:ie,behavior:h});return}De?E.y=z.scrollTop-ie:E.y=V===Ce.Down?z.scrollTop-X.y:z.scrollTop-G.y,E.y&&z.scrollBy({top:-E.y,behavior:h});break}}this.handleMove(l,kl(br(x,this.referenceCoordinates),E))}}}handleMove(l,i){const{onMove:s}=this.props;l.preventDefault(),s(i)}handleEnd(l){const{onEnd:i}=this.props;l.preventDefault(),this.detach(),i()}handleCancel(l){const{onCancel:i}=this.props;l.preventDefault(),this.detach(),i()}detach(){this.listeners.removeAll(),this.windowListeners.removeAll()}}Fg.activators=[{eventName:"onKeyDown",handler:(o,l,i)=>{let{keyboardCodes:s=$g,onActivation:u}=l,{active:d}=i;const{code:f}=o.nativeEvent;if(s.start.includes(f)){const h=d.activatorNode.current;return h&&o.target!==h?!1:(o.preventDefault(),u==null||u({event:o.nativeEvent}),!0)}return!1}}];function Ph(o){return!!(o&&"distance"in o)}function eg(o){return!!(o&&"delay"in o)}class Eu{constructor(l,i,s){var u;s===void 0&&(s=x1(l.event.target)),this.props=void 0,this.events=void 0,this.autoScrollEnabled=!0,this.document=void 0,this.activated=!1,this.initialCoordinates=void 0,this.timeoutId=null,this.listeners=void 0,this.documentListeners=void 0,this.windowListeners=void 0,this.props=l,this.events=i;const{event:d}=l,{target:f}=d;this.props=l,this.events=i,this.document=Ol(f),this.documentListeners=new zi(this.document),this.listeners=new zi(s),this.windowListeners=new zi(vt(f)),this.initialCoordinates=(u=vr(d))!=null?u:cn,this.handleStart=this.handleStart.bind(this),this.handleMove=this.handleMove.bind(this),this.handleEnd=this.handleEnd.bind(this),this.handleCancel=this.handleCancel.bind(this),this.handleKeydown=this.handleKeydown.bind(this),this.removeTextSelection=this.removeTextSelection.bind(this),this.attach()}attach(){const{events:l,props:{options:{activationConstraint:i,bypassActivationConstraint:s}}}=this;if(this.listeners.add(l.move.name,this.handleMove,{passive:!1}),this.listeners.add(l.end.name,this.handleEnd),l.cancel&&this.listeners.add(l.cancel.name,this.handleCancel),this.windowListeners.add(en.Resize,this.handleCancel),this.windowListeners.add(en.DragStart,Wh),this.windowListeners.add(en.VisibilityChange,this.handleCancel),this.windowListeners.add(en.ContextMenu,Wh),this.documentListeners.add(en.Keydown,this.handleKeydown),i){if(s!=null&&s({event:this.props.event,activeNode:this.props.activeNode,options:this.props.options}))return this.handleStart();if(eg(i)){this.timeoutId=setTimeout(this.handleStart,i.delay),this.handlePending(i);return}if(Ph(i)){this.handlePending(i);return}}this.handleStart()}detach(){this.listeners.removeAll(),this.windowListeners.removeAll(),setTimeout(this.documentListeners.removeAll,50),this.timeoutId!==null&&(clearTimeout(this.timeoutId),this.timeoutId=null)}handlePending(l,i){const{active:s,onPending:u}=this.props;u(s,l,this.initialCoordinates,i)}handleStart(){const{initialCoordinates:l}=this,{onStart:i}=this.props;l&&(this.activated=!0,this.documentListeners.add(en.Click,S1,{capture:!0}),this.removeTextSelection(),this.documentListeners.add(en.SelectionChange,this.removeTextSelection),i(l))}handleMove(l){var i;const{activated:s,initialCoordinates:u,props:d}=this,{onMove:f,options:{activationConstraint:h}}=d;if(!u)return;const g=(i=vr(l))!=null?i:cn,b=br(u,g);if(!s&&h){if(Ph(h)){if(h.tolerance!=null&&Wc(b,h.tolerance))return this.handleCancel();if(Wc(b,h.distance))return this.handleStart()}if(eg(h)&&Wc(b,h.tolerance))return this.handleCancel();this.handlePending(h,b);return}l.cancelable&&l.preventDefault(),f(g)}handleEnd(){const{onAbort:l,onEnd:i}=this.props;this.detach(),this.activated||l(this.props.active),i()}handleCancel(){const{onAbort:l,onCancel:i}=this.props;this.detach(),this.activated||l(this.props.active),i()}handleKeydown(l){l.code===Ce.Esc&&this.handleCancel()}removeTextSelection(){var l;(l=this.document.getSelection())==null||l.removeAllRanges()}}const C1={cancel:{name:"pointercancel"},move:{name:"pointermove"},end:{name:"pointerup"}};class Du extends Eu{constructor(l){const{event:i}=l,s=Ol(i.target);super(l,C1,s)}}Du.activators=[{eventName:"onPointerDown",handler:(o,l)=>{let{nativeEvent:i}=o,{onActivation:s}=l;return!i.isPrimary||i.button!==0?!1:(s==null||s({event:i}),!0)}}];const N1={move:{name:"mousemove"},end:{name:"mouseup"}};var ru;(function(o){o[o.RightClick=2]="RightClick"})(ru||(ru={}));class T1 extends Eu{constructor(l){super(l,N1,Ol(l.event.target))}}T1.activators=[{eventName:"onMouseDown",handler:(o,l)=>{let{nativeEvent:i}=o,{onActivation:s}=l;return i.button===ru.RightClick?!1:(s==null||s({event:i}),!0)}}];const Pc={cancel:{name:"touchcancel"},move:{name:"touchmove"},end:{name:"touchend"}};class E1 extends Eu{constructor(l){super(l,Pc)}static setup(){return window.addEventListener(Pc.move.name,l,{capture:!1,passive:!1}),function(){window.removeEventListener(Pc.move.name,l)};function l(){}}}E1.activators=[{eventName:"onTouchStart",handler:(o,l)=>{let{nativeEvent:i}=o,{onActivation:s}=l;const{touches:u}=i;return u.length>1?!1:(s==null||s({event:i}),!0)}}];var ji;(function(o){o[o.Pointer=0]="Pointer",o[o.DraggableRect=1]="DraggableRect"})(ji||(ji={}));var xr;(function(o){o[o.TreeOrder=0]="TreeOrder",o[o.ReversedTreeOrder=1]="ReversedTreeOrder"})(xr||(xr={}));function D1(o){let{acceleration:l,activator:i=ji.Pointer,canScroll:s,draggingRect:u,enabled:d,interval:f=5,order:h=xr.TreeOrder,pointerCoordinates:g,scrollableAncestors:b,scrollableAncestorRects:y,delta:x,threshold:A}=o;const E=k1({delta:x,disabled:!d}),[_,z]=Ly(),V=N.useRef({x:0,y:0}),B=N.useRef({x:0,y:0}),Q=N.useMemo(()=>{switch(i){case ji.Pointer:return g?{top:g.y,bottom:g.y,left:g.x,right:g.x}:null;case ji.DraggableRect:return u}},[i,u,g]),Z=N.useRef(null),I=N.useCallback(()=>{const G=Z.current;if(!G)return;const Y=V.current.x*B.current.x,J=V.current.y*B.current.y;G.scrollBy(Y,J)},[]),X=N.useMemo(()=>h===xr.TreeOrder?[...b].reverse():b,[h,b]);N.useEffect(()=>{if(!d||!b.length||!Q){z();return}for(const G of X){if((s==null?void 0:s(G))===!1)continue;const Y=b.indexOf(G),J=y[Y];if(!J)continue;const{direction:ee,speed:de}=g1(G,J,Q,l,A);for(const ie of["x","y"])E[ie][ee[ie]]||(de[ie]=0,ee[ie]=0);if(de.x>0||de.y>0){z(),Z.current=G,_(I,f),V.current=de,B.current=ee;return}}V.current={x:0,y:0},B.current={x:0,y:0},z()},[l,I,s,z,d,f,JSON.stringify(Q),JSON.stringify(E),_,b,X,y,JSON.stringify(A)])}const A1={x:{[lt.Backward]:!1,[lt.Forward]:!1},y:{[lt.Backward]:!1,[lt.Forward]:!1}};function k1(o){let{delta:l,disabled:i}=o;const s=mr(l);return Bi(u=>{if(i||!s||!u)return A1;const d={x:Math.sign(l.x-s.x),y:Math.sign(l.y-s.y)};return{x:{[lt.Backward]:u.x[lt.Backward]||d.x===-1,[lt.Forward]:u.x[lt.Forward]||d.x===1},y:{[lt.Backward]:u.y[lt.Backward]||d.y===-1,[lt.Forward]:u.y[lt.Forward]||d.y===1}}},[i,l,s])}function R1(o,l){const i=l!=null?o.get(l):void 0,s=i?i.node.current:null;return Bi(u=>{var d;return l==null?null:(d=s??u)!=null?d:null},[s,l])}function O1(o,l){return N.useMemo(()=>o.reduce((i,s)=>{const{sensor:u}=s,d=u.activators.map(f=>({eventName:f.eventName,handler:l(f.handler,s)}));return[...i,...d]},[]),[o,l])}var Ui;(function(o){o[o.Always=0]="Always",o[o.BeforeDragging=1]="BeforeDragging",o[o.WhileDragging=2]="WhileDragging"})(Ui||(Ui={}));var ou;(function(o){o.Optimized="optimized"})(ou||(ou={}));const tg=new Map;function z1(o,l){let{dragging:i,dependencies:s,config:u}=l;const[d,f]=N.useState(null),{frequency:h,measure:g,strategy:b}=u,y=N.useRef(o),x=V(),A=_i(x),E=N.useCallback(function(B){B===void 0&&(B=[]),!A.current&&f(Q=>Q===null?B:Q.concat(B.filter(Z=>!Q.includes(Z))))},[A]),_=N.useRef(null),z=Bi(B=>{if(x&&!i)return tg;if(!B||B===tg||y.current!==o||d!=null){const Q=new Map;for(let Z of o){if(!Z)continue;if(d&&d.length>0&&!d.includes(Z.id)&&Z.rect.current){Q.set(Z.id,Z.rect.current);continue}const I=Z.node.current,X=I?new Tu(g(I),I):null;Z.rect.current=X,X&&Q.set(Z.id,X)}return Q}return B},[o,d,i,x,g]);return N.useEffect(()=>{y.current=o},[o]),N.useEffect(()=>{x||E()},[i,x]),N.useEffect(()=>{d&&d.length>0&&f(null)},[JSON.stringify(d)]),N.useEffect(()=>{x||typeof h!="number"||_.current!==null||(_.current=setTimeout(()=>{E(),_.current=null},h))},[h,x,E,...s]),{droppableRects:z,measureDroppableContainers:E,measuringScheduled:d!=null};function V(){switch(b){case Ui.Always:return!1;case Ui.BeforeDragging:return i;default:return!i}}}function Au(o,l){return Bi(i=>o?i||(typeof l=="function"?l(o):o):null,[l,o])}function j1(o,l){return Au(o,l)}function M1(o){let{callback:l,disabled:i}=o;const s=Nr(l),u=N.useMemo(()=>{if(i||typeof window>"u"||typeof window.MutationObserver>"u")return;const{MutationObserver:d}=window;return new d(s)},[s,i]);return N.useEffect(()=>()=>u==null?void 0:u.disconnect(),[u]),u}function Er(o){let{callback:l,disabled:i}=o;const s=Nr(l),u=N.useMemo(()=>{if(i||typeof window>"u"||typeof window.ResizeObserver>"u")return;const{ResizeObserver:d}=window;return new d(s)},[i]);return N.useEffect(()=>()=>u==null?void 0:u.disconnect(),[u]),u}function _1(o){return new Tu(zl(o),o)}function ng(o,l,i){l===void 0&&(l=_1);const[s,u]=N.useState(null);function d(){u(g=>{if(!o)return null;if(o.isConnected===!1){var b;return(b=g??i)!=null?b:null}const y=l(o);return JSON.stringify(g)===JSON.stringify(y)?g:y})}const f=M1({callback(g){if(o)for(const b of g){const{type:y,target:x}=b;if(y==="childList"&&x instanceof HTMLElement&&x.contains(o)){d();break}}}}),h=Er({callback:d});return on(()=>{d(),o?(h==null||h.observe(o),f==null||f.observe(document.body,{childList:!0,subtree:!0})):(h==null||h.disconnect(),f==null||f.disconnect())},[o]),s}function U1(o){const l=Au(o);return Yg(o,l)}const ag=[];function L1(o){const l=N.useRef(o),i=Bi(s=>o?s&&s!==ag&&o&&l.current&&o.parentNode===l.current.parentNode?s:Nu(o):ag,[o]);return N.useEffect(()=>{l.current=o},[o]),i}function q1(o){const[l,i]=N.useState(null),s=N.useRef(o),u=N.useCallback(d=>{const f=Fc(d.target);f&&i(h=>h?(h.set(f,su(f)),new Map(h)):null)},[]);return N.useEffect(()=>{const d=s.current;if(o!==d){f(d);const h=o.map(g=>{const b=Fc(g);return b?(b.addEventListener("scroll",u,{passive:!0}),[b,su(b)]):null}).filter(g=>g!=null);i(h.length?new Map(h):null),s.current=o}return()=>{f(o),f(d)};function f(h){h.forEach(g=>{const b=Fc(g);b==null||b.removeEventListener("scroll",u)})}},[u,o]),N.useMemo(()=>o.length?l?Array.from(l.values()).reduce((d,f)=>kl(d,f),cn):Ig(o):cn,[o,l])}function lg(o,l){l===void 0&&(l=[]);const i=N.useRef(null);return N.useEffect(()=>{i.current=null},l),N.useEffect(()=>{const s=o!==cn;s&&!i.current&&(i.current=o),!s&&i.current&&(i.current=null)},[o]),i.current?br(o,i.current):cn}function H1(o){N.useEffect(()=>{if(!Cr)return;const l=o.map(i=>{let{sensor:s}=i;return s.setup==null?void 0:s.setup()});return()=>{for(const i of l)i==null||i()}},o.map(l=>{let{sensor:i}=l;return i}))}function B1(o,l){return N.useMemo(()=>o.reduce((i,s)=>{let{eventName:u,handler:d}=s;return i[u]=f=>{d(f,l)},i},{}),[o,l])}function Wg(o){return N.useMemo(()=>o?d1(o):null,[o])}const ig=[];function Y1(o,l){l===void 0&&(l=zl);const[i]=o,s=Wg(i?vt(i):null),[u,d]=N.useState(ig);function f(){d(()=>o.length?o.map(g=>Zg(g)?s:new Tu(l(g),g)):ig)}const h=Er({callback:f});return on(()=>{h==null||h.disconnect(),f(),o.forEach(g=>h==null?void 0:h.observe(g))},[o]),u}function Pg(o){if(!o)return null;if(o.children.length>1)return o;const l=o.children[0];return Hi(l)?l:o}function G1(o){let{measure:l}=o;const[i,s]=N.useState(null),u=N.useCallback(b=>{for(const{target:y}of b)if(Hi(y)){s(x=>{const A=l(y);return x?{...x,width:A.width,height:A.height}:A});break}},[l]),d=Er({callback:u}),f=N.useCallback(b=>{const y=Pg(b);d==null||d.disconnect(),y&&(d==null||d.observe(y)),s(y?l(y):null)},[l,d]),[h,g]=gr(f);return N.useMemo(()=>({nodeRef:h,rect:i,setRef:g}),[i,h,g])}const X1=[{sensor:Du,options:{}},{sensor:Fg,options:{}}],V1={current:{}},dr={draggable:{measure:Fh},droppable:{measure:Fh,strategy:Ui.WhileDragging,frequency:ou.Optimized},dragOverlay:{measure:zl}};class Mi extends Map{get(l){var i;return l!=null&&(i=super.get(l))!=null?i:void 0}toArray(){return Array.from(this.values())}getEnabled(){return this.toArray().filter(l=>{let{disabled:i}=l;return!i})}getNodeFor(l){var i,s;return(i=(s=this.get(l))==null?void 0:s.node.current)!=null?i:void 0}}const Q1={activatorEvent:null,active:null,activeNode:null,activeNodeRect:null,collisions:null,containerNodeRect:null,draggableNodes:new Map,droppableRects:new Map,droppableContainers:new Mi,over:null,dragOverlay:{nodeRef:{current:null},rect:null,setRef:yr},scrollableAncestors:[],scrollableAncestorRects:[],measuringConfiguration:dr,measureDroppableContainers:yr,windowRect:null,measuringScheduled:!1},em={activatorEvent:null,activators:[],active:null,activeNodeRect:null,ariaDescribedById:{draggable:""},dispatch:yr,draggableNodes:new Map,over:null,measureDroppableContainers:yr},Gi=N.createContext(em),tm=N.createContext(Q1);function Z1(){return{draggable:{active:null,initialCoordinates:{x:0,y:0},nodes:new Map,translate:{x:0,y:0}},droppable:{containers:new Mi}}}function K1(o,l){switch(l.type){case et.DragStart:return{...o,draggable:{...o.draggable,initialCoordinates:l.initialCoordinates,active:l.active}};case et.DragMove:return o.draggable.active==null?o:{...o,draggable:{...o.draggable,translate:{x:l.coordinates.x-o.draggable.initialCoordinates.x,y:l.coordinates.y-o.draggable.initialCoordinates.y}}};case et.DragEnd:case et.DragCancel:return{...o,draggable:{...o.draggable,active:null,initialCoordinates:{x:0,y:0},translate:{x:0,y:0}}};case et.RegisterDroppable:{const{element:i}=l,{id:s}=i,u=new Mi(o.droppable.containers);return u.set(s,i),{...o,droppable:{...o.droppable,containers:u}}}case et.SetDroppableDisabled:{const{id:i,key:s,disabled:u}=l,d=o.droppable.containers.get(i);if(!d||s!==d.key)return o;const f=new Mi(o.droppable.containers);return f.set(i,{...d,disabled:u}),{...o,droppable:{...o.droppable,containers:f}}}case et.UnregisterDroppable:{const{id:i,key:s}=l,u=o.droppable.containers.get(i);if(!u||s!==u.key)return o;const d=new Mi(o.droppable.containers);return d.delete(i),{...o,droppable:{...o.droppable,containers:d}}}default:return o}}function I1(o){let{disabled:l}=o;const{active:i,activatorEvent:s,draggableNodes:u}=N.useContext(Gi),d=mr(s),f=mr(i==null?void 0:i.id);return N.useEffect(()=>{if(!l&&!s&&d&&f!=null){if(!Tr(d)||document.activeElement===d.target)return;const h=u.get(f);if(!h)return;const{activatorNode:g,node:b}=h;if(!g.current&&!b.current)return;requestAnimationFrame(()=>{for(const y of[g.current,b.current]){if(!y)continue;const x=By(y);if(x){x.focus();break}}})}},[s,l,u,f,d]),null}function nm(o,l){let{transform:i,...s}=l;return o!=null&&o.length?o.reduce((u,d)=>d({transform:u,...s}),i):i}function J1(o){return N.useMemo(()=>({draggable:{...dr.draggable,...o==null?void 0:o.draggable},droppable:{...dr.droppable,...o==null?void 0:o.droppable},dragOverlay:{...dr.dragOverlay,...o==null?void 0:o.dragOverlay}}),[o==null?void 0:o.draggable,o==null?void 0:o.droppable,o==null?void 0:o.dragOverlay])}function $1(o){let{activeNode:l,measure:i,initialRect:s,config:u=!0}=o;const d=N.useRef(!1),{x:f,y:h}=typeof u=="boolean"?{x:u,y:u}:u;on(()=>{if(!f&&!h||!l){d.current=!1;return}if(d.current||!s)return;const b=l==null?void 0:l.node.current;if(!b||b.isConnected===!1)return;const y=i(b),x=Yg(y,s);if(f||(x.x=0),h||(x.y=0),d.current=!0,Math.abs(x.x)>0||Math.abs(x.y)>0){const A=Xg(b);A&&A.scrollBy({top:x.y,left:x.x})}},[l,f,h,s,i])}const Dr=N.createContext({...cn,scaleX:1,scaleY:1});var ma;(function(o){o[o.Uninitialized=0]="Uninitialized",o[o.Initializing=1]="Initializing",o[o.Initialized=2]="Initialized"})(ma||(ma={}));const F1=N.memo(function(l){var i,s,u,d;let{id:f,accessibility:h,autoScroll:g=!0,children:b,sensors:y=X1,collisionDetection:x=i1,measuring:A,modifiers:E,..._}=l;const z=N.useReducer(K1,void 0,Z1),[V,B]=z,[Q,Z]=Zy(),[I,X]=N.useState(ma.Uninitialized),G=I===ma.Initialized,{draggable:{active:Y,nodes:J,translate:ee},droppable:{containers:de}}=V,ie=Y!=null?J.get(Y):null,De=N.useRef({initial:null,translated:null}),Ge=N.useMemo(()=>{var Xe;return Y!=null?{id:Y,data:(Xe=ie==null?void 0:ie.data)!=null?Xe:V1,rect:De}:null},[Y,ie]),He=N.useRef(null),[Fe,M]=N.useState(null),[q,F]=N.useState(null),te=_i(_,Object.values(_)),re=Yi("DndDescribedBy",f),w=N.useMemo(()=>de.getEnabled(),[de]),j=J1(A),{droppableRects:K,measureDroppableContainers:$,measuringScheduled:se}=z1(w,{dragging:G,dependencies:[ee.x,ee.y],config:j.droppable}),le=R1(J,Y),me=N.useMemo(()=>q?vr(q):null,[q]),Ue=Ga(),Se=j1(le,j.draggable.measure);$1({activeNode:Y!=null?J.get(Y):null,config:Ue.layoutShiftCompensation,initialRect:Se,measure:j.draggable.measure});const ve=ng(le,j.draggable.measure,Se),un=ng(le?le.parentElement:null),yt=N.useRef({activatorEvent:null,active:null,activeNode:le,collisionRect:null,collisions:null,droppableRects:K,draggableNodes:J,draggingNode:null,draggingNodeRect:null,droppableContainers:de,over:null,scrollableAncestors:[],scrollAdjustedTranslate:null}),xn=de.getNodeFor((i=yt.current.over)==null?void 0:i.id),it=G1({measure:j.dragOverlay.measure}),dn=(s=it.nodeRef.current)!=null?s:le,fn=G?(u=it.rect)!=null?u:ve:null,Xi=!!(it.nodeRef.current&&it.rect),jl=U1(Xi?null:ve),va=Wg(dn?vt(dn):null),Ht=L1(G?xn??le:null),Vn=Y1(Ht),Ba=nm(E,{transform:{x:ee.x-jl.x,y:ee.y-jl.y,scaleX:1,scaleY:1},activatorEvent:q,active:Ge,activeNodeRect:ve,containerNodeRect:un,draggingNodeRect:fn,over:yt.current.over,overlayNodeRect:it.rect,scrollableAncestors:Ht,scrollableAncestorRects:Vn,windowRect:va}),Vi=me?kl(me,ee):null,dt=q1(Ht),Ar=lg(dt),Qi=lg(dt,[ve]),Sn=kl(Ba,Ar),tn=fn?o1(fn,Ba):null,ya=Ge&&tn?x({active:Ge,collisionRect:tn,droppableRects:K,droppableContainers:w,pointerCoordinates:Vi}):null,Ml=n1(ya,"id"),[pn,Zi]=N.useState(null),xa=Xi?Ba:kl(Ba,Qi),gt=s1(xa,(d=pn==null?void 0:pn.rect)!=null?d:null,ve),Bt=N.useRef(null),ft=N.useCallback((Xe,Ve)=>{let{sensor:tt,options:xt}=Ve;if(He.current==null)return;const St=J.get(He.current);if(!St)return;const pt=Xe.nativeEvent,wt=new tt({active:He.current,activeNode:St,event:pt,options:xt,context:yt,onAbort(We){if(!J.get(We))return;const{onDragAbort:Rt}=te.current,Gt={id:We};Rt==null||Rt(Gt),Q({type:"onDragAbort",event:Gt})},onPending(We,nn,Rt,Gt){if(!J.get(We))return;const{onDragPending:Cn}=te.current,an={id:We,constraint:nn,initialCoordinates:Rt,offset:Gt};Cn==null||Cn(an),Q({type:"onDragPending",event:an})},onStart(We){const nn=He.current;if(nn==null)return;const Rt=J.get(nn);if(!Rt)return;const{onDragStart:Gt}=te.current,wn={activatorEvent:pt,active:{id:nn,data:Rt.data,rect:De}};ki.unstable_batchedUpdates(()=>{Gt==null||Gt(wn),X(ma.Initializing),B({type:et.DragStart,initialCoordinates:We,active:nn}),Q({type:"onDragStart",event:wn}),M(Bt.current),F(pt)})},onMove(We){B({type:et.DragMove,coordinates:We})},onEnd:Yt(et.DragEnd),onCancel:Yt(et.DragCancel)});Bt.current=wt;function Yt(We){return async function(){const{active:Rt,collisions:Gt,over:wn,scrollAdjustedTranslate:Cn}=yt.current;let an=null;if(Rt&&Cn){const{cancelDrop:Qn}=te.current;an={activatorEvent:pt,active:Rt,collisions:Gt,delta:Cn,over:wn},We===et.DragEnd&&typeof Qn=="function"&&await Promise.resolve(Qn(an))&&(We=et.DragCancel)}He.current=null,ki.unstable_batchedUpdates(()=>{B({type:We}),X(ma.Uninitialized),Zi(null),M(null),F(null),Bt.current=null;const Qn=We===et.DragEnd?"onDragEnd":"onDragCancel";if(an){const Xt=te.current[Qn];Xt==null||Xt(an),Q({type:Qn,event:an})}})}}},[J]),kr=N.useCallback((Xe,Ve)=>(tt,xt)=>{const St=tt.nativeEvent,pt=J.get(xt);if(He.current!==null||!pt||St.dndKit||St.defaultPrevented)return;const wt={active:pt};Xe(tt,Ve.options,wt)===!0&&(St.dndKit={capturedBy:Ve.sensor},He.current=xt,ft(tt,Ve))},[J,ft]),Ki=O1(y,kr);H1(y),on(()=>{ve&&I===ma.Initializing&&X(ma.Initialized)},[ve,I]),N.useEffect(()=>{const{onDragMove:Xe}=te.current,{active:Ve,activatorEvent:tt,collisions:xt,over:St}=yt.current;if(!Ve||!tt)return;const pt={active:Ve,activatorEvent:tt,collisions:xt,delta:{x:Sn.x,y:Sn.y},over:St};ki.unstable_batchedUpdates(()=>{Xe==null||Xe(pt),Q({type:"onDragMove",event:pt})})},[Sn.x,Sn.y]),N.useEffect(()=>{const{active:Xe,activatorEvent:Ve,collisions:tt,droppableContainers:xt,scrollAdjustedTranslate:St}=yt.current;if(!Xe||He.current==null||!Ve||!St)return;const{onDragOver:pt}=te.current,wt=xt.get(Ml),Yt=wt&&wt.rect.current?{id:wt.id,rect:wt.rect.current,data:wt.data,disabled:wt.disabled}:null,We={active:Xe,activatorEvent:Ve,collisions:tt,delta:{x:St.x,y:St.y},over:Yt};ki.unstable_batchedUpdates(()=>{Zi(Yt),pt==null||pt(We),Q({type:"onDragOver",event:We})})},[Ml]),on(()=>{yt.current={activatorEvent:q,active:Ge,activeNode:le,collisionRect:tn,collisions:ya,droppableRects:K,draggableNodes:J,draggingNode:dn,draggingNodeRect:fn,droppableContainers:de,over:pn,scrollableAncestors:Ht,scrollAdjustedTranslate:Sn},De.current={initial:fn,translated:tn}},[Ge,le,ya,tn,J,dn,fn,K,de,pn,Ht,Sn]),D1({...Ue,delta:ee,draggingRect:tn,pointerCoordinates:Vi,scrollableAncestors:Ht,scrollableAncestorRects:Vn});const Rr=N.useMemo(()=>({active:Ge,activeNode:le,activeNodeRect:ve,activatorEvent:q,collisions:ya,containerNodeRect:un,dragOverlay:it,draggableNodes:J,droppableContainers:de,droppableRects:K,over:pn,measureDroppableContainers:$,scrollableAncestors:Ht,scrollableAncestorRects:Vn,measuringConfiguration:j,measuringScheduled:se,windowRect:va}),[Ge,le,ve,q,ya,un,it,J,de,K,pn,$,Ht,Vn,j,se,va]),Ya=N.useMemo(()=>({activatorEvent:q,activators:Ki,active:Ge,activeNodeRect:ve,ariaDescribedById:{draggable:re},dispatch:B,draggableNodes:J,over:pn,measureDroppableContainers:$}),[q,Ki,Ge,ve,B,re,J,pn,$]);return qe.createElement(Bg.Provider,{value:Z},qe.createElement(Gi.Provider,{value:Ya},qe.createElement(tm.Provider,{value:Rr},qe.createElement(Dr.Provider,{value:gt},b)),qe.createElement(I1,{disabled:(h==null?void 0:h.restoreFocus)===!1})),qe.createElement(Jy,{...h,hiddenTextDescribedById:re}));function Ga(){const Xe=(Fe==null?void 0:Fe.autoScrollEnabled)===!1,Ve=typeof g=="object"?g.enabled===!1:g===!1,tt=G&&!Xe&&!Ve;return typeof g=="object"?{...g,enabled:tt}:{enabled:tt}}}),W1=N.createContext(null),sg="button",P1="Draggable";function ex(o){let{id:l,data:i,disabled:s=!1,attributes:u}=o;const d=Yi(P1),{activators:f,activatorEvent:h,active:g,activeNodeRect:b,ariaDescribedById:y,draggableNodes:x,over:A}=N.useContext(Gi),{role:E=sg,roleDescription:_="draggable",tabIndex:z=0}=u??{},V=(g==null?void 0:g.id)===l,B=N.useContext(V?Dr:W1),[Q,Z]=gr(),[I,X]=gr(),G=B1(f,l),Y=_i(i);on(()=>(x.set(l,{id:l,key:d,node:Q,activatorNode:I,data:Y}),()=>{const ee=x.get(l);ee&&ee.key===d&&x.delete(l)}),[x,l]);const J=N.useMemo(()=>({role:E,tabIndex:z,"aria-disabled":s,"aria-pressed":V&&E===sg?!0:void 0,"aria-roledescription":_,"aria-describedby":y.draggable}),[s,E,z,V,_,y.draggable]);return{active:g,activatorEvent:h,activeNodeRect:b,attributes:J,isDragging:V,listeners:s?void 0:G,node:Q,over:A,setNodeRef:Z,setActivatorNodeRef:X,transform:B}}function am(){return N.useContext(tm)}const tx="Droppable",nx={timeout:25};function ax(o){let{data:l,disabled:i=!1,id:s,resizeObserverConfig:u}=o;const d=Yi(tx),{active:f,dispatch:h,over:g,measureDroppableContainers:b}=N.useContext(Gi),y=N.useRef({disabled:i}),x=N.useRef(!1),A=N.useRef(null),E=N.useRef(null),{disabled:_,updateMeasurementsFor:z,timeout:V}={...nx,...u},B=_i(z??s),Q=N.useCallback(()=>{if(!x.current){x.current=!0;return}E.current!=null&&clearTimeout(E.current),E.current=setTimeout(()=>{b(Array.isArray(B.current)?B.current:[B.current]),E.current=null},V)},[V]),Z=Er({callback:Q,disabled:_||!f}),I=N.useCallback((J,ee)=>{Z&&(ee&&(Z.unobserve(ee),x.current=!1),J&&Z.observe(J))},[Z]),[X,G]=gr(I),Y=_i(l);return N.useEffect(()=>{!Z||!X.current||(Z.disconnect(),x.current=!1,Z.observe(X.current))},[X,Z]),N.useEffect(()=>(h({type:et.RegisterDroppable,element:{id:s,key:d,disabled:i,node:X,rect:A,data:Y}}),()=>h({type:et.UnregisterDroppable,key:d,id:s})),[s]),N.useEffect(()=>{i!==y.current.disabled&&(h({type:et.SetDroppableDisabled,id:s,key:d,disabled:i}),y.current.disabled=i)},[s,d,i,h]),{active:f,rect:A,isOver:(g==null?void 0:g.id)===s,node:X,over:g,setNodeRef:G}}function lx(o){let{animation:l,children:i}=o;const[s,u]=N.useState(null),[d,f]=N.useState(null),h=mr(i);return!i&&!s&&h&&u(h),on(()=>{if(!d)return;const g=s==null?void 0:s.key,b=s==null?void 0:s.props.id;if(g==null||b==null){u(null);return}Promise.resolve(l(b,d)).then(()=>{u(null)})},[l,s,d]),qe.createElement(qe.Fragment,null,i,s?N.cloneElement(s,{ref:f}):null)}const ix={x:0,y:0,scaleX:1,scaleY:1};function sx(o){let{children:l}=o;return qe.createElement(Gi.Provider,{value:em},qe.createElement(Dr.Provider,{value:ix},l))}const rx={position:"fixed",touchAction:"none"},ox=o=>Tr(o)?"transform 250ms ease":void 0,cx=N.forwardRef((o,l)=>{let{as:i,activatorEvent:s,adjustScale:u,children:d,className:f,rect:h,style:g,transform:b,transition:y=ox}=o;if(!h)return null;const x=u?b:{...b,scaleX:1,scaleY:1},A={...rx,width:h.width,height:h.height,top:h.top,left:h.left,transform:ba.Transform.toString(x),transformOrigin:u&&s?Py(s,h):void 0,transition:typeof y=="function"?y(s):y,...g};return qe.createElement(i,{className:f,style:A,ref:l},d)}),ux=o=>l=>{let{active:i,dragOverlay:s}=l;const u={},{styles:d,className:f}=o;if(d!=null&&d.active)for(const[h,g]of Object.entries(d.active))g!==void 0&&(u[h]=i.node.style.getPropertyValue(h),i.node.style.setProperty(h,g));if(d!=null&&d.dragOverlay)for(const[h,g]of Object.entries(d.dragOverlay))g!==void 0&&s.node.style.setProperty(h,g);return f!=null&&f.active&&i.node.classList.add(f.active),f!=null&&f.dragOverlay&&s.node.classList.add(f.dragOverlay),function(){for(const[g,b]of Object.entries(u))i.node.style.setProperty(g,b);f!=null&&f.active&&i.node.classList.remove(f.active)}},dx=o=>{let{transform:{initial:l,final:i}}=o;return[{transform:ba.Transform.toString(l)},{transform:ba.Transform.toString(i)}]},fx={duration:250,easing:"ease",keyframes:dx,sideEffects:ux({styles:{active:{opacity:"0"}}})};function px(o){let{config:l,draggableNodes:i,droppableContainers:s,measuringConfiguration:u}=o;return Nr((d,f)=>{if(l===null)return;const h=i.get(d);if(!h)return;const g=h.node.current;if(!g)return;const b=Pg(f);if(!b)return;const{transform:y}=vt(f).getComputedStyle(f),x=Gg(y);if(!x)return;const A=typeof l=="function"?l:hx(l);return Jg(g,u.draggable.measure),A({active:{id:d,data:h.data,node:g,rect:u.draggable.measure(g)},draggableNodes:i,dragOverlay:{node:f,rect:u.dragOverlay.measure(b)},droppableContainers:s,measuringConfiguration:u,transform:x})})}function hx(o){const{duration:l,easing:i,sideEffects:s,keyframes:u}={...fx,...o};return d=>{let{active:f,dragOverlay:h,transform:g,...b}=d;if(!l)return;const y={x:h.rect.left-f.rect.left,y:h.rect.top-f.rect.top},x={scaleX:g.scaleX!==1?f.rect.width*g.scaleX/h.rect.width:1,scaleY:g.scaleY!==1?f.rect.height*g.scaleY/h.rect.height:1},A={x:g.x-y.x,y:g.y-y.y,...x},E=u({...b,active:f,dragOverlay:h,transform:{initial:g,final:A}}),[_]=E,z=E[E.length-1];if(JSON.stringify(_)===JSON.stringify(z))return;const V=s==null?void 0:s({active:f,dragOverlay:h,...b}),B=h.node.animate(E,{duration:l,easing:i,fill:"forwards"});return new Promise(Q=>{B.onfinish=()=>{V==null||V(),Q()}})}}let rg=0;function gx(o){return N.useMemo(()=>{if(o!=null)return rg++,rg},[o])}const mx=qe.memo(o=>{let{adjustScale:l=!1,children:i,dropAnimation:s,style:u,transition:d,modifiers:f,wrapperElement:h="div",className:g,zIndex:b=999}=o;const{activatorEvent:y,active:x,activeNodeRect:A,containerNodeRect:E,draggableNodes:_,droppableContainers:z,dragOverlay:V,over:B,measuringConfiguration:Q,scrollableAncestors:Z,scrollableAncestorRects:I,windowRect:X}=am(),G=N.useContext(Dr),Y=gx(x==null?void 0:x.id),J=nm(f,{activatorEvent:y,active:x,activeNodeRect:A,containerNodeRect:E,draggingNodeRect:V.rect,over:B,overlayNodeRect:V.rect,scrollableAncestors:Z,scrollableAncestorRects:I,transform:G,windowRect:X}),ee=Au(A),de=px({config:s,draggableNodes:_,droppableContainers:z,measuringConfiguration:Q}),ie=ee?V.setRef:void 0;return qe.createElement(sx,null,qe.createElement(lx,{animation:de},x&&Y?qe.createElement(cx,{key:Y,id:x.id,ref:ie,as:h,activatorEvent:y,adjustScale:l,className:g,transition:d,rect:ee,style:{zIndex:b,...u},transform:J},i):null))});function lm(o,l,i){const s=o.slice();return s.splice(i<0?s.length+i:i,0,s.splice(l,1)[0]),s}function bx(o,l){return o.reduce((i,s,u)=>{const d=l.get(s);return d&&(i[u]=d),i},Array(o.length))}function or(o){return o!==null&&o>=0}function vx(o,l){if(o===l)return!0;if(o.length!==l.length)return!1;for(let i=0;i<o.length;i++)if(o[i]!==l[i])return!1;return!0}function yx(o){return typeof o=="boolean"?{draggable:o,droppable:o}:o}const im=o=>{let{rects:l,activeIndex:i,overIndex:s,index:u}=o;const d=lm(l,s,i),f=l[u],h=d[u];return!h||!f?null:{x:h.left-f.left,y:h.top-f.top,scaleX:h.width/f.width,scaleY:h.height/f.height}},cr={scaleX:1,scaleY:1},xx=o=>{var l;let{activeIndex:i,activeNodeRect:s,index:u,rects:d,overIndex:f}=o;const h=(l=d[i])!=null?l:s;if(!h)return null;if(u===i){const b=d[f];return b?{x:0,y:i<f?b.top+b.height-(h.top+h.height):b.top-h.top,...cr}:null}const g=Sx(d,u,i);return u>i&&u<=f?{x:0,y:-h.height-g,...cr}:u<i&&u>=f?{x:0,y:h.height+g,...cr}:{x:0,y:0,...cr}};function Sx(o,l,i){const s=o[l],u=o[l-1],d=o[l+1];return s?i<l?u?s.top-(u.top+u.height):d?d.top-(s.top+s.height):0:d?d.top-(s.top+s.height):u?s.top-(u.top+u.height):0:0}const sm="Sortable",rm=qe.createContext({activeIndex:-1,containerId:sm,disableTransforms:!1,items:[],overIndex:-1,useDragOverlay:!1,sortedRects:[],strategy:im,disabled:{draggable:!1,droppable:!1}});function wx(o){let{children:l,id:i,items:s,strategy:u=im,disabled:d=!1}=o;const{active:f,dragOverlay:h,droppableRects:g,over:b,measureDroppableContainers:y}=am(),x=Yi(sm,i),A=h.rect!==null,E=N.useMemo(()=>s.map(G=>typeof G=="object"&&"id"in G?G.id:G),[s]),_=f!=null,z=f?E.indexOf(f.id):-1,V=b?E.indexOf(b.id):-1,B=N.useRef(E),Q=!vx(E,B.current),Z=V!==-1&&z===-1||Q,I=yx(d);on(()=>{Q&&_&&y(E)},[Q,E,_,y]),N.useEffect(()=>{B.current=E},[E]);const X=N.useMemo(()=>({activeIndex:z,containerId:x,disabled:I,disableTransforms:Z,items:E,overIndex:V,useDragOverlay:A,sortedRects:bx(E,g),strategy:u}),[z,x,I.draggable,I.droppable,Z,E,V,g,A,u]);return qe.createElement(rm.Provider,{value:X},l)}const Cx=o=>{let{id:l,items:i,activeIndex:s,overIndex:u}=o;return lm(i,s,u).indexOf(l)},Nx=o=>{let{containerId:l,isSorting:i,wasDragging:s,index:u,items:d,newIndex:f,previousItems:h,previousContainerId:g,transition:b}=o;return!b||!s||h!==d&&u===f?!1:i?!0:f!==u&&l===g},Tx={duration:200,easing:"ease"},om="transform",Ex=ba.Transition.toString({property:om,duration:0,easing:"linear"}),Dx={roleDescription:"sortable"};function Ax(o){let{disabled:l,index:i,node:s,rect:u}=o;const[d,f]=N.useState(null),h=N.useRef(i);return on(()=>{if(!l&&i!==h.current&&s.current){const g=u.current;if(g){const b=zl(s.current,{ignoreTransform:!0}),y={x:g.left-b.left,y:g.top-b.top,scaleX:g.width/b.width,scaleY:g.height/b.height};(y.x||y.y)&&f(y)}}i!==h.current&&(h.current=i)},[l,i,s,u]),N.useEffect(()=>{d&&f(null)},[d]),d}function kx(o){let{animateLayoutChanges:l=Nx,attributes:i,disabled:s,data:u,getNewIndex:d=Cx,id:f,strategy:h,resizeObserverConfig:g,transition:b=Tx}=o;const{items:y,containerId:x,activeIndex:A,disabled:E,disableTransforms:_,sortedRects:z,overIndex:V,useDragOverlay:B,strategy:Q}=N.useContext(rm),Z=Rx(s,E),I=y.indexOf(f),X=N.useMemo(()=>({sortable:{containerId:x,index:I,items:y},...u}),[x,u,I,y]),G=N.useMemo(()=>y.slice(y.indexOf(f)),[y,f]),{rect:Y,node:J,isOver:ee,setNodeRef:de}=ax({id:f,data:X,disabled:Z.droppable,resizeObserverConfig:{updateMeasurementsFor:G,...g}}),{active:ie,activatorEvent:De,activeNodeRect:Ge,attributes:He,setNodeRef:Fe,listeners:M,isDragging:q,over:F,setActivatorNodeRef:te,transform:re}=ex({id:f,data:X,attributes:{...Dx,...i},disabled:Z.draggable}),w=Uy(de,Fe),j=!!ie,K=j&&!_&&or(A)&&or(V),$=!B&&q,se=$&&K?re:null,me=K?se??(h??Q)({rects:z,activeNodeRect:Ge,activeIndex:A,overIndex:V,index:I}):null,Ue=or(A)&&or(V)?d({id:f,items:y,activeIndex:A,overIndex:V}):I,Se=ie==null?void 0:ie.id,ve=N.useRef({activeId:Se,items:y,newIndex:Ue,containerId:x}),un=y!==ve.current.items,yt=l({active:ie,containerId:x,isDragging:q,isSorting:j,id:f,index:I,items:y,newIndex:ve.current.newIndex,previousItems:ve.current.items,previousContainerId:ve.current.containerId,transition:b,wasDragging:ve.current.activeId!=null}),xn=Ax({disabled:!yt,index:I,node:J,rect:Y});return N.useEffect(()=>{j&&ve.current.newIndex!==Ue&&(ve.current.newIndex=Ue),x!==ve.current.containerId&&(ve.current.containerId=x),y!==ve.current.items&&(ve.current.items=y)},[j,Ue,x,y]),N.useEffect(()=>{if(Se===ve.current.activeId)return;if(Se!=null&&ve.current.activeId==null){ve.current.activeId=Se;return}const dn=setTimeout(()=>{ve.current.activeId=Se},50);return()=>clearTimeout(dn)},[Se]),{active:ie,activeIndex:A,attributes:He,data:X,rect:Y,index:I,newIndex:Ue,items:y,isOver:ee,isSorting:j,isDragging:q,listeners:M,node:J,overIndex:V,over:F,setNodeRef:w,setActivatorNodeRef:te,setDroppableNodeRef:de,setDraggableNodeRef:Fe,transform:xn??me,transition:it()};function it(){if(xn||un&&ve.current.newIndex===I)return Ex;if(!($&&!Tr(De)||!b)&&(j||yt))return ba.Transition.toString({...b,property:om})}}function Rx(o,l){var i,s;return typeof o=="boolean"?{draggable:o,droppable:!1}:{draggable:(i=o==null?void 0:o.draggable)!=null?i:l.draggable,droppable:(s=o==null?void 0:o.droppable)!=null?s:l.droppable}}Ce.Down,Ce.Right,Ce.Up,Ce.Left;function Ox({prd:o,projectId:l,onClose:i,onSave:s}){const[u,d]=N.useState((o==null?void 0:o.title)??""),[f,h]=N.useState((o==null?void 0:o.content)??""),g=N.useRef();function b(x){const A=x.target.files[0];if(!A)return;const E=A.name.replace(/\.md$/i,"").replace(/[-_]/g," "),_=new FileReader;_.onload=z=>{u||d(E),h(z.target.result)},_.readAsText(A)}function y(){const x=u.trim();x&&s({title:x,content:f})}return v.jsx("div",{className:"prd-editor-scrim",onClick:x=>x.target===x.currentTarget&&i(),children:v.jsxs("div",{className:"prd-editor-modal",children:[v.jsxs("div",{className:"prd-editor-header",children:[v.jsx("span",{className:"prd-editor-title",children:o?"Edit PRD":"New PRD"}),v.jsx("button",{className:"prd-editor-close",onClick:i,children:"✕"})]}),v.jsxs("div",{className:"prd-editor-body",children:[v.jsxs("div",{className:"prd-editor-field",children:[v.jsx("label",{className:"prd-editor-label",children:"Title"}),v.jsx("input",{className:"prd-editor-input",type:"text",placeholder:"e.g. Producer Filter Modal",value:u,onChange:x=>d(x.target.value),autoFocus:!0})]}),v.jsxs("div",{className:"prd-editor-field prd-editor-field--grow",children:[v.jsxs("div",{className:"prd-editor-label-row",children:[v.jsx("label",{className:"prd-editor-label",children:"Content"}),v.jsx("button",{className:"prd-editor-load-file",onClick:()=>g.current.click(),children:"Load from .md file"}),v.jsx("input",{ref:g,type:"file",accept:".md,.txt",style:{display:"none"},onChange:b})]}),v.jsx("textarea",{className:"prd-editor-textarea",placeholder:"Paste your PRD markdown here…",value:f,onChange:x=>h(x.target.value)})]})]}),v.jsxs("div",{className:"prd-editor-footer",children:[v.jsx("button",{className:"prd-editor-btn prd-editor-btn--cancel",onClick:i,children:"Cancel"}),v.jsx("button",{className:"prd-editor-btn prd-editor-btn--save",onClick:y,disabled:!u.trim(),children:o?"Save changes":"Create PRD"})]})]})})}function cm(o){const l=Math.floor((Date.now()-new Date(o))/6e4);if(l<1)return"just now";if(l<60)return`${l}m ago`;const i=Math.floor(l/60);return i<24?`${i}h ago`:`${Math.floor(i/24)}d ago`}function zx({status:o}){return v.jsx("span",{className:`prd-status prd-status--${o}`,children:Ug[o]})}function jx({prd:o,onEdit:l,onDelete:i,onOpen:s,isDragging:u}){const{attributes:d,listeners:f,setNodeRef:h,transform:g,transition:b}=kx({id:o.id}),y={transform:ba.Transform.toString(g),transition:b,opacity:u?.4:1};return v.jsxs("div",{ref:h,style:y,className:"kanban-card",...d,...f,children:[v.jsx("div",{className:"kanban-card-title",children:o.title}),v.jsx("div",{className:"kanban-card-meta",children:cm(o.updatedAt)}),v.jsxs("div",{className:"kanban-card-actions",onPointerDown:x=>x.stopPropagation(),children:[v.jsx("button",{className:"kanban-card-btn",onClick:()=>s(o),children:"Open →"}),v.jsx("button",{className:"kanban-card-btn",onClick:()=>l(o),children:"Edit"}),v.jsx("button",{className:"kanban-card-btn kanban-card-btn--danger",onClick:()=>i(o.id),children:"Delete"})]})]})}function Mx({status:o,prds:l,onEdit:i,onDelete:s,onOpen:u,activeId:d}){return v.jsxs("div",{className:"kanban-col",children:[v.jsxs("div",{className:"kanban-col-header",children:[v.jsx("span",{className:"kanban-col-title",children:Ug[o]}),v.jsx("span",{className:"kanban-col-count",children:l.length})]}),v.jsx(wx,{items:l.map(f=>f.id),strategy:xx,children:v.jsxs("div",{className:"kanban-col-cards",children:[l.map(f=>v.jsx(jx,{prd:f,onEdit:i,onDelete:s,onOpen:u,isDragging:d===f.id},f.id)),l.length===0&&v.jsx("div",{className:"kanban-col-empty",children:"Drop here"})]})})]})}function _x({projectId:o,prds:l,onNavigate:i,onCreatePrd:s,onUpdatePrd:u,onDeletePrd:d}){const f=Lg(o),h=l.filter(X=>X.projectId===o),[g,b]=N.useState("kanban"),[y,x]=N.useState(!1),[A,E]=N.useState(null),[_,z]=N.useState(null),V=Fy($y(Du,{activationConstraint:{distance:6}}));function B({active:X}){z(X.id)}function Q({active:X,over:G}){if(z(null),!G||X.id===G.id)return;const Y=h.find(de=>de.id===X.id);if(!Y)return;const J=h.find(de=>de.id===G.id),ee=J?J.status:G.id;Kh.includes(ee)&&Y.status!==ee&&u(X.id,{status:ee})}function Z({active:X,over:G}){if(!G)return;const Y=h.find(ee=>ee.id===X.id),J=h.find(ee=>ee.id===G.id);!Y||!J||Y.status!==J.status&&u(X.id,{status:J.status})}const I=_?h.find(X=>X.id===_):null;return v.jsxs("div",{className:"project-view",children:[v.jsxs("header",{className:"project-view-header",children:[v.jsx("button",{className:"project-back-btn",onClick:()=>i({page:"projects"}),children:"← Projects"}),v.jsxs("div",{className:"project-view-title",children:[v.jsx("span",{className:"project-view-icon",children:f==null?void 0:f.icon}),v.jsx("span",{className:"project-view-name",children:f==null?void 0:f.name})]}),v.jsxs("div",{className:"project-view-actions",children:[v.jsxs("div",{className:"view-toggle",children:[v.jsx("button",{className:`view-toggle-btn ${g==="list"?"active":""}`,onClick:()=>b("list"),children:"List"}),v.jsx("button",{className:`view-toggle-btn ${g==="kanban"?"active":""}`,onClick:()=>b("kanban"),children:"Kanban"})]}),v.jsx("button",{className:"new-prd-btn",onClick:()=>{E(null),x(!0)},children:"+ New PRD"})]})]}),v.jsx("div",{className:"project-view-body",children:g==="list"?v.jsx("div",{className:"prd-list",children:h.length===0?v.jsx("div",{className:"prd-list-empty",children:"No PRDs yet — create one to get started."}):v.jsxs("table",{className:"prd-table",children:[v.jsx("thead",{children:v.jsxs("tr",{children:[v.jsx("th",{children:"Title"}),v.jsx("th",{children:"Status"}),v.jsx("th",{children:"Updated"}),v.jsx("th",{})]})}),v.jsx("tbody",{children:h.map(X=>v.jsxs("tr",{children:[v.jsx("td",{className:"prd-table-title",children:X.title}),v.jsx("td",{children:v.jsx(zx,{status:X.status})}),v.jsx("td",{className:"prd-table-date",children:cm(X.updatedAt)}),v.jsxs("td",{className:"prd-table-actions",children:[v.jsx("button",{className:"prd-action-btn",onClick:()=>i({page:"builder",prdId:X.id}),children:"Open →"}),v.jsx("button",{className:"prd-action-btn",onClick:()=>{E(X),x(!0)},children:"Edit"}),v.jsx("button",{className:"prd-action-btn prd-action-btn--danger",onClick:()=>d(X.id),children:"Delete"})]})]},X.id))})]})}):v.jsxs(F1,{sensors:V,collisionDetection:a1,onDragStart:B,onDragOver:Z,onDragEnd:Q,children:[v.jsx("div",{className:"kanban-board",children:Kh.map(X=>v.jsx(Mx,{status:X,prds:h.filter(G=>G.status===X),onEdit:G=>{E(G),x(!0)},onDelete:G=>d(G),onOpen:G=>i({page:"builder",prdId:G.id}),activeId:_},X))}),v.jsx(mx,{children:I?v.jsx("div",{className:"kanban-card kanban-card--overlay",children:v.jsx("div",{className:"kanban-card-title",children:I.title})}):null})]})}),y&&v.jsx(Ox,{prd:A,projectId:o,onClose:()=>x(!1),onSave:X=>{A?u(A.id,X):s(o,X),x(!1)}})]})}function Ux(){const[o,l]=N.useState(()=>!!Cg()),[i,s]=N.useState(Zh),[u,d]=N.useState(!1),[f,h]=N.useState({page:"projects"}),[g,b]=N.useState([]),[y,x]=N.useState(!1),[A,E]=N.useState(null),[_,z]=N.useState(null),[V,B]=N.useState([]),[Q,Z]=N.useState(null),[I,X]=N.useState(Ev),[G,Y]=N.useState(0),J=i&&!u;N.useEffect(()=>{if(!o||!i&&!u)return;async function q(){if(J)try{const F=await Ay();b(F)}catch{Ih(),b(iu())}else Ih(),b(iu());x(!0)}q()},[o,i,u]);function ee(q){if(q.page==="builder"&&q.prdId){const F=g.find(te=>te.id===q.prdId);F&&de(F)}h(q)}function de(q){E({id:q.id,name:q.title,content:q.content}),B([]),z(null),Z(Zv(q.title))}async function ie(q,F){if(J){const te=await ky({projectId:q,...F});b(re=>[te,...re])}else{const te={id:`prd-${Date.now()}`,projectId:q,status:"backlog",createdAt:new Date().toISOString(),updatedAt:new Date().toISOString(),...F};b(re=>{const w=[te,...re];return ur(w),w})}}async function De(q,F){if(J){const te=await Ry(q,{...F,updated:new Date().toISOString()});b(re=>re.map(w=>w.id===q?te:w))}else b(te=>{const re=te.map(w=>w.id===q?{...w,...F,updatedAt:new Date().toISOString()}:w);return ur(re),re})}async function Ge(q){J&&await Oy(q),b(F=>{const te=F.filter(re=>re.id!==q);return J||ur(te),te})}function He(q){if(z(q),A){const te=[Dv({prdName:A.name,code:q,iteration:((Q==null?void 0:Q.iterations)??0)+1}),...I].slice(0,50);X(te),Lh(te)}}function Fe({inputTokens:q,outputTokens:F,cacheReadTokens:te,componentsUsed:re}){Z(w=>{if(!w)return w;const j={...w,iterations:w.iterations+1,inputTokens:w.inputTokens+q,outputTokens:w.outputTokens+F,cacheReadTokens:w.cacheReadTokens+te,componentsUsed:[...new Set([...w.componentsUsed,...re])]};return j.cost=Qv(j),nu(j),j})}function M(){X([]),Lh([])}return o?!i&&!u?v.jsx(zy,{onDone:()=>{Zh()?s(!0):d(!0)}}):y?f.page==="projects"?v.jsx(_y,{prds:g,onNavigate:ee}):f.page==="project"?v.jsx(_x,{projectId:f.projectId,prds:g,onNavigate:ee,onCreatePrd:ie,onUpdatePrd:De,onDeletePrd:Ge}):v.jsxs("div",{className:"app",children:[v.jsxs("header",{className:"app-header",children:[v.jsxs("div",{className:"app-header-left",children:[v.jsx("button",{className:"app-back-btn",onClick:()=>ee({page:"projects"}),children:"← Projects"}),v.jsx("span",{className:"app-header-sep"}),v.jsx("span",{className:"app-logo",children:"ennabl"}),v.jsx("span",{className:"app-logo-suffix",children:"builder"}),A&&v.jsx("span",{className:"app-prd-badge",children:A.name})]}),v.jsx(My,{prds:g,onSelect:de})]}),v.jsxs("main",{className:"app-panels",children:[v.jsx(jv,{code:_,prd:A,history:I,onHistoryClear:M,onInitDesign:()=>Y(q=>q+1)}),v.jsx("div",{className:"app-divider"}),v.jsx(ry,{prd:A,messages:V,setMessages:B,onCodeGenerated:He,onIterationComplete:Fe,session:Q,onSessionUpdate:Z,initTrigger:G})]})]}):v.jsx("div",{style:{height:"100dvh",display:"flex",alignItems:"center",justifyContent:"center",background:"var(--bg)",color:"var(--text-muted)",fontSize:13},children:"Loading…"}):v.jsx(oy,{onDone:()=>l(!0)})}j0.createRoot(document.getElementById("root")).render(v.jsx(N.StrictMode,{children:v.jsx(Ux,{})}));
