 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var rh;function W0(){if(rh)return ie;rh=1;var o=Symbol.for("react.transitional.element"),i=Symbol.for("react.portal"),r=Symbol.for("react.fragment"),c=Symbol.for("react.strict_mode"),u=Symbol.for("react.profiler"),f=Symbol.for("react.consumer"),p=Symbol.for("react.context"),m=Symbol.for("react.forward_ref"),g=Symbol.for("react.suspense"),v=Symbol.for("react.memo"),y=Symbol.for("react.lazy"),S=Symbol.for("react.activity"),z=Symbol.iterator;function R(C){return C===null||typeof C!="object"?null:(C=z&&C[z]||C["@@iterator"],typeof C=="function"?C:null)}var H={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},q=Object.assign,L={};function $(C,O,Z){this.props=C,this.context=O,this.refs=L,this.updater=Z||H}$.prototype.isReactComponent={},$.prototype.setState=function(C,O){if(typeof C!="object"&&typeof C!="function"&&C!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,C,O,"setState")},$.prototype.forceUpdate=function(C){this.updater.enqueueForceUpdate(this,C,"forceUpdate")};function W(){}W.prototype=$.prototype;function X(C,O,Z){this.props=C,this.context=O,this.refs=L,this.updater=Z||H}var Q=X.prototype=new W;Q.constructor=X,q(Q,$.prototype),Q.isPureReactComponent=!0;var V=Array.isArray;function Y(){}var B={H:null,A:null,T:null,S:null},K=Object.prototype.hasOwnProperty;function le(C,O,Z){var J=Z.ref;return{$$typeof:o,type:C,key:O,ref:J!==void 0?J:null,props:Z}}function fe(C,O){return le(C.type,O,C.props)}function se(C){return typeof C=="object"&&C!==null&&C.$$typeof===o}function ke(C){var O={"=":"=0",":":"=2"};return"$"+C.replace(/[=:]/g,function(Z){return O[Z]})}var Ie=/\/+/g;function Ze(C,O){return typeof C=="object"&&C!==null&&C.key!=null?ke(""+C.key):O.toString(36)}function lt(C){switch(C.status){case"fulfilled":return C.value;case"rejected":throw C.reason;default:switch(typeof C.status=="string"?C.then(Y,Y):(C.status="pending",C.then(function(O){C.status==="pending"&&(C.status="fulfilled",C.value=O)},function(O){C.status==="pending"&&(C.status="rejected",C.reason=O)})),C.status){case"fulfilled":return C.value;case"rejected":throw C.reason}}throw C}function k(C,O,Z,J,ae){var ne=typeof C;(ne==="undefined"||ne==="boolean")&&(C=null);var ge=!1;if(C===null)ge=!0;else switch(ne){case"bigint":case"string":case"number":ge=!0;break;case"object":switch(C.$$typeof){case o:case i:ge=!0;break;case y:return ge=C._init,k(ge(C._payload),O,Z,J,ae)}}if(ge)return ae=ae(C),ge=J===""?"."+Ze(C,0):J,V(ae)?(Z="",ge!=null&&(Z=ge.replace(Ie,"$&/")+"/"),k(ae,O,Z,"",function(ve){return ve})):ae!=null&&(se(ae)&&(ae=fe(ae,Z+(ae.key==null||C&&C.key===ae.key?"":(""+ae.key).replace(Ie,"$&/")+"/")+ge)),O.push(ae)),1;ge=0;var Ue=J===""?".":J+":";if(V(C))for(var Se=0;Se<C.length;Se++)J=C[Se],ne=Ue+Ze(J,Se),ge+=k(J,O,Z,ne,ae);else if(Se=R(C),typeof Se=="function")for(C=Se.call(C),Se=0;!(J=C.next()).done;)J=J.value,ne=Ue+Ze(J,Se++),ge+=k(J,O,Z,ne,ae);else if(ne==="object"){if(typeof C.then=="function")return k(lt(C),O,Z,J,ae);throw O=String(C),Error("Objects are not valid as a React child (found: "+(O==="[object Object]"?"object with keys {"+Object.keys(C).join(", ")+"}":O)+"). If you meant to render a collection of children, use an array instead.")}return ge}function G(C,O,Z){if(C==null)return C;var J=[],ae=0;return k(C,J,"","",function(ne){return O.call(Z,ne,ae++)}),J}function ee(C){if(C._status===-1){var O=C._result;O=O(),O.then(function(Z){(C._status===0||C._status===-1)&&(C._status=1,C._result=Z)},function(Z){(C._status===0||C._status===-1)&&(C._status=2,C._result=Z)}),C._status===-1&&(C._status=0,C._result=O)}if(C._status===1)return C._result.default;throw C._result}var ce=typeof reportError=="function"?reportError:function(C){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var O=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof C=="object"&&C!==null&&typeof C.message=="string"?String(C.message):String(C),error:C});if(!window.dispatchEvent(O))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",C);return}console.error(C)},be={map:G,forEach:function(C,O,Z){G(C,function(){O.apply(this,arguments)},Z)},count:function(C){var O=0;return G(C,function(){O++}),O},toArray:function(C){return G(C,function(O){return O})||[]},only:function(C){if(!se(C))throw Error("React.Children.only expected to receive a single React element child.");return C}};return ie.Activity=S,ie.Children=be,ie.Component=$,ie.Fragment=r,ie.Profiler=u,ie.PureComponent=X,ie.StrictMode=c,ie.Suspense=g,ie.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=B,ie.__COMPILER_RUNTIME={__proto__:null,c:function(C){return B.H.useMemoCache(C)}},ie.cache=function(C){return function(){return C.apply(null,arguments)}},ie.cacheSignal=function(){return null},ie.cloneElement=function(C,O,Z){if(C==null)throw Error("The argument must be a React element, but you passed "+C+".");var J=q({},C.props),ae=C.key;if(O!=null)for(ne in O.key!==void 0&&(ae=""+O.key),O)!K.call(O,ne)||ne==="key"||ne==="__self"||ne==="__source"||ne==="ref"&&O.ref===void 0||(J[ne]=O[ne]);var ne=arguments.length-2;if(ne===1)J.children=Z;else if(1<ne){for(var ge=Array(ne),Ue=0;Ue<ne;Ue++)ge[Ue]=arguments[Ue+2];J.children=ge}return le(C.type,ae,J)},ie.createContext=function(C){return C={$$typeof:p,_currentValue:C,_currentValue2:C,_threadCount:0,Provider:null,Consumer:null},C.Provider=C,C.Consumer={$$typeof:f,_context:C},C},ie.createElement=function(C,O,Z){var J,ae={},ne=null;if(O!=null)for(J in O.key!==void 0&&(ne=""+O.key),O)K.call(O,J)&&J!=="key"&&J!=="__self"&&J!=="__source"&&(ae[J]=O[J]);var ge=arguments.length-2;if(ge===1)ae.children=Z;else if(1<ge){for(var Ue=Array(ge),Se=0;Se<ge;Se++)Ue[Se]=arguments[Se+2];ae.children=Ue}if(C&&C.defaultProps)for(J in ge=C.defaultProps,ge)ae[J]===void 0&&(ae[J]=ge[J]);return le(C,ne,ae)},ie.createRef=function(){return{current:null}},ie.forwardRef=function(C){return{$$typeof:m,render:C}},ie.isValidElement=se,ie.lazy=function(C){return{$$typeof:y,_payload:{_status:-1,_result:C},_init:ee}},ie.memo=function(C,O){return{$$typeof:v,type:C,compare:O===void 0?null:O}},ie.startTransition=function(C){var O=B.T,Z={};B.T=Z;try{var J=C(),ae=B.S;ae!==null&&ae(Z,J),typeof J=="object"&&J!==null&&typeof J.then=="function"&&J.then(Y,ce)}catch(ne){ce(ne)}finally{O!==null&&Z.types!==null&&(O.types=Z.types),B.T=O}},ie.unstable_useCacheRefresh=function(){return B.H.useCacheRefresh()},ie.use=function(C){return B.H.use(C)},ie.useActionState=function(C,O,Z){return B.H.useActionState(C,O,Z)},ie.useCallback=function(C,O){return B.H.useCallback(C,O)},ie.useContext=function(C){return B.H.useContext(C)},ie.useDebugValue=function(){},ie.useDeferredValue=function(C,O){return B.H.useDeferredValue(C,O)},ie.useEffect=function(C,O){return B.H.useEffect(C,O)},ie.useEffectEvent=function(C){return B.H.useEffectEvent(C)},ie.useId=function(){return B.H.useId()},ie.useImperativeHandle=function(C,O,Z){return B.H.useImperativeHandle(C,O,Z)},ie.useInsertionEffect=function(C,O){return B.H.useInsertionEffect(C,O)},ie.useLayoutEffect=function(C,O){return B.H.useLayoutEffect(C,O)},ie.useMemo=function(C,O){return B.H.useMemo(C,O)},ie.useOptimistic=function(C,O){return B.H.useOptimistic(C,O)},ie.useReducer=function(C,O,Z){return B.H.useReducer(C,O,Z)},ie.useRef=function(C){return B.H.useRef(C)},ie.useState=function(C){return B.H.useState(C)},ie.useSyncExternalStore=function(C,O,Z){return B.H.useSyncExternalStore(C,O,Z)},ie.useTransition=function(){return B.H.useTransition()},ie.version="19.2.6",ie}var ch;function Wc(){return ch||(ch=1,_c.exports=W0()),_c.exports}var T=Wc();const Le=$0(T);var Uc={exports:{}},Si={},Hc={exports:{}},Lc={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var uh;function P0(){return uh||(uh=1,(function(o){function i(k,G){var ee=k.length;k.push(G);e:for(;0<ee;){var ce=ee-1>>>1,be=k[ce];if(0<u(be,G))k[ce]=G,k[ee]=be,ee=ce;else break e}}function r(k){return k.length===0?null:k[0]}function c(k){if(k.length===0)return null;var G=k[0],ee=k.pop();if(ee!==G){k[0]=ee;e:for(var ce=0,be=k.length,C=be>>>1;ce<C;){var O=2*(ce+1)-1,Z=k[O],J=O+1,ae=k[J];if(0>u(Z,ee))J<be&&0>u(ae,Z)?(k[ce]=ae,k[J]=ee,ce=J):(k[ce]=Z,k[O]=ee,ce=O);else if(J<be&&0>u(ae,ee))k[ce]=ae,k[J]=ee,ce=J;else break e}}return G}function u(k,G){var ee=k.sortIndex-G.sortIndex;return ee!==0?ee:k.id-G.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var f=performance;o.unstable_now=function(){return f.now()}}else{var p=Date,m=p.now();o.unstable_now=function(){return p.now()-m}}var g=[],v=[],y=1,S=null,z=3,R=!1,H=!1,q=!1,L=!1,$=typeof setTimeout=="function"?setTimeout:null,W=typeof clearTimeout=="function"?clearTimeout:null,X=typeof setImmediate<"u"?setImmediate:null;function Q(k){for(var G=r(v);G!==null;){if(G.callback===null)c(v);else if(G.startTime<=k)c(v),G.sortIndex=G.expirationTime,i(g,G);else break;G=r(v)}}function V(k){if(q=!1,Q(k),!H)if(r(g)!==null)H=!0,Y||(Y=!0,ke());else{var G=r(v);G!==null&&lt(V,G.startTime-k)}}var Y=!1,B=-1,K=5,le=-1;function fe(){return L?!0:!(o.unstable_now()-le<K)}function se(){if(L=!1,Y){var k=o.unstable_now();le=k;var G=!0;try{e:{H=!1,q&&(q=!1,W(B),B=-1),R=!0;var ee=z;try{t:{for(Q(k),S=r(g);S!==null&&!(S.expirationTime>k&&fe());){var ce=S.callback;if(typeof ce=="function"){S.callback=null,z=S.priorityLevel;var be=ce(S.expirationTime<=k);if(k=o.unstable_now(),typeof be=="function"){S.callback=be,Q(k),G=!0;break t}S===r(g)&&c(g),Q(k)}else c(g);S=r(g)}if(S!==null)G=!0;else{var C=r(v);C!==null&&lt(V,C.startTime-k),G=!1}}break e}finally{S=null,z=ee,R=!1}G=void 0}}finally{G?ke():Y=!1}}}var ke;if(typeof X=="function")ke=function(){X(se)};else if(typeof MessageChannel<"u"){var Ie=new MessageChannel,Ze=Ie.port2;Ie.port1.onmessage=se,ke=function(){Ze.postMessage(null)}}else ke=function(){$(se,0)};function lt(k,G){B=$(function(){k(o.unstable_now())},G)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(k){k.callback=null},o.unstable_forceFrameRate=function(k){0>k||125<k?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):K=0<k?Math.floor(1e3/k):5},o.unstable_getCurrentPriorityLevel=function(){return z},o.unstable_next=function(k){switch(z){case 1:case 2:case 3:var G=3;break;default:G=z}var ee=z;z=G;try{return k()}finally{z=ee}},o.unstable_requestPaint=function(){L=!0},o.unstable_runWithPriority=function(k,G){switch(k){case 1:case 2:case 3:case 4:case 5:break;default:k=3}var ee=z;z=k;try{return G()}finally{z=ee}},o.unstable_scheduleCallback=function(k,G,ee){var ce=o.unstable_now();switch(typeof ee=="object"&&ee!==null?(ee=ee.delay,ee=typeof ee=="number"&&0<ee?ce+ee:ce):ee=ce,k){case 1:var be=-1;break;case 2:be=250;break;case 5:be=1073741823;break;case 4:be=1e4;break;default:be=5e3}return be=ee+be,k={id:y++,callback:G,priorityLevel:k,startTime:ee,expirationTime:be,sortIndex:-1},ee>ce?(k.sortIndex=ee,i(v,k),r(g)===null&&k===r(v)&&(q?(W(B),B=-1):q=!0,lt(V,ee-ce))):(k.sortIndex=be,i(g,k),H||R||(H=!0,Y||(Y=!0,ke()))),k},o.unstable_shouldYield=fe,o.unstable_wrapCallback=function(k){var G=z;return function(){var ee=z;z=G;try{return k.apply(this,arguments)}finally{z=ee}}}})(Lc)),Lc}var dh;function ev(){return dh||(dh=1,Hc.exports=P0()),Hc.exports}var Bc={exports:{}},ht={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var hh;function nv(){if(hh)return Si;hh=1;var o=ev(),i=Wc(),r=Lh();function c(e){var t="https://react.dev/errors/"+e;if(1<arguments.length){t+="?args[]="+encodeURIComponent(arguments[1]);for(var n=2;n<arguments.length;n++)t+="&args[]="+encodeURIComponent(arguments[n])}return"Minified React error #"+e+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function u(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function f(e){var t=e,n=e;if(e.alternate)for(;t.return;)t=t.return;else{e=t;do t=e,(t.flags&4098)!==0&&(n=t.return),e=t.return;while(e)}return t.tag===3?n:null}function p(e){if(e.tag===13){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function m(e){if(e.tag===31){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function g(e){if(f(e)!==e)throw Error(c(188))}function v(e){var t=e.alternate;if(!t){if(t=f(e),t===null)throw Error(c(188));return t!==e?null:e}for(var n=e,a=t;;){var l=n.return;if(l===null)break;var s=l.alternate;if(s===null){if(a=l.return,a!==null){n=a;continue}break}if(l.child===s.child){for(s=l.child;s;){if(s===n)return g(l),e;if(s===a)return g(l),t;s=s.sibling}throw Error(c(188))}if(n.return!==a.return)n=l,a=s;else{for(var d=!1,h=l.child;h;){if(h===n){d=!0,n=l,a=s;break}if(h===a){d=!0,a=l,n=s;break}h=h.sibling}if(!d){for(h=s.child;h;){if(h===n){d=!0,n=s,a=l;break}if(h===a){d=!0,a=s,n=l;break}h=h.sibling}if(!d)throw Error(c(189))}}if(n.alternate!==a)throw Error(c(190))}if(n.tag!==3)throw Error(c(188));return n.stateNode.current===n?e:t}function y(e){var t=e.tag;if(t===5||t===26||t===27||t===6)return e;for(e=e.child;e!==null;){if(t=y(e),t!==null)return t;e=e.sibling}return null}var S=Object.assign,z=Symbol.for("react.element"),R=Symbol.for("react.transitional.element"),H=Symbol.for("react.portal"),q=Symbol.for("react.fragment"),L=Symbol.for("react.strict_mode"),$=Symbol.for("react.profiler"),W=Symbol.for("react.consumer"),X=Symbol.for("react.context"),Q=Symbol.for("react.forward_ref"),V=Symbol.for("react.suspense"),Y=Symbol.for("react.suspense_list"),B=Symbol.for("react.memo"),K=Symbol.for("react.lazy"),le=Symbol.for("react.activity"),fe=Symbol.for("react.memo_cache_sentinel"),se=Symbol.iterator;function ke(e){return e===null||typeof e!="object"?null:(e=se&&e[se]||e["@@iterator"],typeof e=="function"?e:null)}var Ie=Symbol.for("react.client.reference");function Ze(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===Ie?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case q:return"Fragment";case $:return"Profiler";case L:return"StrictMode";case V:return"Suspense";case Y:return"SuspenseList";case le:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case H:return"Portal";case X:return e.displayName||"Context";case W:return(e._context.displayName||"Context")+".Consumer";case Q:var t=e.render;return e=e.displayName,e||(e=t.displayName||t.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case B:return t=e.displayName||null,t!==null?t:Ze(e.type)||"Memo";case K:t=e._payload,e=e._init;try{return Ze(e(t))}catch{}}return null}var lt=Array.isArray,k=i.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,G=r.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,ee={pending:!1,data:null,method:null,action:null},ce=[],be=-1;function C(e){return{current:e}}function O(e){0>be||(e.current=ce[be],ce[be]=null,be--)}function Z(e,t){be++,ce[be]=e.current,e.current=t}var J=C(null),ae=C(null),ne=C(null),ge=C(null);function Ue(e,t){switch(Z(ne,t),Z(ae,e),Z(J,null),t.nodeType){case 9:case 11:e=(e=t.documentElement)&&(e=e.namespaceURI)?Ep(e):0;break;default:if(e=t.tagName,t=t.namespaceURI)t=Ep(t),e=Ap(t,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}O(J),Z(J,e)}function Se(){O(J),O(ae),O(ne)}function ve(e){e.memoizedState!==null&&Z(ge,e);var t=J.current,n=Ap(t,e.type);t!==n&&(Z(ae,e),Z(J,n))}function cn(e){ae.current===e&&(O(J),O(ae)),ge.current===e&&(O(ge),gi._currentValue=ee)}var bt,yn;function it(e){if(bt===void 0)try{throw Error()}catch(n){var t=n.stack.trim().match(/\n( *(at )?)/);bt=t&&t[1]||"",yn=-1<n.stack.indexOf(`
...
${y}`:y,f=f?`${f}
${S}`:S;const z=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(S,p,!0),this.lexer.state.top=z,c.length===0)break;const R=p[p.length-1];if((R==null?void 0:R.type)==="code")break;if((R==null?void 0:R.type)==="blockquote"){const H=R,q=H.raw+`
`+c.join(`
`),L=this.blockquote(q);p[p.length-1]=L,u=u.substring(0,u.length-H.raw.length)+L.raw,f=f.substring(0,f.length-H.text.length)+L.text;break}else if((R==null?void 0:R.type)==="list"){const H=R,q=H.raw+`
`+c.join(`
`),L=this.list(q);p[p.length-1]=L,u=u.substring(0,u.length-R.raw.length)+L.raw,f=f.substring(0,f.length-H.raw.length)+L.raw,c=q.substring(p[p.length-1].raw.length).split(`
...
`,Vv=qv.replace(/@font-face\s*\{[^}]*\}/g,""),Kv=[Gv,Qv,Zv].join(`

`);function Jv(o){return`<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
...
</html>`}function $v({code:o}){const i=T.useRef(null),[r,c]=T.useState("preview");return T.useEffect(()=>{!i.current||!o||(i.current.srcdoc=Jv(o))},[o]),o?b.jsxs("div",{className:"canvas canvas--live",children:[b.jsxs("div",{className:"canvas-toolbar",children:[b.jsxs("div",{className:"canvas-view-tabs",children:[b.jsx("button",{className:`canvas-view-tab ${r==="preview"?"active":""}`,onClick:()=>c("preview"),children:"Preview"}),b.jsx("button",{className:`canvas-view-tab ${r==="code"?"active":""}`,onClick:()=>c("code"),children:"Code"})]}),b.jsx("button",{className:"canvas-copy-btn",onClick:()=>navigator.clipboard.writeText(o),children:"copy"})]}),b.jsxs("div",{className:"canvas-body",children:[b.jsx("iframe",{ref:i,className:"canvas-iframe",style:{display:r==="preview"?"block":"none"},title:"design preview",sandbox:"allow-scripts allow-same-origin"}),r==="code"&&b.jsx("pre",{className:"canvas-code",children:b.jsx("code",{children:o})})]})]}):b.jsx("div",{className:"canvas canvas--empty",children:b.jsxs("div",{className:"canvas-empty-inner",children:[b.jsx("div",{className:"canvas-empty-icon",children:"◻"}),b.jsx("p",{children:"Your design will appear here"}),b.jsx("span",{children:"Load a PRD and describe the UI in the chat"})]})})}const Fh="ennabl_builder_history",Iv=50;function Fv(){try{return JSON.parse(localStorage.getItem(Fh)||"[]")}catch{return[]}}function Sh(o){localStorage.setItem(Fh,JSON.stringify(o.slice(0,Iv)))}function Wv({prdName:o,code:i,iteration:r}){return{id:`${Date.now()}-${Math.random().toString(36).slice(2,6)}`,timestamp:new Date().toISOString(),prdName:o,code:i,iteration:r}}function Pv(o){const r=`${o.prdName.replace(/\.md$/i,"").replace(/[^a-z0-9]/gi,"-").toLowerCase()}-v${o.iteration}.jsx`,c=`/**
