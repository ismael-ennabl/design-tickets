 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var j1;function u2(){if(j1)return fe;j1=1;var s=Symbol.for("react.transitional.element"),l=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),o=Symbol.for("react.strict_mode"),u=Symbol.for("react.profiler"),d=Symbol.for("react.consumer"),f=Symbol.for("react.context"),m=Symbol.for("react.forward_ref"),g=Symbol.for("react.suspense"),v=Symbol.for("react.memo"),x=Symbol.for("react.lazy"),S=Symbol.for("react.activity"),T=Symbol.iterator;function A(E){return E===null||typeof E!="object"?null:(E=T&&E[T]||E["@@iterator"],typeof E=="function"?E:null)}var k={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},M=Object.assign,B={};function Z(E,_,K){this.props=E,this.context=_,this.refs=B,this.updater=K||k}Z.prototype.isReactComponent={},Z.prototype.setState=function(E,_){if(typeof E!="object"&&typeof E!="function"&&E!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,E,_,"setState")},Z.prototype.forceUpdate=function(E){this.updater.enqueueForceUpdate(this,E,"forceUpdate")};function G(){}G.prototype=Z.prototype;function $(E,_,K){this.props=E,this.context=_,this.refs=B,this.updater=K||k}var X=$.prototype=new G;X.constructor=$,M(X,Z.prototype),X.isPureReactComponent=!0;var I=Array.isArray;function F(){}var q={H:null,A:null,T:null,S:null},te=Object.prototype.hasOwnProperty;function ue(E,_,K){var J=K.ref;return{$$typeof:s,type:E,key:_,ref:J!==void 0?J:null,props:K}}function pe(E,_){return ue(E.type,_,E.props)}function de(E){return typeof E=="object"&&E!==null&&E.$$typeof===s}function me(E){var _={"=":"=0",":":"=2"};return"$"+E.replace(/[=:]/g,function(K){return _[K]})}var Ae=/\/+/g;function ke(E,_){return typeof E=="object"&&E!==null&&E.key!=null?me(""+E.key):_.toString(36)}function ae(E){switch(E.status){case"fulfilled":return E.value;case"rejected":throw E.reason;default:switch(typeof E.status=="string"?E.then(F,F):(E.status="pending",E.then(function(_){E.status==="pending"&&(E.status="fulfilled",E.value=_)},function(_){E.status==="pending"&&(E.status="rejected",E.reason=_)})),E.status){case"fulfilled":return E.value;case"rejected":throw E.reason}}throw E}function j(E,_,K,J,Y){var Q=typeof E;(Q==="undefined"||Q==="boolean")&&(E=null);var P=!1;if(E===null)P=!0;else switch(Q){case"bigint":case"string":case"number":P=!0;break;case"object":switch(E.$$typeof){case s:case l:P=!0;break;case x:return P=E._init,j(P(E._payload),_,K,J,Y)}}if(P)return Y=Y(E),P=J===""?"."+ke(E,0):J,I(Y)?(K="",P!=null&&(K=P.replace(Ae,"$&/")+"/"),j(Y,_,K,"",function(re){return re})):Y!=null&&(de(Y)&&(Y=pe(Y,K+(Y.key==null||E&&E.key===Y.key?"":(""+Y.key).replace(Ae,"$&/")+"/")+P)),_.push(Y)),1;P=0;var ie=J===""?".":J+":";if(I(E))for(var le=0;le<E.length;le++)J=E[le],Q=ie+ke(J,le),P+=j(J,_,K,Q,Y);else if(le=A(E),typeof le=="function")for(E=le.call(E),le=0;!(J=E.next()).done;)J=J.value,Q=ie+ke(J,le++),P+=j(J,_,K,Q,Y);else if(Q==="object"){if(typeof E.then=="function")return j(ae(E),_,K,J,Y);throw _=String(E),Error("Objects are not valid as a React child (found: "+(_==="[object Object]"?"object with keys {"+Object.keys(E).join(", ")+"}":_)+"). If you meant to render a collection of children, use an array instead.")}return P}function V(E,_,K){if(E==null)return E;var J=[],Y=0;return j(E,J,"","",function(Q){return _.call(K,Q,Y++)}),J}function W(E){if(E._status===-1){var _=E._result;_=_(),_.then(function(K){(E._status===0||E._status===-1)&&(E._status=1,E._result=K)},function(K){(E._status===0||E._status===-1)&&(E._status=2,E._result=K)}),E._status===-1&&(E._status=0,E._result=_)}if(E._status===1)return E._result.default;throw E._result}var ce=typeof reportError=="function"?reportError:function(E){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var _=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof E=="object"&&E!==null&&typeof E.message=="string"?String(E.message):String(E),error:E});if(!window.dispatchEvent(_))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",E);return}console.error(E)},be={map:V,forEach:function(E,_,K){V(E,function(){_.apply(this,arguments)},K)},count:function(E){var _=0;return V(E,function(){_++}),_},toArray:function(E){return V(E,function(_){return _})||[]},only:function(E){if(!de(E))throw Error("React.Children.only expected to receive a single React element child.");return E}};return fe.Activity=S,fe.Children=be,fe.Component=Z,fe.Fragment=i,fe.Profiler=u,fe.PureComponent=$,fe.StrictMode=o,fe.Suspense=g,fe.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=q,fe.__COMPILER_RUNTIME={__proto__:null,c:function(E){return q.H.useMemoCache(E)}},fe.cache=function(E){return function(){return E.apply(null,arguments)}},fe.cacheSignal=function(){return null},fe.cloneElement=function(E,_,K){if(E==null)throw Error("The argument must be a React element, but you passed "+E+".");var J=M({},E.props),Y=E.key;if(_!=null)for(Q in _.key!==void 0&&(Y=""+_.key),_)!te.call(_,Q)||Q==="key"||Q==="__self"||Q==="__source"||Q==="ref"&&_.ref===void 0||(J[Q]=_[Q]);var Q=arguments.length-2;if(Q===1)J.children=K;else if(1<Q){for(var P=Array(Q),ie=0;ie<Q;ie++)P[ie]=arguments[ie+2];J.children=P}return ue(E.type,Y,J)},fe.createContext=function(E){return E={$$typeof:f,_currentValue:E,_currentValue2:E,_threadCount:0,Provider:null,Consumer:null},E.Provider=E,E.Consumer={$$typeof:d,_context:E},E},fe.createElement=function(E,_,K){var J,Y={},Q=null;if(_!=null)for(J in _.key!==void 0&&(Q=""+_.key),_)te.call(_,J)&&J!=="key"&&J!=="__self"&&J!=="__source"&&(Y[J]=_[J]);var P=arguments.length-2;if(P===1)Y.children=K;else if(1<P){for(var ie=Array(P),le=0;le<P;le++)ie[le]=arguments[le+2];Y.children=ie}if(E&&E.defaultProps)for(J in P=E.defaultProps,P)Y[J]===void 0&&(Y[J]=P[J]);return ue(E,Q,Y)},fe.createRef=function(){return{current:null}},fe.forwardRef=function(E){return{$$typeof:m,render:E}},fe.isValidElement=de,fe.lazy=function(E){return{$$typeof:x,_payload:{_status:-1,_result:E},_init:W}},fe.memo=function(E,_){return{$$typeof:v,type:E,compare:_===void 0?null:_}},fe.startTransition=function(E){var _=q.T,K={};q.T=K;try{var J=E(),Y=q.S;Y!==null&&Y(K,J),typeof J=="object"&&J!==null&&typeof J.then=="function"&&J.then(F,ce)}catch(Q){ce(Q)}finally{_!==null&&K.types!==null&&(_.types=K.types),q.T=_}},fe.unstable_useCacheRefresh=function(){return q.H.useCacheRefresh()},fe.use=function(E){return q.H.use(E)},fe.useActionState=function(E,_,K){return q.H.useActionState(E,_,K)},fe.useCallback=function(E,_){return q.H.useCallback(E,_)},fe.useContext=function(E){return q.H.useContext(E)},fe.useDebugValue=function(){},fe.useDeferredValue=function(E,_){return q.H.useDeferredValue(E,_)},fe.useEffect=function(E,_){return q.H.useEffect(E,_)},fe.useEffectEvent=function(E){return q.H.useEffectEvent(E)},fe.useId=function(){return q.H.useId()},fe.useImperativeHandle=function(E,_,K){return q.H.useImperativeHandle(E,_,K)},fe.useInsertionEffect=function(E,_){return q.H.useInsertionEffect(E,_)},fe.useLayoutEffect=function(E,_){return q.H.useLayoutEffect(E,_)},fe.useMemo=function(E,_){return q.H.useMemo(E,_)},fe.useOptimistic=function(E,_){return q.H.useOptimistic(E,_)},fe.useReducer=function(E,_,K){return q.H.useReducer(E,_,K)},fe.useRef=function(E){return q.H.useRef(E)},fe.useState=function(E){return q.H.useState(E)},fe.useSyncExternalStore=function(E,_,K){return q.H.useSyncExternalStore(E,_,K)},fe.useTransition=function(){return q.H.useTransition()},fe.version="19.2.6",fe}var z1;function hu(){return z1||(z1=1,Ic.exports=u2()),Ic.exports}var h=hu();const Ve=o2(h);var Yc={exports:{}},ki={},Gc={exports:{}},Xc={};/**
 * @license React
...
// Phosphor: NotePencil (fill weight)
const IconEditFill = ({ size = 16, style }) => (
  <PhIcon size={size} style={style} d="M224,128v80a16,16,0,0,1-16,16H48a16,16,0,0,1-16-16V48A16,16,0,0,1,48,32h80a8,8,0,0,1,0,16H48V208H208V128a8,8,0,0,1,16,0Zm5.66-58.34-96,96A8,8,0,0,1,128,168H96a8,8,0,0,1-8-8V128a8,8,0,0,1,2.34-5.66l96-96a8,8,0,0,1,11.32,0l32,32A8,8,0,0,1,229.66,69.66Zm-17-5.66L192,43.31,179.31,56,200,76.69Z" />
);
...
`,Lb=`You are an expert UI engineer for ennabl, an insurance analytics platform for insurance agencies and brokers.
