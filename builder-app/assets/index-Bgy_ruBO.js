var N0=Object.defineProperty;var xh=o=>{throw TypeError(o)};var T0=(o,l,i)=>l in o?N0(o,l,{enumerable:!0,configurable:!0,writable:!0,value:i}):o[l]=i;var je=(o,l,i)=>T0(o,typeof l!="symbol"?l+"":l,i),E0=(o,l,i)=>l.has(o)||xh("Cannot "+i);var Sh=(o,l,i)=>l.has(o)?xh("Cannot add the same private member more than once"):l instanceof WeakSet?l.add(o):l.set(o,i);var Ni=(o,l,i)=>(E0(o,l,"access private method"),i);(function(){const l=document.createElement("link").relList;if(l&&l.supports&&l.supports("modulepreload"))return;for(const u of document.querySelectorAll('link[rel="modulepreload"]'))s(u);new MutationObserver(u=>{for(const d of u)if(d.type==="childList")for(const f of d.addedNodes)f.tagName==="LINK"&&f.rel==="modulepreload"&&s(f)}).observe(document,{childList:!0,subtree:!0});function i(u){const d={};return u.integrity&&(d.integrity=u.integrity),u.referrerPolicy&&(d.referrerPolicy=u.referrerPolicy),u.crossOrigin==="use-credentials"?d.credentials="include":u.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function s(u){if(u.ep)return;u.ep=!0;const d=i(u);fetch(u.href,d)}})();function D0(o){return o&&o.__esModule&&Object.prototype.hasOwnProperty.call(o,"default")?o.default:o}var Yc={exports:{}},Ti={};/**
 * @license React
 ...
 */var wh;function A0(){if(wh)return Ti;wh=1;var o=Symbol.for("react.transitional.element"),l=Symbol.for("react.fragment");function i(s,u,d){var f=null;if(d!==void 0&&(f=""+d),u.key!==void 0&&(f=""+u.key),"key"in u){d={};for(var h in u)h!=="key"&&(d[h]=u[h])}else d=u;return u=d.ref,{$$typeof:o,type:s,key:f,ref:u!==void 0?u:null,props:d}}return Ti.Fragment=l,Ti.jsx=i,Ti.jsxs=i,Ti}var Ch;function k0(){return Ch||(Ch=1,Yc.exports=A0()),Yc.exports}var v=k0(),Gc={exports:{}},oe={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Nh;function R0(){if(Nh)return oe;Nh=1;var o=Symbol.for("react.transitional.element"),l=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),u=Symbol.for("react.profiler"),d=Symbol.for("react.consumer"),f=Symbol.for("react.context"),h=Symbol.for("react.forward_ref"),g=Symbol.for("react.suspense"),b=Symbol.for("react.memo"),y=Symbol.for("react.lazy"),x=Symbol.for("react.activity"),E=Symbol.iterator;function D(w){return w===null||typeof w!="object"?null:(w=E&&w[E]||w["@@iterator"],typeof w=="function"?w:null)}var M={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},z=Object.assign,Q={};function B(w,j,Z){this.props=w,this.context=j,this.refs=Q,this.updater=Z||M}B.prototype.isReactComponent={},B.prototype.setState=function(w,j){if(typeof w!="object"&&typeof w!="function"&&w!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,w,j,"setState")},B.prototype.forceUpdate=function(w){this.updater.enqueueForceUpdate(this,w,"forceUpdate")};function X(){}X.prototype=B.prototype;function K(w,j,Z){this.props=w,this.context=j,this.refs=Q,this.updater=Z||M}var I=K.prototype=new X;I.constructor=K,z(I,B.prototype),I.isPureReactComponent=!0;var V=Array.isArray;function G(){}var Y={H:null,A:null,T:null,S:null},J=Object.prototype.hasOwnProperty;function ee(w,j,Z){var F=Z.ref;return{$$typeof:o,type:w,key:j,ref:F!==void 0?F:null,props:Z}}function de(w,j){return ee(w.type,j,w.props)}function re(w){return typeof w=="object"&&w!==null&&w.$$typeof===o}function me(w){var j={"=":"=0",":":"=2"};return"$"+w.replace(/[=:]/g,function(Z){return j[Z]})}var Ge=/\/+/g;function He(w,j){return typeof w=="object"&&w!==null&&w.key!=null?me(""+w.key):j.toString(36)}function Fe(w){switch(w.status){case"fulfilled":return w.value;case"rejected":throw w.reason;default:switch(typeof w.status=="string"?w.then(G,G):(w.status="pending",w.then(function(j){w.status==="pending"&&(w.status="fulfilled",w.value=j)},function(j){w.status==="pending"&&(w.status="rejected",w.reason=j)})),w.status){case"fulfilled":return w.value;case"rejected":throw w.reason}}throw w}function _(w,j,Z,F,le){var te=typeof w;(te==="undefined"||te==="boolean")&&(w=null);var be=!1;if(w===null)be=!0;else switch(te){case"bigint":case"string":case"number":be=!0;break;case"object":switch(w.$$typeof){case o:case l:be=!0;break;case y:return be=w._init,_(be(w._payload),j,Z,F,le)}}if(be)return le=le(w),be=F===""?"."+He(w,0):F,V(le)?(Z="",be!=null&&(Z=be.replace(Ge,"$&/")+"/"),_(le,j,Z,"",function(ye){return ye})):le!=null&&(re(le)&&(le=de(le,Z+(le.key==null||w&&w.key===le.key?"":(""+le.key).replace(Ge,"$&/")+"/")+be)),j.push(le)),1;be=0;var Ue=F===""?".":F+":";if(V(w))for(var we=0;we<w.length;we++)F=w[we],te=Ue+He(F,we),be+=_(F,j,Z,te,le);else if(we=D(w),typeof we=="function")for(w=we.call(w),we=0;!(F=w.next()).done;)F=F.value,te=Ue+He(F,we++),be+=_(F,j,Z,te,le);else if(te==="object"){if(typeof w.then=="function")return _(Fe(w),j,Z,F,le);throw j=String(w),Error("Objects are not valid as a React child (found: "+(j==="[object Object]"?"object with keys {"+Object.keys(w).join(", ")+"}":j)+"). If you meant to render a collection of children, use an array instead.")}return be}function q(w,j,Z){if(w==null)return w;var F=[],le=0;return _(w,F,"","",function(te){return j.call(Z,te,le++)}),F}function $(w){if(w._status===-1){var j=w._result;j=j(),j.then(function(Z){(w._status===0||w._status===-1)&&(w._status=1,w._result=Z)},function(Z){(w._status===0||w._status===-1)&&(w._status=2,w._result=Z)}),w._status===-1&&(w._status=0,w._result=j)}if(w._status===1)return w._result.default;throw w._result}var ae=typeof reportError=="function"?reportError:function(w){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var j=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof w=="object"&&w!==null&&typeof w.message=="string"?String(w.message):String(w),error:w});if(!window.dispatchEvent(j))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",w);return}console.error(w)},se={map:q,forEach:function(w,j,Z){q(w,function(){j.apply(this,arguments)},Z)},count:function(w){var j=0;return q(w,function(){j++}),j},toArray:function(w){return q(w,function(j){return j})||[]},only:function(w){if(!re(w))throw Error("React.Children.only expected to receive a single React element child.");return w}};return oe.Activity=x,oe.Children=se,oe.Component=B,oe.Fragment=i,oe.Profiler=u,oe.PureComponent=K,oe.StrictMode=s,oe.Suspense=g,oe.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=Y,oe.__COMPILER_RUNTIME={__proto__:null,c:function(w){return Y.H.useMemoCache(w)}},oe.cache=function(w){return function(){return w.apply(null,arguments)}},oe.cacheSignal=function(){return null},oe.cloneElement=function(w,j,Z){if(w==null)throw Error("The argument must be a React element, but you passed "+w+".");var F=z({},w.props),le=w.key;if(j!=null)for(te in j.key!==void 0&&(le=""+j.key),j)!J.call(j,te)||te==="key"||te==="__self"||te==="__source"||te==="ref"&&j.ref===void 0||(F[te]=j[te]);var te=arguments.length-2;if(te===1)F.children=Z;else if(1<te){for(var be=Array(te),Ue=0;Ue<te;Ue++)be[Ue]=arguments[Ue+2];F.children=be}return ee(w.type,le,F)},oe.createContext=function(w){return w={$$typeof:f,_currentValue:w,_currentValue2:w,_threadCount:0,Provider:null,Consumer:null},w.Provider=w,w.Consumer={$$typeof:d,_context:w},w},oe.createElement=function(w,j,Z){var F,le={},te=null;if(j!=null)for(F in j.key!==void 0&&(te=""+j.key),j)J.call(j,F)&&F!=="key"&&F!=="__self"&&F!=="__source"&&(le[F]=j[F]);var be=arguments.length-2;if(be===1)le.children=Z;else if(1<be){for(var Ue=Array(be),we=0;we<be;we++)Ue[we]=arguments[we+2];le.children=Ue}if(w&&w.defaultProps)for(F in be=w.defaultProps,be)le[F]===void 0&&(le[F]=be[F]);return ee(w,te,le)},oe.createRef=function(){return{current:null}},oe.forwardRef=function(w){return{$$typeof:h,render:w}},oe.isValidElement=re,oe.lazy=function(w){return{$$typeof:y,_payload:{_status:-1,_result:w},_init:$}},oe.memo=function(w,j){return{$$typeof:b,type:w,compare:j===void 0?null:j}},oe.startTransition=function(w){var j=Y.T,Z={};Y.T=Z;try{var F=w(),le=Y.S;le!==null&&le(Z,F),typeof F=="object"&&F!==null&&typeof F.then=="function"&&F.then(G,ae)}catch(te){ae(te)}finally{j!==null&&Z.types!==null&&(j.types=Z.types),Y.T=j}},oe.unstable_useCacheRefresh=function(){return Y.H.useCacheRefresh()},oe.use=function(w){return Y.H.use(w)},oe.useActionState=function(w,j,Z){return Y.H.useActionState(w,j,Z)},oe.useCallback=function(w,j){return Y.H.useCallback(w,j)},oe.useContext=function(w){return Y.H.useContext(w)},oe.useDebugValue=function(){},oe.useDeferredValue=function(w,j){return Y.H.useDeferredValue(w,j)},oe.useEffect=function(w,j){return Y.H.useEffect(w,j)},oe.useEffectEvent=function(w){return Y.H.useEffectEvent(w)},oe.useId=function(){return Y.H.useId()},oe.useImperativeHandle=function(w,j,Z){return Y.H.useImperativeHandle(w,j,Z)},oe.useInsertionEffect=function(w,j){return Y.H.useInsertionEffect(w,j)},oe.useLayoutEffect=function(w,j){return Y.H.useLayoutEffect(w,j)},oe.useMemo=function(w,j){return Y.H.useMemo(w,j)},oe.useOptimistic=function(w,j){return Y.H.useOptimistic(w,j)},oe.useReducer=function(w,j,Z){return Y.H.useReducer(w,j,Z)},oe.useRef=function(w){return Y.H.useRef(w)},oe.useState=function(w){return Y.H.useState(w)},oe.useSyncExternalStore=function(w,j,Z){return Y.H.useSyncExternalStore(w,j,Z)},oe.useTransition=function(){return Y.H.useTransition()},oe.version="19.2.6",oe}var Th;function cu(){return Th||(Th=1,Gc.exports=R0()),Gc.exports}var N=cu();const qe=D0(N);var Xc={exports:{}},Ei={},Vc={exports:{}},Qc={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Eh;function O0(){return Eh||(Eh=1,(function(o){function l(_,q){var $=_.length;_.push(q);e:for(;0<$;){var ae=$-1>>>1,se=_[ae];if(0<u(se,q))_[ae]=q,_[$]=se,$=ae;else break e}}function i(_){return _.length===0?null:_[0]}function s(_){if(_.length===0)return null;var q=_[0],$=_.pop();if($!==q){_[0]=$;e:for(var ae=0,se=_.length,w=se>>>1;ae<w;){var j=2*(ae+1)-1,Z=_[j],F=j+1,le=_[F];if(0>u(Z,$))F<se&&0>u(le,Z)?(_[ae]=le,_[F]=$,ae=F):(_[ae]=Z,_[j]=$,ae=j);else if(F<se&&0>u(le,$))_[ae]=le,_[F]=$,ae=F;else break e}}return q}function u(_,q){var $=_.sortIndex-q.sortIndex;return $!==0?$:_.id-q.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var d=performance;o.unstable_now=function(){return d.now()}}else{var f=Date,h=f.now();o.unstable_now=function(){return f.now()-h}}var g=[],b=[],y=1,x=null,E=3,D=!1,M=!1,z=!1,Q=!1,B=typeof setTimeout=="function"?setTimeout:null,X=typeof clearTimeout=="function"?clearTimeout:null,K=typeof setImmediate<"u"?setImmediate:null;function I(_){for(var q=i(b);q!==null;){if(q.callback===null)s(b);else if(q.startTime<=_)s(b),q.sortIndex=q.expirationTime,l(g,q);else break;q=i(b)}}function V(_){if(z=!1,I(_),!M)if(i(g)!==null)M=!0,G||(G=!0,me());else{var q=i(b);q!==null&&Fe(V,q.startTime-_)}}var G=!1,Y=-1,J=5,ee=-1;function de(){return Q?!0:!(o.unstable_now()-ee<J)}function re(){if(Q=!1,G){var _=o.unstable_now();ee=_;var q=!0;try{e:{M=!1,z&&(z=!1,X(Y),Y=-1),D=!0;var $=E;try{t:{for(I(_),x=i(g);x!==null&&!(x.expirationTime>_&&de());){var ae=x.callback;if(typeof ae=="function"){x.callback=null,E=x.priorityLevel;var se=ae(x.expirationTime<=_);if(_=o.unstable_now(),typeof se=="function"){x.callback=se,I(_),q=!0;break t}x===i(g)&&s(g),I(_)}else s(g);x=i(g)}if(x!==null)q=!0;else{var w=i(b);w!==null&&Fe(V,w.startTime-_),q=!1}}break e}finally{x=null,E=$,D=!1}q=void 0}}finally{q?me():G=!1}}}var me;if(typeof K=="function")me=function(){K(re)};else if(typeof MessageChannel<"u"){var Ge=new MessageChannel,He=Ge.port2;Ge.port1.onmessage=re,me=function(){He.postMessage(null)}}else me=function(){B(re,0)};function Fe(_,q){Y=B(function(){_(o.unstable_now())},q)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(_){_.callback=null},o.unstable_forceFrameRate=function(_){0>_||125<_?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):J=0<_?Math.floor(1e3/_):5},o.unstable_getCurrentPriorityLevel=function(){return E},o.unstable_next=function(_){switch(E){case 1:case 2:case 3:var q=3;break;default:q=E}var $=E;E=q;try{return _()}finally{E=$}},o.unstable_requestPaint=function(){Q=!0},o.unstable_runWithPriority=function(_,q){switch(_){case 1:case 2:case 3:case 4:case 5:break;default:_=3}var $=E;E=_;try{return q()}finally{E=$}},o.unstable_scheduleCallback=function(_,q,$){var ae=o.unstable_now();switch(typeof $=="object"&&$!==null?($=$.delay,$=typeof $=="number"&&0<$?ae+$:ae):$=ae,_){case 1:var se=-1;break;case 2:se=250;break;case 5:se=1073741823;break;case 4:se=1e4;break;default:se=5e3}return se=$+se,_={id:y++,callback:q,priorityLevel:_,startTime:$,expirationTime:se,sortIndex:-1},$>ae?(_.sortIndex=$,l(b,_),i(g)===null&&_===i(b)&&(z?(X(Y),Y=-1):z=!0,Fe(V,$-ae))):(_.sortIndex=se,l(g,_),M||D||(M=!0,G||(G=!0,me()))),_},o.unstable_shouldYield=de,o.unstable_wrapCallback=function(_){var q=E;return function(){var $=E;E=q;try{return _.apply(this,arguments)}finally{E=$}}}})(Qc)),Qc}var Dh;function z0(){return Dh||(Dh=1,Vc.exports=O0()),Vc.exports}var Zc={exports:{}},ht={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Rh;function M0(){if(Rh)return Ei;Rh=1;var o=z0(),l=cu(),i=cg();function s(e){var t="https://react.dev/errors/"+e;if(1<arguments.length){t+="?args[]="+encodeURIComponent(arguments[1]);for(var n=2;n<arguments.length;n++)t+="&args[]="+encodeURIComponent(arguments[n])}return"Minified React error #"+e+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function u(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function d(e){var t=e,n=e;if(e.alternate)for(;t.return;)t=t.return;else{e=t;do t=e,(t.flags&4098)!==0&&(n=t.return),e=t.return;while(e)}return t.tag===3?n:null}function f(e){if(e.tag===13){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function h(e){if(e.tag===31){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function g(e){if(d(e)!==e)throw Error(s(188))}function b(e){var t=e.alternate;if(!t){if(t=d(e),t===null)throw Error(s(188));return t!==e?null:e}for(var n=e,a=t;;){var r=n.return;if(r===null)break;var c=r.alternate;if(c===null){if(a=r.return,a!==null){n=a;continue}break}if(r.child===c.child){for(c=r.child;c;){if(c===n)return g(r),e;if(c===a)return g(r),t;c=c.sibling}throw Error(s(188))}if(n.return!==a.return)n=r,a=c;else{for(var p=!1,m=r.child;m;){if(m===n){p=!0,n=r,a=c;break}if(m===a){p=!0,a=r,n=c;break}m=m.sibling}if(!p){for(m=c.child;m;){if(m===n){p=!0,n=c,a=r;break}if(m===a){p=!0,a=c,n=r;break}m=m.sibling}if(!p)throw Error(s(189))}}if(n.alternate!==a)throw Error(s(190))}if(n.tag!==3)throw Error(s(188));return n.stateNode.current===n?e:t}function y(e){var t=e.tag;if(t===5||t===26||t===27||t===6)return e;for(e=e.child;e!==null;){if(t=y(e),t!==null)return t;e=e.sibling}return null}var x=Object.assign,E=Symbol.for("react.element"),D=Symbol.for("react.transitional.element"),M=Symbol.for("react.portal"),z=Symbol.for("react.fragment"),Q=Symbol.for("react.strict_mode"),B=Symbol.for("react.profiler"),X=Symbol.for("react.consumer"),K=Symbol.for("react.context"),I=Symbol.for("react.forward_ref"),V=Symbol.for("react.suspense"),G=Symbol.for("react.suspense_list"),Y=Symbol.for("react.memo"),J=Symbol.for("react.lazy"),ee=Symbol.for("react.activity"),de=Symbol.for("react.memo_cache_sentinel"),re=Symbol.iterator;function me(e){return e===null||typeof e!="object"?null:(e=re&&e[re]||e["@@iterator"],typeof e=="function"?e:null)}var Ge=Symbol.for("react.client.reference");function He(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===Ge?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case z:return"Fragment";case B:return"Profiler";case Q:return"StrictMode";case V:return"Suspense";case G:return"SuspenseList";case ee:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case M:return"Portal";case K:return e.displayName||"Context";case X:return(e._context.displayName||"Context")+".Consumer";case I:var t=e.render;return e=e.displayName,e||(e=t.displayName||t.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case Y:return t=e.displayName||null,t!==null?t:He(e.type)||"Memo";case J:t=e._payload,e=e._init;try{return He(e(t))}catch{}}return null}var Fe=Array.isArray,_=l.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,q=i.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,$={pending:!1,data:null,method:null,action:null},ae=[],se=-1;function w(e){return{current:e}}function j(e){0>se||(e.current=ae[se],ae[se]=null,se--)}function Z(e,t){se++,ae[se]=e.current,e.current=t}var F=w(null),le=w(null),te=w(null),be=w(null);function Ue(e,t){switch(Z(te,t),Z(le,e),Z(F,null),t.nodeType){case 9:case 11:e=(e=t.documentElement)&&(e=e.namespaceURI)?Xp(e):0;break;default:if(e=t.tagName,t=t.namespaceURI)t=Xp(t),e=Vp(t,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}j(F),Z(F,e)}function we(){j(F),j(le),j(te)}function ye(e){e.memoizedState!==null&&Z(be,e);var t=F.current,n=Vp(t,e.type);t!==n&&(Z(le,e),Z(F,n))}function un(e){le.current===e&&(j(F),j(le)),be.current===e&&(j(be),xi._currentValue=$)}var yt,xn;function it(e){if(yt===void 0)try{throw Error()}catch(n){var t=n.stack.trim().match(/\n( *(at )?)/);yt=t&&t[1]||"",xn=-1<n.stack.indexOf(`
...
`)}}}fences(l){const i=this.rules.block.fences.exec(l);if(i){const s=i[0],u=V0(s,i[3]||"");return{type:"code",raw:s,lang:i[2]?i[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):i[2],text:u}}}heading(l){const i=this.rules.block.heading.exec(l);if(i){let s=i[2].trim();if(/#$/.test(s)){const u=Di(s,"#");(this.options.pedantic||!u||/ $/.test(u))&&(s=u.trim())}return{type:"heading",raw:i[0],depth:i[1].length,text:s,tokens:this.lexer.inline(s)}}}hr(l){const i=this.rules.block.hr.exec(l);if(i)return{type:"hr",raw:Di(i[0],`
...
${y}`:y,d=d?`${d}
${x}`:x;const E=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(x,f,!0),this.lexer.state.top=E,s.length===0)break;const D=f[f.length-1];if((D==null?void 0:D.type)==="code")break;if((D==null?void 0:D.type)==="blockquote"){const M=D,z=M.raw+`
`+s.join(`
`),Q=this.blockquote(z);f[f.length-1]=Q,u=u.substring(0,u.length-M.raw.length)+Q.raw,d=d.substring(0,d.length-M.text.length)+Q.text;break}else if((D==null?void 0:D.type)==="list"){const M=D,z=M.raw+`
`+s.join(`
`),Q=this.list(z);f[f.length-1]=Q,u=u.substring(0,u.length-D.raw.length)+Q.raw,d=d.substring(0,d.length-M.raw.length)+Q.raw,s=z.substring(f[f.length-1].raw.length).split(`
...
</html>`}function Dv({code:o,prd:l,onInitDesign:i}){const s=N.useRef(null),[u,d]=N.useState("preview"),[f,h]=N.useState("#/"),[g,b]=N.useState("#/"),[y,x]=N.useState(["#/"]),[E,D]=N.useState(0);N.useEffect(()=>{function X(K){var V;if(((V=K.data)==null?void 0:V.type)!=="__route")return;const I=K.data.path||"#/";h(I),b(I),x(G=>{const Y=G.slice(0,E+1);return Y[Y.length-1]===I?Y:[...Y,I]}),D(G=>G+1)}return window.addEventListener("message",X),()=>window.removeEventListener("message",X)},[E]),N.useEffect(()=>{!s.current||!o||(h("#/"),b("#/"),x(["#/"]),D(0),s.current.srcdoc=Ev(o))},[o]);function M(X){var K,I,V,G,Y;(I=(K=s.current)==null?void 0:K.contentWindow)==null||I.postMessage({type:"__navigate",path:X},"*");try{(V=s.current)!=null&&V.contentWindow&&((Y=(G=s.current.contentWindow).__navigate)==null||Y.call(G,X))}catch{}}function z(){if(E<=0)return;const X=y[E-1];D(K=>K-1),h(X),b(X),M(X)}function Q(){if(E>=y.length-1)return;const X=y[E+1];D(K=>K+1),h(X),b(X),M(X)}function B(X){X.preventDefault(),M(g)}return o?v.jsxs("div",{className:"canvas canvas--live",children:[v.jsxs("div",{className:"canvas-toolbar",children:[v.jsxs("div",{className:"canvas-view-tabs",children:[v.jsx("button",{className:`canvas-view-tab ${u==="preview"?"active":""}`,onClick:()=>d("preview"),children:"Preview"}),v.jsx("button",{className:`canvas-view-tab ${u==="code"?"active":""}`,onClick:()=>d("code"),children:"Code"})]}),u==="preview"&&v.jsxs("div",{className:"canvas-urlbar",children:[v.jsx("button",{className:"canvas-nav-btn",onClick:z,disabled:E<=0,title:"Back",children:"←"}),v.jsx("button",{className:"canvas-nav-btn",onClick:Q,disabled:E>=y.length-1,title:"Forward",children:"→"}),v.jsx("form",{className:"canvas-url-form",onSubmit:B,children:v.jsx("input",{className:"canvas-url-input",value:g,onChange:X=>b(X.target.value),spellCheck:!1})})]}),v.jsx("button",{className:"canvas-copy-btn",onClick:()=>navigator.clipboard.writeText(o),children:"copy"})]}),v.jsxs("div",{className:"canvas-body",children:[v.jsx("iframe",{ref:s,className:"canvas-iframe",style:{display:u==="preview"?"block":"none"},title:"design preview",sandbox:"allow-scripts allow-same-origin"}),u==="code"&&v.jsx("pre",{className:"canvas-code",children:v.jsx("code",{children:o})})]})]}):v.jsx("div",{className:"canvas canvas--empty",children:l?v.jsxs(v.Fragment,{children:[v.jsx("div",{className:"canvas-empty-icon",children:"✦"}),v.jsx("p",{className:"canvas-empty-title",children:l.name}),v.jsx("span",{className:"canvas-empty-sub",children:"PRD loaded — ready to generate"}),v.jsx("button",{className:"canvas-init-btn",onClick:i,children:"Init Design"})]}):v.jsxs(v.Fragment,{children:[v.jsx("div",{className:"canvas-empty-icon",children:"◎"}),v.jsx("p",{className:"canvas-empty-title",children:"No PRD loaded"}),v.jsx("span",{className:"canvas-empty-sub",children:"Open a PRD from Projects to start"})]})})}const wg="ennabl_builder_history",Av=50;function kv(){try{return JSON.parse(localStorage.getItem(wg)||"[]")}catch{return[]}}function Lh(o){localStorage.setItem(wg,JSON.stringify(o.slice(0,Av)))}function Rv({prdName:o,code:l,iteration:i}){return{id:`${Date.now()}-${Math.random().toString(36).slice(2,6)}`,timestamp:new Date().toISOString(),prdName:o,code:l,iteration:i}}function Ov(o){const i=`${o.prdName.replace(/\.md$/i,"").replace(/[^a-z0-9]/gi,"-").toLowerCase()}-v${o.iteration}.jsx`,s=`/**
...
`,Vv=`You are an expert UI engineer for ennabl, an insurance analytics platform for insurance agencies and brokers.
...
The generated code runs inside a Vite + React app. The ennabl design system CSS (colors_and_type.css + styles.css) is already loaded globally — you can use all \`--en-*\` variables and \`.en-*\` classes directly without importing them.`,Qv="https://api.anthropic.com/v1/messages";function Zv(o){return o==="claude-opus-4-7"?{max_tokens:8192,thinking:{type:"enabled",budget_tokens:5e3}}:{max_tokens:8192}}async function Kv({messages:o,onText:l,onDone:i}){var y,x,E,D,M,z,Q;const s=Eg(),u=await fetch(Qv,{method:"POST",headers:{"Content-Type":"application/json","x-api-key":Ng(),"anthropic-version":"2023-06-01","anthropic-dangerous-direct-browser-access":"true"},body:JSON.stringify({model:s,...Zv(s),system:[{type:"text",text:Vv,cache_control:{type:"ephemeral"}}],messages:o,stream:!0})});if(!u.ok){const B=await u.json().catch(()=>({}));throw new Error(((y=B.error)==null?void 0:y.message)||`API error ${u.status}`)}const d=u.body.getReader(),f=new TextDecoder;let h=0,g=0,b=0;for(;;){const{done:B,value:X}=await d.read();if(B)break;const K=f.decode(X).split(`
`);for(const I of K){if(!I.startsWith("data: "))continue;const V=I.slice(6).trim();if(!(!V||V==="[DONE]"))try{const G=JSON.parse(V);G.type==="message_start"&&(h=((E=(x=G.message)==null?void 0:x.usage)==null?void 0:E.input_tokens)??0,b=((M=(D=G.message)==null?void 0:D.usage)==null?void 0:M.cache_read_input_tokens)??0),G.type==="content_block_delta"&&((z=G.delta)==null?void 0:z.type)==="text_delta"&&l(G.delta.text),G.type==="message_delta"&&(g=((Q=G.usage)==null?void 0:Q.output_tokens)??0)}catch{}}}i({inputTokens:h,outputTokens:g,cacheReadTokens:b})}const Dg="ennabl_builder_reports",Kc={input:15/1e6,output:75/1e6,cacheRead:1.5/1e6};function Iv({inputTokens:o=0,outputTokens:l=0,cacheReadTokens:i=0}){return Math.max(0,o-i)*Kc.input+i*Kc.cacheRead+l*Kc.output}function Jv(o){return{id:`s_${Date.now()}`,prdName:o,startedAt:new Date().toISOString(),iterations:0,inputTokens:0,outputTokens:0,cacheReadTokens:0,cost:0,componentsUsed:[],rating:null,accepted:!1}}function Ag(){try{return JSON.parse(localStorage.getItem(Dg)||"{}")}catch{return{}}}function $v(o){localStorage.setItem(Dg,JSON.stringify(o))}function nu(o){const l=Ag(),i=o.prdName;l[i]||(l[i]=[]);const s=l[i].findIndex(u=>u.id===o.id);s>=0?l[i][s]=o:l[i].unshift(o),$v(l)}function Ic(o){return Ag()[o]||[]}function Fv(o){return o?["CollapsibleSection","EditableField","TemplatePicker","SaveTemplateDialog","UpdateTemplateDialog","ManageModal","DeleteConfirm","Step3Body","ProducerTable"].filter(i=>o.includes(i)):[]}function Wv(o){if(!o.length)return null;const l=o.filter(i=>i.accepted&&i.iterations<=2).length;return Math.round(l/o.length*100)}const Pv=new Set(["--en-primary","--en-primary-light","--en-primary-dark","--en-action-hover","--en-outlined-hover","--en-fg","--en-fg-secondary","--en-fg-disabled","--en-bg","--en-bg-grey","--en-bg-dark-grey","--en-bg-hover","--en-bg-active","--en-secondary","--en-secondary-dark","--en-border","--en-divider","--en-error","--en-error-dark","--en-success","--en-warning","--en-warning-dark","--en-icon","--en-icon-secondary","--en-sidebar","--en-logo-primary","--en-logo-accent","--en-radius-sm","--en-radius","--en-radius-regular","--en-radius-medium","--en-radius-large","--en-radius-xl","--en-shadow-menu","--en-shadow-tooltip","--en-shadow-card-hover","--en-duration-short","--en-easing","--en-font-sans"]),ey=new Set(["en-h3","en-h4","en-h5","en-body1","en-body1-bold","en-body2","en-body2-bold","en-body3","en-body3-bold","en-subtitle1","en-subtitle2","en-subtitle3","en-overline","en-caption","en-table-header","en-table-text"]),ty=new Set(["IconCheck","IconChevronDown","IconChevronUp","IconClose","IconCopy","IconEdit","IconEditFill","IconExternal","IconGear","IconInfo","IconMore","IconPlus","IconRevert","IconSearch","IconShare","IconStar","IconTrash","IconTrashFill","IconUpload","IconUsers"]);function ny(o){const l=[],i=[...o.matchAll(/var\((--en-[a-z0-9-]+)/g)].map(h=>h[1]);[...new Set(i)].filter(h=>!Pv.has(h)).forEach(h=>l.push({type:"token",msg:`unknown token ${h}`}));const s=[...o.matchAll(/className="([^"]+)"/g)].flatMap(h=>h[1].split(/\s+/)).filter(h=>h.startsWith("en-"));[...new Set(s)].filter(h=>!ey.has(h)).forEach(h=>l.push({type:"class",msg:`unknown class .${h}`}));const u=[...o.matchAll(/<(Icon[A-Z][A-Za-z]*)/g)].map(h=>h[1]);[...new Set(u)].filter(h=>!ty.has(h)).forEach(h=>l.push({type:"icon",msg:`unknown icon <${h} />`}));const d=o.replace(/\/\/.*$/gm,"").replace(/\/\*[\s\S]*?\*\//g,"");return[...new Set([...d.matchAll(/#[0-9A-Fa-f]{6}\b/g)].map(h=>h[0]))].forEach(h=>l.push({type:"color",msg:`raw color ${h} — use --en-* var`})),{ok:l.length===0,issues:l}}function ay(o){const l=o.match(/```(?:jsx?|tsx?|javascript|typescript)?\n([\s\S]*?)```/);return l?l[1].trim():null}function ly({prd:o,messages:l,setMessages:i,onCodeGenerated:s,onSwitchToPrd:u,onIterationComplete:d,initTrigger:f}){const[h,g]=N.useState(""),[b,y]=N.useState(!1),[x,E]=N.useState(Eg),D=N.useRef(null),M=N.useRef(null);N.useEffect(()=>{var B;(B=D.current)==null||B.scrollIntoView({behavior:"smooth"})},[l]),N.useEffect(()=>{f>0&&o&&!b&&l.length===0&&z("Build a complete UI from this PRD.")},[f]);async function z(B){const X=(B??h).trim();if(!X||b)return;const K={role:"user",content:X},I=o?`
...
`,status:"doing",createdAt:new Date(Date.now()-1440*60*1e3).toISOString(),updatedAt:new Date(Date.now()-7200*1e3).toISOString()}];function iu(){try{return JSON.parse(localStorage.getItem(_g)||"[]")}catch{return[]}}function ur(o){localStorage.setItem(_g,JSON.stringify(o))}function Ih(){iu().length===0&&ur(Uy)}function qg(o){return Ug.find(l=>l.id===o)||null}function Ly({prds:o=[],onSelect:l}){const[i,s]=N.useState(""),[u,d]=N.useState([]),[f,h]=N.useState(!1),[g,b]=N.useState(0),y=N.useRef(),x=N.useRef();N.useEffect(()=>{if(!i.trim()){d([]),h(!1);return}const D=i.toLowerCase(),M=o.filter(z=>z.title.toLowerCase().includes(D)).slice(0,8);d(M),h(M.length>0),b(0)},[i,o]),N.useEffect(()=>{function D(M){f&&(M.key==="ArrowDown"&&(M.preventDefault(),b(z=>Math.min(z+1,u.length-1))),M.key==="ArrowUp"&&(M.preventDefault(),b(z=>Math.max(z-1,0))),M.key==="Enter"&&(M.preventDefault(),u[g]&&E(u[g])),M.key==="Escape"&&h(!1))}return window.addEventListener("keydown",D),()=>window.removeEventListener("keydown",D)},[f,u,g]),N.useEffect(()=>{function D(M){var z,Q;!((z=x.current)!=null&&z.contains(M.target))&&!((Q=y.current)!=null&&Q.contains(M.target))&&h(!1)}return document.addEventListener("mousedown",D),()=>document.removeEventListener("mousedown",D)},[]);function E(D){var M;l(D),s(""),h(!1),(M=y.current)==null||M.blur()}return v.jsxs("div",{className:"prd-search",children:[v.jsxs("div",{className:"prd-search-input-wrap",children:[v.jsx("span",{className:"prd-search-icon",children:"⌕"}),v.jsx("input",{ref:y,className:"prd-search-input",type:"text",placeholder:"Search PRDs…",value:i,onChange:D=>s(D.target.value),onFocus:()=>{u.length&&h(!0)}}),i&&v.jsx("button",{className:"prd-search-clear",onClick:()=>{s(""),h(!1)},children:"✕"})]}),f&&v.jsx("div",{ref:x,className:"prd-search-dropdown",children:u.map((D,M)=>{const z=qg(D.projectId);return v.jsxs("button",{className:`prd-search-result ${M===g?"prd-search-result--active":""}`,onMouseEnter:()=>b(M),onClick:()=>E(D),children:[v.jsx("span",{className:"prd-search-result-title",children:D.title}),v.jsxs("span",{className:"prd-search-result-project",children:[z==null?void 0:z.icon," ",z==null?void 0:z.name]})]},D.id)})})]})}function qy({prds:o,onNavigate:l}){return v.jsxs("div",{className:"projects-page",children:[v.jsx("header",{className:"projects-header",children:v.jsxs("div",{className:"projects-logo",children:[v.jsx("span",{className:"projects-logo-name",children:"ennabl"}),v.jsx("span",{className:"projects-logo-suffix",children:"builder"})]})}),v.jsxs("main",{className:"projects-main",children:[v.jsx("h1",{className:"projects-title",children:"Projects"}),v.jsx("div",{className:"projects-grid",children:Ug.map(i=>{const s=o.filter(d=>d.projectId===i.id),u=s.filter(d=>d.status==="doing").length;return v.jsxs("button",{className:"project-card",onClick:()=>l({page:"project",projectId:i.id}),children:[v.jsx("div",{className:"project-card-icon",children:i.icon}),v.jsx("div",{className:"project-card-name",children:i.name}),v.jsx("div",{className:"project-card-meta",children:s.length>0?v.jsxs(v.Fragment,{children:[v.jsxs("span",{className:"project-card-count",children:[s.length," PRD",s.length!==1?"s":""]}),u>0&&v.jsxs("span",{className:"project-card-doing",children:[u," doing"]})]}):v.jsx("span",{className:"project-card-empty",children:"No PRDs yet"})})]},i.id)})})]})]})}var ki=cg();function Hy(){for(var o=arguments.length,l=new Array(o),i=0;i<o;i++)l[i]=arguments[i];return N.useMemo(()=>s=>{l.forEach(u=>u(s))},l)}const Cr=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";function Rl(o){const l=Object.prototype.toString.call(o);return l==="[object Window]"||l==="[object global]"}function wu(o){return"nodeType"in o}function vt(o){var l,i;return o?Rl(o)?o:wu(o)&&(l=(i=o.ownerDocument)==null?void 0:i.defaultView)!=null?l:window:window}function Cu(o){const{Document:l}=vt(o);return o instanceof l}function Hi(o){return Rl(o)?!1:o instanceof vt(o).HTMLElement}function Hg(o){return o instanceof vt(o).SVGElement}function Ol(o){return o?Rl(o)?o.document:wu(o)?Cu(o)?o:Hi(o)||Hg(o)?o.ownerDocument:document:document:document}const on=Cr?N.useLayoutEffect:N.useEffect;function Nr(o){const l=N.useRef(o);return on(()=>{l.current=o}),N.useCallback(function(){for(var i=arguments.length,s=new Array(i),u=0;u<i;u++)s[u]=arguments[u];return l.current==null?void 0:l.current(...s)},[])}function By(){const o=N.useRef(null),l=N.useCallback((s,u)=>{o.current=setInterval(s,u)},[]),i=N.useCallback(()=>{o.current!==null&&(clearInterval(o.current),o.current=null)},[]);return[l,i]}function _i(o,l){l===void 0&&(l=[o]);const i=N.useRef(o);return on(()=>{i.current!==o&&(i.current=o)},l),i}function Bi(o,l){const i=N.useRef();return N.useMemo(()=>{const s=o(i.current);return i.current=s,s},[...l])}function gr(o){const l=Nr(o),i=N.useRef(null),s=N.useCallback(u=>{u!==i.current&&(l==null||l(u,i.current)),i.current=u},[]);return[i,s]}function mr(o){const l=N.useRef();return N.useEffect(()=>{l.current=o},[o]),l.current}let $c={};function Yi(o,l){return N.useMemo(()=>{if(l)return l;const i=$c[o]==null?0:$c[o]+1;return $c[o]=i,o+"-"+i},[o,l])}function Bg(o){return function(l){for(var i=arguments.length,s=new Array(i>1?i-1:0),u=1;u<i;u++)s[u-1]=arguments[u];return s.reduce((d,f)=>{const h=Object.entries(f);for(const[g,b]of h){const y=d[g];y!=null&&(d[g]=y+o*b)}return d},{...l})}}const kl=Bg(1),br=Bg(-1);function Yy(o){return"clientX"in o&&"clientY"in o}function Tr(o){if(!o)return!1;const{KeyboardEvent:l}=vt(o.target);return l&&o instanceof l}function Gy(o){if(!o)return!1;const{TouchEvent:l}=vt(o.target);return l&&o instanceof l}function vr(o){if(Gy(o)){if(o.touches&&o.touches.length){const{clientX:l,clientY:i}=o.touches[0];return{x:l,y:i}}else if(o.changedTouches&&o.changedTouches.length){const{clientX:l,clientY:i}=o.changedTouches[0];return{x:l,y:i}}}return Yy(o)?{x:o.clientX,y:o.clientY}:null}const ba=Object.freeze({Translate:{toString(o){if(!o)return;const{x:l,y:i}=o;return"translate3d("+(l?Math.round(l):0)+"px, "+(i?Math.round(i):0)+"px, 0)"}},Scale:{toString(o){if(!o)return;const{scaleX:l,scaleY:i}=o;return"scaleX("+l+") scaleY("+i+")"}},Transform:{toString(o){if(o)return[ba.Translate.toString(o),ba.Scale.toString(o)].join(" ")}},Transition:{toString(o){let{property:l,duration:i,easing:s}=o;return l+" "+i+"ms "+s}}}),Jh="a,frame,iframe,input:not([type=hidden]):not(:disabled),select:not(:disabled),textarea:not(:disabled),button:not(:disabled),*[tabindex]";function Xy(o){return o.matches(Jh)?o:o.querySelector(Jh)}const Vy={display:"none"};function Qy(o){let{id:l,value:i}=o;return qe.createElement("div",{id:l,style:Vy},i)}function Zy(o){let{id:l,announcement:i,ariaLiveType:s="assertive"}=o;const u={position:"fixed",top:0,left:0,width:1,height:1,margin:-1,border:0,padding:0,overflow:"hidden",clip:"rect(0 0 0 0)",clipPath:"inset(100%)",whiteSpace:"nowrap"};return qe.createElement("div",{id:l,style:u,role:"status","aria-live":s,"aria-atomic":!0},i)}function Ky(){const[o,l]=N.useState("");return{announce:N.useCallback(s=>{s!=null&&l(s)},[]),announcement:o}}const Yg=N.createContext(null);function Iy(o){const l=N.useContext(Yg);N.useEffect(()=>{if(!l)throw new Error("useDndMonitor must be used within a children of <DndContext>");return l(o)},[o,l])}function Jy(){const[o]=N.useState(()=>new Set),l=N.useCallback(s=>(o.add(s),()=>o.delete(s)),[o]);return[N.useCallback(s=>{let{type:u,event:d}=s;o.forEach(f=>{var h;return(h=f[u])==null?void 0:h.call(f,d)})},[o]),l]}const $y={draggable:`
    To pick up a draggable item, press the space bar.
    While dragging, use the arrow keys to move the item.
    Press space again to drop the item in its new position, or press escape to cancel.
  `},Fy={onDragStart(o){let{active:l}=o;return"Picked up draggable item "+l.id+"."},onDragOver(o){let{active:l,over:i}=o;return i?"Draggable item "+l.id+" was moved over droppable area "+i.id+".":"Draggable item "+l.id+" is no longer over a droppable area."},onDragEnd(o){let{active:l,over:i}=o;return i?"Draggable item "+l.id+" was dropped over droppable area "+i.id:"Draggable item "+l.id+" was dropped."},onDragCancel(o){let{active:l}=o;return"Dragging was cancelled. Draggable item "+l.id+" was dropped."}};function Wy(o){let{announcements:l=Fy,container:i,hiddenTextDescribedById:s,screenReaderInstructions:u=$y}=o;const{announce:d,announcement:f}=Ky(),h=Yi("DndLiveRegion"),[g,b]=N.useState(!1);if(N.useEffect(()=>{b(!0)},[]),Iy(N.useMemo(()=>({onDragStart(x){let{active:E}=x;d(l.onDragStart({active:E}))},onDragMove(x){let{active:E,over:D}=x;l.onDragMove&&d(l.onDragMove({active:E,over:D}))},onDragOver(x){let{active:E,over:D}=x;d(l.onDragOver({active:E,over:D}))},onDragEnd(x){let{active:E,over:D}=x;d(l.onDragEnd({active:E,over:D}))},onDragCancel(x){let{active:E,over:D}=x;d(l.onDragCancel({active:E,over:D}))}}),[d,l])),!g)return null;const y=qe.createElement(qe.Fragment,null,qe.createElement(Qy,{id:s,value:u.draggable}),qe.createElement(Zy,{id:h,announcement:f}));return i?ki.createPortal(y,i):y}var et;(function(o){o.DragStart="dragStart",o.DragMove="dragMove",o.DragEnd="dragEnd",o.DragCancel="dragCancel",o.DragOver="dragOver",o.RegisterDroppable="registerDroppable",o.SetDroppableDisabled="setDroppableDisabled",o.UnregisterDroppable="unregisterDroppable"})(et||(et={}));function yr(){}function Py(o,l){return N.useMemo(()=>({sensor:o,options:l??{}}),[o,l])}function e1(){for(var o=arguments.length,l=new Array(o),i=0;i<o;i++)l[i]=arguments[i];return N.useMemo(()=>[...l].filter(s=>s!=null),[...l])}const cn=Object.freeze({x:0,y:0});function t1(o,l){return Math.sqrt(Math.pow(o.x-l.x,2)+Math.pow(o.y-l.y,2))}function n1(o,l){const i=vr(o);if(!i)return"0 0";const s={x:(i.x-l.left)/l.width*100,y:(i.y-l.top)/l.height*100};return s.x+"% "+s.y+"%"}function a1(o,l){let{data:{value:i}}=o,{data:{value:s}}=l;return i-s}function l1(o,l){let{data:{value:i}}=o,{data:{value:s}}=l;return s-i}function $h(o){let{left:l,top:i,height:s,width:u}=o;return[{x:l,y:i},{x:l+u,y:i},{x:l,y:i+s},{x:l+u,y:i+s}]}function i1(o,l){if(!o||o.length===0)return null;const[i]=o;return i[l]}const s1=o=>{let{collisionRect:l,droppableRects:i,droppableContainers:s}=o;const u=$h(l),d=[];for(const f of s){const{id:h}=f,g=i.get(h);if(g){const b=$h(g),y=u.reduce((E,D,M)=>E+t1(b[M],D),0),x=Number((y/4).toFixed(4));d.push({id:h,data:{droppableContainer:f,value:x}})}}return d.sort(a1)};function r1(o,l){const i=Math.max(l.top,o.top),s=Math.max(l.left,o.left),u=Math.min(l.left+l.width,o.left+o.width),d=Math.min(l.top+l.height,o.top+o.height),f=u-s,h=d-i;if(s<u&&i<d){const g=l.width*l.height,b=o.width*o.height,y=f*h,x=y/(g+b-y);return Number(x.toFixed(4))}return 0}const o1=o=>{let{collisionRect:l,droppableRects:i,droppableContainers:s}=o;const u=[];for(const d of s){const{id:f}=d,h=i.get(f);if(h){const g=r1(h,l);g>0&&u.push({id:f,data:{droppableContainer:d,value:g}})}}return u.sort(l1)};function c1(o,l,i){return{...o,scaleX:l&&i?l.width/i.width:1,scaleY:l&&i?l.height/i.height:1}}function Gg(o,l){return o&&l?{x:o.left-l.left,y:o.top-l.top}:cn}function u1(o){return function(i){for(var s=arguments.length,u=new Array(s>1?s-1:0),d=1;d<s;d++)u[d-1]=arguments[d];return u.reduce((f,h)=>({...f,top:f.top+o*h.y,bottom:f.bottom+o*h.y,left:f.left+o*h.x,right:f.right+o*h.x}),{...i})}}const d1=u1(1);function Xg(o){if(o.startsWith("matrix3d(")){const l=o.slice(9,-1).split(/, /);return{x:+l[12],y:+l[13],scaleX:+l[0],scaleY:+l[5]}}else if(o.startsWith("matrix(")){const l=o.slice(7,-1).split(/, /);return{x:+l[4],y:+l[5],scaleX:+l[0],scaleY:+l[3]}}return null}function f1(o,l,i){const s=Xg(l);if(!s)return o;const{scaleX:u,scaleY:d,x:f,y:h}=s,g=o.left-f-(1-u)*parseFloat(i),b=o.top-h-(1-d)*parseFloat(i.slice(i.indexOf(" ")+1)),y=u?o.width/u:o.width,x=d?o.height/d:o.height;return{width:y,height:x,top:b,right:g+y,bottom:b+x,left:g}}const p1={ignoreTransform:!1};function zl(o,l){l===void 0&&(l=p1);let i=o.getBoundingClientRect();if(l.ignoreTransform){const{transform:b,transformOrigin:y}=vt(o).getComputedStyle(o);b&&(i=f1(i,b,y))}const{top:s,left:u,width:d,height:f,bottom:h,right:g}=i;return{top:s,left:u,width:d,height:f,bottom:h,right:g}}function Fh(o){return zl(o,{ignoreTransform:!0})}function h1(o){const l=o.innerWidth,i=o.innerHeight;return{top:0,left:0,right:l,bottom:i,width:l,height:i}}function g1(o,l){return l===void 0&&(l=vt(o).getComputedStyle(o)),l.position==="fixed"}function m1(o,l){l===void 0&&(l=vt(o).getComputedStyle(o));const i=/(auto|scroll|overlay)/;return["overflow","overflowX","overflowY"].some(u=>{const d=l[u];return typeof d=="string"?i.test(d):!1})}function Nu(o,l){const i=[];function s(u){if(l!=null&&i.length>=l||!u)return i;if(Cu(u)&&u.scrollingElement!=null&&!i.includes(u.scrollingElement))return i.push(u.scrollingElement),i;if(!Hi(u)||Hg(u)||i.includes(u))return i;const d=vt(o).getComputedStyle(u);return u!==o&&m1(u,d)&&i.push(u),g1(u,d)?i:s(u.parentNode)}return o?s(o):i}function Vg(o){const[l]=Nu(o,1);return l??null}function Fc(o){return!Cr||!o?null:Rl(o)?o:wu(o)?Cu(o)||o===Ol(o).scrollingElement?window:Hi(o)?o:null:null}function Qg(o){return Rl(o)?o.scrollX:o.scrollLeft}function Zg(o){return Rl(o)?o.scrollY:o.scrollTop}function su(o){return{x:Qg(o),y:Zg(o)}}var lt;(function(o){o[o.Forward=1]="Forward",o[o.Backward=-1]="Backward"})(lt||(lt={}));function Kg(o){return!Cr||!o?!1:o===document.scrollingElement}function Ig(o){const l={x:0,y:0},i=Kg(o)?{height:window.innerHeight,width:window.innerWidth}:{height:o.clientHeight,width:o.clientWidth},s={x:o.scrollWidth-i.width,y:o.scrollHeight-i.height},u=o.scrollTop<=l.y,d=o.scrollLeft<=l.x,f=o.scrollTop>=s.y,h=o.scrollLeft>=s.x;return{isTop:u,isLeft:d,isBottom:f,isRight:h,maxScroll:s,minScroll:l}}const b1={x:.2,y:.2};function v1(o,l,i,s,u){let{top:d,left:f,right:h,bottom:g}=i;s===void 0&&(s=10),u===void 0&&(u=b1);const{isTop:b,isBottom:y,isLeft:x,isRight:E}=Ig(o),D={x:0,y:0},M={x:0,y:0},z={height:l.height*u.y,width:l.width*u.x};return!b&&d<=l.top+z.height?(D.y=lt.Backward,M.y=s*Math.abs((l.top+z.height-d)/z.height)):!y&&g>=l.bottom-z.height&&(D.y=lt.Forward,M.y=s*Math.abs((l.bottom-z.height-g)/z.height)),!E&&h>=l.right-z.width?(D.x=lt.Forward,M.x=s*Math.abs((l.right-z.width-h)/z.width)):!x&&f<=l.left+z.width&&(D.x=lt.Backward,M.x=s*Math.abs((l.left+z.width-f)/z.width)),{direction:D,speed:M}}function y1(o){if(o===document.scrollingElement){const{innerWidth:d,innerHeight:f}=window;return{top:0,left:0,right:d,bottom:f,width:d,height:f}}const{top:l,left:i,right:s,bottom:u}=o.getBoundingClientRect();return{top:l,left:i,right:s,bottom:u,width:o.clientWidth,height:o.clientHeight}}function Jg(o){return o.reduce((l,i)=>kl(l,su(i)),cn)}function x1(o){return o.reduce((l,i)=>l+Qg(i),0)}function S1(o){return o.reduce((l,i)=>l+Zg(i),0)}function $g(o,l){if(l===void 0&&(l=zl),!o)return;const{top:i,left:s,bottom:u,right:d}=l(o);Vg(o)&&(u<=0||d<=0||i>=window.innerHeight||s>=window.innerWidth)&&o.scrollIntoView({block:"center",inline:"center"})}const w1=[["x",["left","right"],x1],["y",["top","bottom"],S1]];class Tu{constructor(l,i){this.rect=void 0,this.width=void 0,this.height=void 0,this.top=void 0,this.bottom=void 0,this.right=void 0,this.left=void 0;const s=Nu(i),u=Jg(s);this.rect={...l},this.width=l.width,this.height=l.height;for(const[d,f,h]of w1)for(const g of f)Object.defineProperty(this,g,{get:()=>{const b=h(s),y=u[d]-b;return this.rect[g]+y},enumerable:!0});Object.defineProperty(this,"rect",{enumerable:!1})}}class zi{constructor(l){this.target=void 0,this.listeners=[],this.removeAll=()=>{this.listeners.forEach(i=>{var s;return(s=this.target)==null?void 0:s.removeEventListener(...i)})},this.target=l}add(l,i,s){var u;(u=this.target)==null||u.addEventListener(l,i,s),this.listeners.push([l,i,s])}}function C1(o){const{EventTarget:l}=vt(o);return o instanceof l?o:Ol(o)}function Wc(o,l){const i=Math.abs(o.x),s=Math.abs(o.y);return typeof l=="number"?Math.sqrt(i**2+s**2)>l:"x"in l&&"y"in l?i>l.x&&s>l.y:"x"in l?i>l.x:"y"in l?s>l.y:!1}var en;(function(o){o.Click="click",o.DragStart="dragstart",o.Keydown="keydown",o.ContextMenu="contextmenu",o.Resize="resize",o.SelectionChange="selectionchange",o.VisibilityChange="visibilitychange"})(en||(en={}));function Wh(o){o.preventDefault()}function N1(o){o.stopPropagation()}var Ne;(function(o){o.Space="Space",o.Down="ArrowDown",o.Right="ArrowRight",o.Left="ArrowLeft",o.Up="ArrowUp",o.Esc="Escape",o.Enter="Enter",o.Tab="Tab"})(Ne||(Ne={}));const Fg={start:[Ne.Space,Ne.Enter],cancel:[Ne.Esc],end:[Ne.Space,Ne.Enter,Ne.Tab]},T1=(o,l)=>{let{currentCoordinates:i}=l;switch(o.code){case Ne.Right:return{...i,x:i.x+25};case Ne.Left:return{...i,x:i.x-25};case Ne.Down:return{...i,y:i.y+25};case Ne.Up:return{...i,y:i.y-25}}};class Wg{constructor(l){this.props=void 0,this.autoScrollEnabled=!1,this.referenceCoordinates=void 0,this.listeners=void 0,this.windowListeners=void 0,this.props=l;const{event:{target:i}}=l;this.props=l,this.listeners=new zi(Ol(i)),this.windowListeners=new zi(vt(i)),this.handleKeyDown=this.handleKeyDown.bind(this),this.handleCancel=this.handleCancel.bind(this),this.attach()}attach(){this.handleStart(),this.windowListeners.add(en.Resize,this.handleCancel),this.windowListeners.add(en.VisibilityChange,this.handleCancel),setTimeout(()=>this.listeners.add(en.Keydown,this.handleKeyDown))}handleStart(){const{activeNode:l,onStart:i}=this.props,s=l.node.current;s&&$g(s),i(cn)}handleKeyDown(l){if(Tr(l)){const{active:i,context:s,options:u}=this.props,{keyboardCodes:d=Fg,coordinateGetter:f=T1,scrollBehavior:h="smooth"}=u,{code:g}=l;if(d.end.includes(g)){this.handleEnd(l);return}if(d.cancel.includes(g)){this.handleCancel(l);return}const{collisionRect:b}=s.current,y=b?{x:b.left,y:b.top}:cn;this.referenceCoordinates||(this.referenceCoordinates=y);const x=f(l,{active:i,context:s.current,currentCoordinates:y});if(x){const E=br(x,y),D={x:0,y:0},{scrollableAncestors:M}=s.current;for(const z of M){const Q=l.code,{isTop:B,isRight:X,isLeft:K,isBottom:I,maxScroll:V,minScroll:G}=Ig(z),Y=y1(z),J={x:Math.min(Q===Ne.Right?Y.right-Y.width/2:Y.right,Math.max(Q===Ne.Right?Y.left:Y.left+Y.width/2,x.x)),y:Math.min(Q===Ne.Down?Y.bottom-Y.height/2:Y.bottom,Math.max(Q===Ne.Down?Y.top:Y.top+Y.height/2,x.y))},ee=Q===Ne.Right&&!X||Q===Ne.Left&&!K,de=Q===Ne.Down&&!I||Q===Ne.Up&&!B;if(ee&&J.x!==x.x){const re=z.scrollLeft+E.x,me=Q===Ne.Right&&re<=V.x||Q===Ne.Left&&re>=G.x;if(me&&!E.y){z.scrollTo({left:re,behavior:h});return}me?D.x=z.scrollLeft-re:D.x=Q===Ne.Right?z.scrollLeft-V.x:z.scrollLeft-G.x,D.x&&z.scrollBy({left:-D.x,behavior:h});break}else if(de&&J.y!==x.y){const re=z.scrollTop+E.y,me=Q===Ne.Down&&re<=V.y||Q===Ne.Up&&re>=G.y;if(me&&!E.x){z.scrollTo({top:re,behavior:h});return}me?D.y=z.scrollTop-re:D.y=Q===Ne.Down?z.scrollTop-V.y:z.scrollTop-G.y,D.y&&z.scrollBy({top:-D.y,behavior:h});break}}this.handleMove(l,kl(br(x,this.referenceCoordinates),D))}}}handleMove(l,i){const{onMove:s}=this.props;l.preventDefault(),s(i)}handleEnd(l){const{onEnd:i}=this.props;l.preventDefault(),this.detach(),i()}handleCancel(l){const{onCancel:i}=this.props;l.preventDefault(),this.detach(),i()}detach(){this.listeners.removeAll(),this.windowListeners.removeAll()}}Wg.activators=[{eventName:"onKeyDown",handler:(o,l,i)=>{let{keyboardCodes:s=Fg,onActivation:u}=l,{active:d}=i;const{code:f}=o.nativeEvent;if(s.start.includes(f)){const h=d.activatorNode.current;return h&&o.target!==h?!1:(o.preventDefault(),u==null||u({event:o.nativeEvent}),!0)}return!1}}];function Ph(o){return!!(o&&"distance"in o)}function eg(o){return!!(o&&"delay"in o)}class Eu{constructor(l,i,s){var u;s===void 0&&(s=C1(l.event.target)),this.props=void 0,this.events=void 0,this.autoScrollEnabled=!0,this.document=void 0,this.activated=!1,this.initialCoordinates=void 0,this.timeoutId=null,this.listeners=void 0,this.documentListeners=void 0,this.windowListeners=void 0,this.props=l,this.events=i;const{event:d}=l,{target:f}=d;this.props=l,this.events=i,this.document=Ol(f),this.documentListeners=new zi(this.document),this.listeners=new zi(s),this.windowListeners=new zi(vt(f)),this.initialCoordinates=(u=vr(d))!=null?u:cn,this.handleStart=this.handleStart.bind(this),this.handleMove=this.handleMove.bind(this),this.handleEnd=this.handleEnd.bind(this),this.handleCancel=this.handleCancel.bind(this),this.handleKeydown=this.handleKeydown.bind(this),this.removeTextSelection=this.removeTextSelection.bind(this),this.attach()}attach(){const{events:l,props:{options:{activationConstraint:i,bypassActivationConstraint:s}}}=this;if(this.listeners.add(l.move.name,this.handleMove,{passive:!1}),this.listeners.add(l.end.name,this.handleEnd),l.cancel&&this.listeners.add(l.cancel.name,this.handleCancel),this.windowListeners.add(en.Resize,this.handleCancel),this.windowListeners.add(en.DragStart,Wh),this.windowListeners.add(en.VisibilityChange,this.handleCancel),this.windowListeners.add(en.ContextMenu,Wh),this.documentListeners.add(en.Keydown,this.handleKeydown),i){if(s!=null&&s({event:this.props.event,activeNode:this.props.activeNode,options:this.props.options}))return this.handleStart();if(eg(i)){this.timeoutId=setTimeout(this.handleStart,i.delay),this.handlePending(i);return}if(Ph(i)){this.handlePending(i);return}}this.handleStart()}detach(){this.listeners.removeAll(),this.windowListeners.removeAll(),setTimeout(this.documentListeners.removeAll,50),this.timeoutId!==null&&(clearTimeout(this.timeoutId),this.timeoutId=null)}handlePending(l,i){const{active:s,onPending:u}=this.props;u(s,l,this.initialCoordinates,i)}handleStart(){const{initialCoordinates:l}=this,{onStart:i}=this.props;l&&(this.activated=!0,this.documentListeners.add(en.Click,N1,{capture:!0}),this.removeTextSelection(),this.documentListeners.add(en.SelectionChange,this.removeTextSelection),i(l))}handleMove(l){var i;const{activated:s,initialCoordinates:u,props:d}=this,{onMove:f,options:{activationConstraint:h}}=d;if(!u)return;const g=(i=vr(l))!=null?i:cn,b=br(u,g);if(!s&&h){if(Ph(h)){if(h.tolerance!=null&&Wc(b,h.tolerance))return this.handleCancel();if(Wc(b,h.distance))return this.handleStart()}if(eg(h)&&Wc(b,h.tolerance))return this.handleCancel();this.handlePending(h,b);return}l.cancelable&&l.preventDefault(),f(g)}handleEnd(){const{onAbort:l,onEnd:i}=this.props;this.detach(),this.activated||l(this.props.active),i()}handleCancel(){const{onAbort:l,onCancel:i}=this.props;this.detach(),this.activated||l(this.props.active),i()}handleKeydown(l){l.code===Ne.Esc&&this.handleCancel()}removeTextSelection(){var l;(l=this.document.getSelection())==null||l.removeAllRanges()}}const E1={cancel:{name:"pointercancel"},move:{name:"pointermove"},end:{name:"pointerup"}};class Du extends Eu{constructor(l){const{event:i}=l,s=Ol(i.target);super(l,E1,s)}}Du.activators=[{eventName:"onPointerDown",handler:(o,l)=>{let{nativeEvent:i}=o,{onActivation:s}=l;return!i.isPrimary||i.button!==0?!1:(s==null||s({event:i}),!0)}}];const D1={move:{name:"mousemove"},end:{name:"mouseup"}};var ru;(function(o){o[o.RightClick=2]="RightClick"})(ru||(ru={}));class A1 extends Eu{constructor(l){super(l,D1,Ol(l.event.target))}}A1.activators=[{eventName:"onMouseDown",handler:(o,l)=>{let{nativeEvent:i}=o,{onActivation:s}=l;return i.button===ru.RightClick?!1:(s==null||s({event:i}),!0)}}];const Pc={cancel:{name:"touchcancel"},move:{name:"touchmove"},end:{name:"touchend"}};class k1 extends Eu{constructor(l){super(l,Pc)}static setup(){return window.addEventListener(Pc.move.name,l,{capture:!1,passive:!1}),function(){window.removeEventListener(Pc.move.name,l)};function l(){}}}k1.activators=[{eventName:"onTouchStart",handler:(o,l)=>{let{nativeEvent:i}=o,{onActivation:s}=l;const{touches:u}=i;return u.length>1?!1:(s==null||s({event:i}),!0)}}];var ji;(function(o){o[o.Pointer=0]="Pointer",o[o.DraggableRect=1]="DraggableRect"})(ji||(ji={}));var xr;(function(o){o[o.TreeOrder=0]="TreeOrder",o[o.ReversedTreeOrder=1]="ReversedTreeOrder"})(xr||(xr={}));function R1(o){let{acceleration:l,activator:i=ji.Pointer,canScroll:s,draggingRect:u,enabled:d,interval:f=5,order:h=xr.TreeOrder,pointerCoordinates:g,scrollableAncestors:b,scrollableAncestorRects:y,delta:x,threshold:E}=o;const D=z1({delta:x,disabled:!d}),[M,z]=By(),Q=N.useRef({x:0,y:0}),B=N.useRef({x:0,y:0}),X=N.useMemo(()=>{switch(i){case ji.Pointer:return g?{top:g.y,bottom:g.y,left:g.x,right:g.x}:null;case ji.DraggableRect:return u}},[i,u,g]),K=N.useRef(null),I=N.useCallback(()=>{const G=K.current;if(!G)return;const Y=Q.current.x*B.current.x,J=Q.current.y*B.current.y;G.scrollBy(Y,J)},[]),V=N.useMemo(()=>h===xr.TreeOrder?[...b].reverse():b,[h,b]);N.useEffect(()=>{if(!d||!b.length||!X){z();return}for(const G of V){if((s==null?void 0:s(G))===!1)continue;const Y=b.indexOf(G),J=y[Y];if(!J)continue;const{direction:ee,speed:de}=v1(G,J,X,l,E);for(const re of["x","y"])D[re][ee[re]]||(de[re]=0,ee[re]=0);if(de.x>0||de.y>0){z(),K.current=G,M(I,f),Q.current=de,B.current=ee;return}}Q.current={x:0,y:0},B.current={x:0,y:0},z()},[l,I,s,z,d,f,JSON.stringify(X),JSON.stringify(D),M,b,V,y,JSON.stringify(E)])}const O1={x:{[lt.Backward]:!1,[lt.Forward]:!1},y:{[lt.Backward]:!1,[lt.Forward]:!1}};function z1(o){let{delta:l,disabled:i}=o;const s=mr(l);return Bi(u=>{if(i||!s||!u)return O1;const d={x:Math.sign(l.x-s.x),y:Math.sign(l.y-s.y)};return{x:{[lt.Backward]:u.x[lt.Backward]||d.x===-1,[lt.Forward]:u.x[lt.Forward]||d.x===1},y:{[lt.Backward]:u.y[lt.Backward]||d.y===-1,[lt.Forward]:u.y[lt.Forward]||d.y===1}}},[i,l,s])}function j1(o,l){const i=l!=null?o.get(l):void 0,s=i?i.node.current:null;return Bi(u=>{var d;return l==null?null:(d=s??u)!=null?d:null},[s,l])}function M1(o,l){return N.useMemo(()=>o.reduce((i,s)=>{const{sensor:u}=s,d=u.activators.map(f=>({eventName:f.eventName,handler:l(f.handler,s)}));return[...i,...d]},[]),[o,l])}var Ui;(function(o){o[o.Always=0]="Always",o[o.BeforeDragging=1]="BeforeDragging",o[o.WhileDragging=2]="WhileDragging"})(Ui||(Ui={}));var ou;(function(o){o.Optimized="optimized"})(ou||(ou={}));const tg=new Map;function _1(o,l){let{dragging:i,dependencies:s,config:u}=l;const[d,f]=N.useState(null),{frequency:h,measure:g,strategy:b}=u,y=N.useRef(o),x=Q(),E=_i(x),D=N.useCallback(function(B){B===void 0&&(B=[]),!E.current&&f(X=>X===null?B:X.concat(B.filter(K=>!X.includes(K))))},[E]),M=N.useRef(null),z=Bi(B=>{if(x&&!i)return tg;if(!B||B===tg||y.current!==o||d!=null){const X=new Map;for(let K of o){if(!K)continue;if(d&&d.length>0&&!d.includes(K.id)&&K.rect.current){X.set(K.id,K.rect.current);continue}const I=K.node.current,V=I?new Tu(g(I),I):null;K.rect.current=V,V&&X.set(K.id,V)}return X}return B},[o,d,i,x,g]);return N.useEffect(()=>{y.current=o},[o]),N.useEffect(()=>{x||D()},[i,x]),N.useEffect(()=>{d&&d.length>0&&f(null)},[JSON.stringify(d)]),N.useEffect(()=>{x||typeof h!="number"||M.current!==null||(M.current=setTimeout(()=>{D(),M.current=null},h))},[h,x,D,...s]),{droppableRects:z,measureDroppableContainers:D,measuringScheduled:d!=null};function Q(){switch(b){case Ui.Always:return!1;case Ui.BeforeDragging:return i;default:return!i}}}function Au(o,l){return Bi(i=>o?i||(typeof l=="function"?l(o):o):null,[l,o])}function U1(o,l){return Au(o,l)}function L1(o){let{callback:l,disabled:i}=o;const s=Nr(l),u=N.useMemo(()=>{if(i||typeof window>"u"||typeof window.MutationObserver>"u")return;const{MutationObserver:d}=window;return new d(s)},[s,i]);return N.useEffect(()=>()=>u==null?void 0:u.disconnect(),[u]),u}function Er(o){let{callback:l,disabled:i}=o;const s=Nr(l),u=N.useMemo(()=>{if(i||typeof window>"u"||typeof window.ResizeObserver>"u")return;const{ResizeObserver:d}=window;return new d(s)},[i]);return N.useEffect(()=>()=>u==null?void 0:u.disconnect(),[u]),u}function q1(o){return new Tu(zl(o),o)}function ng(o,l,i){l===void 0&&(l=q1);const[s,u]=N.useState(null);function d(){u(g=>{if(!o)return null;if(o.isConnected===!1){var b;return(b=g??i)!=null?b:null}const y=l(o);return JSON.stringify(g)===JSON.stringify(y)?g:y})}const f=L1({callback(g){if(o)for(const b of g){const{type:y,target:x}=b;if(y==="childList"&&x instanceof HTMLElement&&x.contains(o)){d();break}}}}),h=Er({callback:d});return on(()=>{d(),o?(h==null||h.observe(o),f==null||f.observe(document.body,{childList:!0,subtree:!0})):(h==null||h.disconnect(),f==null||f.disconnect())},[o]),s}function H1(o){const l=Au(o);return Gg(o,l)}const ag=[];function B1(o){const l=N.useRef(o),i=Bi(s=>o?s&&s!==ag&&o&&l.current&&o.parentNode===l.current.parentNode?s:Nu(o):ag,[o]);return N.useEffect(()=>{l.current=o},[o]),i}function Y1(o){const[l,i]=N.useState(null),s=N.useRef(o),u=N.useCallback(d=>{const f=Fc(d.target);f&&i(h=>h?(h.set(f,su(f)),new Map(h)):null)},[]);return N.useEffect(()=>{const d=s.current;if(o!==d){f(d);const h=o.map(g=>{const b=Fc(g);return b?(b.addEventListener("scroll",u,{passive:!0}),[b,su(b)]):null}).filter(g=>g!=null);i(h.length?new Map(h):null),s.current=o}return()=>{f(o),f(d)};function f(h){h.forEach(g=>{const b=Fc(g);b==null||b.removeEventListener("scroll",u)})}},[u,o]),N.useMemo(()=>o.length?l?Array.from(l.values()).reduce((d,f)=>kl(d,f),cn):Jg(o):cn,[o,l])}function lg(o,l){l===void 0&&(l=[]);const i=N.useRef(null);return N.useEffect(()=>{i.current=null},l),N.useEffect(()=>{const s=o!==cn;s&&!i.current&&(i.current=o),!s&&i.current&&(i.current=null)},[o]),i.current?br(o,i.current):cn}function G1(o){N.useEffect(()=>{if(!Cr)return;const l=o.map(i=>{let{sensor:s}=i;return s.setup==null?void 0:s.setup()});return()=>{for(const i of l)i==null||i()}},o.map(l=>{let{sensor:i}=l;return i}))}function X1(o,l){return N.useMemo(()=>o.reduce((i,s)=>{let{eventName:u,handler:d}=s;return i[u]=f=>{d(f,l)},i},{}),[o,l])}function Pg(o){return N.useMemo(()=>o?h1(o):null,[o])}const ig=[];function V1(o,l){l===void 0&&(l=zl);const[i]=o,s=Pg(i?vt(i):null),[u,d]=N.useState(ig);function f(){d(()=>o.length?o.map(g=>Kg(g)?s:new Tu(l(g),g)):ig)}const h=Er({callback:f});return on(()=>{h==null||h.disconnect(),f(),o.forEach(g=>h==null?void 0:h.observe(g))},[o]),u}function em(o){if(!o)return null;if(o.children.length>1)return o;const l=o.children[0];return Hi(l)?l:o}function Q1(o){let{measure:l}=o;const[i,s]=N.useState(null),u=N.useCallback(b=>{for(const{target:y}of b)if(Hi(y)){s(x=>{const E=l(y);return x?{...x,width:E.width,height:E.height}:E});break}},[l]),d=Er({callback:u}),f=N.useCallback(b=>{const y=em(b);d==null||d.disconnect(),y&&(d==null||d.observe(y)),s(y?l(y):null)},[l,d]),[h,g]=gr(f);return N.useMemo(()=>({nodeRef:h,rect:i,setRef:g}),[i,h,g])}const Z1=[{sensor:Du,options:{}},{sensor:Wg,options:{}}],K1={current:{}},dr={draggable:{measure:Fh},droppable:{measure:Fh,strategy:Ui.WhileDragging,frequency:ou.Optimized},dragOverlay:{measure:zl}};class Mi extends Map{get(l){var i;return l!=null&&(i=super.get(l))!=null?i:void 0}toArray(){return Array.from(this.values())}getEnabled(){return this.toArray().filter(l=>{let{disabled:i}=l;return!i})}getNodeFor(l){var i,s;return(i=(s=this.get(l))==null?void 0:s.node.current)!=null?i:void 0}}const I1={activatorEvent:null,active:null,activeNode:null,activeNodeRect:null,collisions:null,containerNodeRect:null,draggableNodes:new Map,droppableRects:new Map,droppableContainers:new Mi,over:null,dragOverlay:{nodeRef:{current:null},rect:null,setRef:yr},scrollableAncestors:[],scrollableAncestorRects:[],measuringConfiguration:dr,measureDroppableContainers:yr,windowRect:null,measuringScheduled:!1},tm={activatorEvent:null,activators:[],active:null,activeNodeRect:null,ariaDescribedById:{draggable:""},dispatch:yr,draggableNodes:new Map,over:null,measureDroppableContainers:yr},Gi=N.createContext(tm),nm=N.createContext(I1);function J1(){return{draggable:{active:null,initialCoordinates:{x:0,y:0},nodes:new Map,translate:{x:0,y:0}},droppable:{containers:new Mi}}}function $1(o,l){switch(l.type){case et.DragStart:return{...o,draggable:{...o.draggable,initialCoordinates:l.initialCoordinates,active:l.active}};case et.DragMove:return o.draggable.active==null?o:{...o,draggable:{...o.draggable,translate:{x:l.coordinates.x-o.draggable.initialCoordinates.x,y:l.coordinates.y-o.draggable.initialCoordinates.y}}};case et.DragEnd:case et.DragCancel:return{...o,draggable:{...o.draggable,active:null,initialCoordinates:{x:0,y:0},translate:{x:0,y:0}}};case et.RegisterDroppable:{const{element:i}=l,{id:s}=i,u=new Mi(o.droppable.containers);return u.set(s,i),{...o,droppable:{...o.droppable,containers:u}}}case et.SetDroppableDisabled:{const{id:i,key:s,disabled:u}=l,d=o.droppable.containers.get(i);if(!d||s!==d.key)return o;const f=new Mi(o.droppable.containers);return f.set(i,{...d,disabled:u}),{...o,droppable:{...o.droppable,containers:f}}}case et.UnregisterDroppable:{const{id:i,key:s}=l,u=o.droppable.containers.get(i);if(!u||s!==u.key)return o;const d=new Mi(o.droppable.containers);return d.delete(i),{...o,droppable:{...o.droppable,containers:d}}}default:return o}}function F1(o){let{disabled:l}=o;const{active:i,activatorEvent:s,draggableNodes:u}=N.useContext(Gi),d=mr(s),f=mr(i==null?void 0:i.id);return N.useEffect(()=>{if(!l&&!s&&d&&f!=null){if(!Tr(d)||document.activeElement===d.target)return;const h=u.get(f);if(!h)return;const{activatorNode:g,node:b}=h;if(!g.current&&!b.current)return;requestAnimationFrame(()=>{for(const y of[g.current,b.current]){if(!y)continue;const x=Xy(y);if(x){x.focus();break}}})}},[s,l,u,f,d]),null}function am(o,l){let{transform:i,...s}=l;return o!=null&&o.length?o.reduce((u,d)=>d({transform:u,...s}),i):i}function W1(o){return N.useMemo(()=>({draggable:{...dr.draggable,...o==null?void 0:o.draggable},droppable:{...dr.droppable,...o==null?void 0:o.droppable},dragOverlay:{...dr.dragOverlay,...o==null?void 0:o.dragOverlay}}),[o==null?void 0:o.draggable,o==null?void 0:o.droppable,o==null?void 0:o.dragOverlay])}function P1(o){let{activeNode:l,measure:i,initialRect:s,config:u=!0}=o;const d=N.useRef(!1),{x:f,y:h}=typeof u=="boolean"?{x:u,y:u}:u;on(()=>{if(!f&&!h||!l){d.current=!1;return}if(d.current||!s)return;const b=l==null?void 0:l.node.current;if(!b||b.isConnected===!1)return;const y=i(b),x=Gg(y,s);if(f||(x.x=0),h||(x.y=0),d.current=!0,Math.abs(x.x)>0||Math.abs(x.y)>0){const E=Vg(b);E&&E.scrollBy({top:x.y,left:x.x})}},[l,f,h,s,i])}const Dr=N.createContext({...cn,scaleX:1,scaleY:1});var ma;(function(o){o[o.Uninitialized=0]="Uninitialized",o[o.Initializing=1]="Initializing",o[o.Initialized=2]="Initialized"})(ma||(ma={}));const ex=N.memo(function(l){var i,s,u,d;let{id:f,accessibility:h,autoScroll:g=!0,children:b,sensors:y=Z1,collisionDetection:x=o1,measuring:E,modifiers:D,...M}=l;const z=N.useReducer($1,void 0,J1),[Q,B]=z,[X,K]=Jy(),[I,V]=N.useState(ma.Uninitialized),G=I===ma.Initialized,{draggable:{active:Y,nodes:J,translate:ee},droppable:{containers:de}}=Q,re=Y!=null?J.get(Y):null,me=N.useRef({initial:null,translated:null}),Ge=N.useMemo(()=>{var Xe;return Y!=null?{id:Y,data:(Xe=re==null?void 0:re.data)!=null?Xe:K1,rect:me}:null},[Y,re]),He=N.useRef(null),[Fe,_]=N.useState(null),[q,$]=N.useState(null),ae=_i(M,Object.values(M)),se=Yi("DndDescribedBy",f),w=N.useMemo(()=>de.getEnabled(),[de]),j=W1(E),{droppableRects:Z,measureDroppableContainers:F,measuringScheduled:le}=_1(w,{dragging:G,dependencies:[ee.x,ee.y],config:j.droppable}),te=j1(J,Y),be=N.useMemo(()=>q?vr(q):null,[q]),Ue=Ga(),we=U1(te,j.draggable.measure);P1({activeNode:Y!=null?J.get(Y):null,config:Ue.layoutShiftCompensation,initialRect:we,measure:j.draggable.measure});const ye=ng(te,j.draggable.measure,we),un=ng(te?te.parentElement:null),yt=N.useRef({activatorEvent:null,active:null,activeNode:te,collisionRect:null,collisions:null,droppableRects:Z,draggableNodes:J,draggingNode:null,draggingNodeRect:null,droppableContainers:de,over:null,scrollableAncestors:[],scrollAdjustedTranslate:null}),xn=de.getNodeFor((i=yt.current.over)==null?void 0:i.id),it=Q1({measure:j.dragOverlay.measure}),dn=(s=it.nodeRef.current)!=null?s:te,fn=G?(u=it.rect)!=null?u:ye:null,Xi=!!(it.nodeRef.current&&it.rect),jl=H1(Xi?null:ye),va=Pg(dn?vt(dn):null),Ht=B1(G?xn??te:null),Vn=V1(Ht),Ba=am(D,{transform:{x:ee.x-jl.x,y:ee.y-jl.y,scaleX:1,scaleY:1},activatorEvent:q,active:Ge,activeNodeRect:ye,containerNodeRect:un,draggingNodeRect:fn,over:yt.current.over,overlayNodeRect:it.rect,scrollableAncestors:Ht,scrollableAncestorRects:Vn,windowRect:va}),Vi=be?kl(be,ee):null,dt=Y1(Ht),Ar=lg(dt),Qi=lg(dt,[ye]),Sn=kl(Ba,Ar),tn=fn?d1(fn,Ba):null,ya=Ge&&tn?x({active:Ge,collisionRect:tn,droppableRects:Z,droppableContainers:w,pointerCoordinates:Vi}):null,Ml=i1(ya,"id"),[pn,Zi]=N.useState(null),xa=Xi?Ba:kl(Ba,Qi),gt=c1(xa,(d=pn==null?void 0:pn.rect)!=null?d:null,ye),Bt=N.useRef(null),ft=N.useCallback((Xe,Ve)=>{let{sensor:tt,options:xt}=Ve;if(He.current==null)return;const St=J.get(He.current);if(!St)return;const pt=Xe.nativeEvent,wt=new tt({active:He.current,activeNode:St,event:pt,options:xt,context:yt,onAbort(We){if(!J.get(We))return;const{onDragAbort:Rt}=ae.current,Gt={id:We};Rt==null||Rt(Gt),X({type:"onDragAbort",event:Gt})},onPending(We,nn,Rt,Gt){if(!J.get(We))return;const{onDragPending:Cn}=ae.current,an={id:We,constraint:nn,initialCoordinates:Rt,offset:Gt};Cn==null||Cn(an),X({type:"onDragPending",event:an})},onStart(We){const nn=He.current;if(nn==null)return;const Rt=J.get(nn);if(!Rt)return;const{onDragStart:Gt}=ae.current,wn={activatorEvent:pt,active:{id:nn,data:Rt.data,rect:me}};ki.unstable_batchedUpdates(()=>{Gt==null||Gt(wn),V(ma.Initializing),B({type:et.DragStart,initialCoordinates:We,active:nn}),X({type:"onDragStart",event:wn}),_(Bt.current),$(pt)})},onMove(We){B({type:et.DragMove,coordinates:We})},onEnd:Yt(et.DragEnd),onCancel:Yt(et.DragCancel)});Bt.current=wt;function Yt(We){return async function(){const{active:Rt,collisions:Gt,over:wn,scrollAdjustedTranslate:Cn}=yt.current;let an=null;if(Rt&&Cn){const{cancelDrop:Qn}=ae.current;an={activatorEvent:pt,active:Rt,collisions:Gt,delta:Cn,over:wn},We===et.DragEnd&&typeof Qn=="function"&&await Promise.resolve(Qn(an))&&(We=et.DragCancel)}He.current=null,ki.unstable_batchedUpdates(()=>{B({type:We}),V(ma.Uninitialized),Zi(null),_(null),$(null),Bt.current=null;const Qn=We===et.DragEnd?"onDragEnd":"onDragCancel";if(an){const Xt=ae.current[Qn];Xt==null||Xt(an),X({type:Qn,event:an})}})}}},[J]),kr=N.useCallback((Xe,Ve)=>(tt,xt)=>{const St=tt.nativeEvent,pt=J.get(xt);if(He.current!==null||!pt||St.dndKit||St.defaultPrevented)return;const wt={active:pt};Xe(tt,Ve.options,wt)===!0&&(St.dndKit={capturedBy:Ve.sensor},He.current=xt,ft(tt,Ve))},[J,ft]),Ki=M1(y,kr);G1(y),on(()=>{ye&&I===ma.Initializing&&V(ma.Initialized)},[ye,I]),N.useEffect(()=>{const{onDragMove:Xe}=ae.current,{active:Ve,activatorEvent:tt,collisions:xt,over:St}=yt.current;if(!Ve||!tt)return;const pt={active:Ve,activatorEvent:tt,collisions:xt,delta:{x:Sn.x,y:Sn.y},over:St};ki.unstable_batchedUpdates(()=>{Xe==null||Xe(pt),X({type:"onDragMove",event:pt})})},[Sn.x,Sn.y]),N.useEffect(()=>{const{active:Xe,activatorEvent:Ve,collisions:tt,droppableContainers:xt,scrollAdjustedTranslate:St}=yt.current;if(!Xe||He.current==null||!Ve||!St)return;const{onDragOver:pt}=ae.current,wt=xt.get(Ml),Yt=wt&&wt.rect.current?{id:wt.id,rect:wt.rect.current,data:wt.data,disabled:wt.disabled}:null,We={active:Xe,activatorEvent:Ve,collisions:tt,delta:{x:St.x,y:St.y},over:Yt};ki.unstable_batchedUpdates(()=>{Zi(Yt),pt==null||pt(We),X({type:"onDragOver",event:We})})},[Ml]),on(()=>{yt.current={activatorEvent:q,active:Ge,activeNode:te,collisionRect:tn,collisions:ya,droppableRects:Z,draggableNodes:J,draggingNode:dn,draggingNodeRect:fn,droppableContainers:de,over:pn,scrollableAncestors:Ht,scrollAdjustedTranslate:Sn},me.current={initial:fn,translated:tn}},[Ge,te,ya,tn,J,dn,fn,Z,de,pn,Ht,Sn]),R1({...Ue,delta:ee,draggingRect:tn,pointerCoordinates:Vi,scrollableAncestors:Ht,scrollableAncestorRects:Vn});const Rr=N.useMemo(()=>({active:Ge,activeNode:te,activeNodeRect:ye,activatorEvent:q,collisions:ya,containerNodeRect:un,dragOverlay:it,draggableNodes:J,droppableContainers:de,droppableRects:Z,over:pn,measureDroppableContainers:F,scrollableAncestors:Ht,scrollableAncestorRects:Vn,measuringConfiguration:j,measuringScheduled:le,windowRect:va}),[Ge,te,ye,q,ya,un,it,J,de,Z,pn,F,Ht,Vn,j,le,va]),Ya=N.useMemo(()=>({activatorEvent:q,activators:Ki,active:Ge,activeNodeRect:ye,ariaDescribedById:{draggable:se},dispatch:B,draggableNodes:J,over:pn,measureDroppableContainers:F}),[q,Ki,Ge,ye,B,se,J,pn,F]);return qe.createElement(Yg.Provider,{value:K},qe.createElement(Gi.Provider,{value:Ya},qe.createElement(nm.Provider,{value:Rr},qe.createElement(Dr.Provider,{value:gt},b)),qe.createElement(F1,{disabled:(h==null?void 0:h.restoreFocus)===!1})),qe.createElement(Wy,{...h,hiddenTextDescribedById:se}));function Ga(){const Xe=(Fe==null?void 0:Fe.autoScrollEnabled)===!1,Ve=typeof g=="object"?g.enabled===!1:g===!1,tt=G&&!Xe&&!Ve;return typeof g=="object"?{...g,enabled:tt}:{enabled:tt}}}),tx=N.createContext(null),sg="button",nx="Draggable";function ax(o){let{id:l,data:i,disabled:s=!1,attributes:u}=o;const d=Yi(nx),{activators:f,activatorEvent:h,active:g,activeNodeRect:b,ariaDescribedById:y,draggableNodes:x,over:E}=N.useContext(Gi),{role:D=sg,roleDescription:M="draggable",tabIndex:z=0}=u??{},Q=(g==null?void 0:g.id)===l,B=N.useContext(Q?Dr:tx),[X,K]=gr(),[I,V]=gr(),G=X1(f,l),Y=_i(i);on(()=>(x.set(l,{id:l,key:d,node:X,activatorNode:I,data:Y}),()=>{const ee=x.get(l);ee&&ee.key===d&&x.delete(l)}),[x,l]);const J=N.useMemo(()=>({role:D,tabIndex:z,"aria-disabled":s,"aria-pressed":Q&&D===sg?!0:void 0,"aria-roledescription":M,"aria-describedby":y.draggable}),[s,D,z,Q,M,y.draggable]);return{active:g,activatorEvent:h,activeNodeRect:b,attributes:J,isDragging:Q,listeners:s?void 0:G,node:X,over:E,setNodeRef:K,setActivatorNodeRef:V,transform:B}}function lm(){return N.useContext(nm)}const lx="Droppable",ix={timeout:25};function sx(o){let{data:l,disabled:i=!1,id:s,resizeObserverConfig:u}=o;const d=Yi(lx),{active:f,dispatch:h,over:g,measureDroppableContainers:b}=N.useContext(Gi),y=N.useRef({disabled:i}),x=N.useRef(!1),E=N.useRef(null),D=N.useRef(null),{disabled:M,updateMeasurementsFor:z,timeout:Q}={...ix,...u},B=_i(z??s),X=N.useCallback(()=>{if(!x.current){x.current=!0;return}D.current!=null&&clearTimeout(D.current),D.current=setTimeout(()=>{b(Array.isArray(B.current)?B.current:[B.current]),D.current=null},Q)},[Q]),K=Er({callback:X,disabled:M||!f}),I=N.useCallback((J,ee)=>{K&&(ee&&(K.unobserve(ee),x.current=!1),J&&K.observe(J))},[K]),[V,G]=gr(I),Y=_i(l);return N.useEffect(()=>{!K||!V.current||(K.disconnect(),x.current=!1,K.observe(V.current))},[V,K]),N.useEffect(()=>(h({type:et.RegisterDroppable,element:{id:s,key:d,disabled:i,node:V,rect:E,data:Y}}),()=>h({type:et.UnregisterDroppable,key:d,id:s})),[s]),N.useEffect(()=>{i!==y.current.disabled&&(h({type:et.SetDroppableDisabled,id:s,key:d,disabled:i}),y.current.disabled=i)},[s,d,i,h]),{active:f,rect:E,isOver:(g==null?void 0:g.id)===s,node:V,over:g,setNodeRef:G}}function rx(o){let{animation:l,children:i}=o;const[s,u]=N.useState(null),[d,f]=N.useState(null),h=mr(i);return!i&&!s&&h&&u(h),on(()=>{if(!d)return;const g=s==null?void 0:s.key,b=s==null?void 0:s.props.id;if(g==null||b==null){u(null);return}Promise.resolve(l(b,d)).then(()=>{u(null)})},[l,s,d]),qe.createElement(qe.Fragment,null,i,s?N.cloneElement(s,{ref:f}):null)}const ox={x:0,y:0,scaleX:1,scaleY:1};function cx(o){let{children:l}=o;return qe.createElement(Gi.Provider,{value:tm},qe.createElement(Dr.Provider,{value:ox},l))}const ux={position:"fixed",touchAction:"none"},dx=o=>Tr(o)?"transform 250ms ease":void 0,fx=N.forwardRef((o,l)=>{let{as:i,activatorEvent:s,adjustScale:u,children:d,className:f,rect:h,style:g,transform:b,transition:y=dx}=o;if(!h)return null;const x=u?b:{...b,scaleX:1,scaleY:1},E={...ux,width:h.width,height:h.height,top:h.top,left:h.left,transform:ba.Transform.toString(x),transformOrigin:u&&s?n1(s,h):void 0,transition:typeof y=="function"?y(s):y,...g};return qe.createElement(i,{className:f,style:E,ref:l},d)}),px=o=>l=>{let{active:i,dragOverlay:s}=l;const u={},{styles:d,className:f}=o;if(d!=null&&d.active)for(const[h,g]of Object.entries(d.active))g!==void 0&&(u[h]=i.node.style.getPropertyValue(h),i.node.style.setProperty(h,g));if(d!=null&&d.dragOverlay)for(const[h,g]of Object.entries(d.dragOverlay))g!==void 0&&s.node.style.setProperty(h,g);return f!=null&&f.active&&i.node.classList.add(f.active),f!=null&&f.dragOverlay&&s.node.classList.add(f.dragOverlay),function(){for(const[g,b]of Object.entries(u))i.node.style.setProperty(g,b);f!=null&&f.active&&i.node.classList.remove(f.active)}},hx=o=>{let{transform:{initial:l,final:i}}=o;return[{transform:ba.Transform.toString(l)},{transform:ba.Transform.toString(i)}]},gx={duration:250,easing:"ease",keyframes:hx,sideEffects:px({styles:{active:{opacity:"0"}}})};function mx(o){let{config:l,draggableNodes:i,droppableContainers:s,measuringConfiguration:u}=o;return Nr((d,f)=>{if(l===null)return;const h=i.get(d);if(!h)return;const g=h.node.current;if(!g)return;const b=em(f);if(!b)return;const{transform:y}=vt(f).getComputedStyle(f),x=Xg(y);if(!x)return;const E=typeof l=="function"?l:bx(l);return $g(g,u.draggable.measure),E({active:{id:d,data:h.data,node:g,rect:u.draggable.measure(g)},draggableNodes:i,dragOverlay:{node:f,rect:u.dragOverlay.measure(b)},droppableContainers:s,measuringConfiguration:u,transform:x})})}function bx(o){const{duration:l,easing:i,sideEffects:s,keyframes:u}={...gx,...o};return d=>{let{active:f,dragOverlay:h,transform:g,...b}=d;if(!l)return;const y={x:h.rect.left-f.rect.left,y:h.rect.top-f.rect.top},x={scaleX:g.scaleX!==1?f.rect.width*g.scaleX/h.rect.width:1,scaleY:g.scaleY!==1?f.rect.height*g.scaleY/h.rect.height:1},E={x:g.x-y.x,y:g.y-y.y,...x},D=u({...b,active:f,dragOverlay:h,transform:{initial:g,final:E}}),[M]=D,z=D[D.length-1];if(JSON.stringify(M)===JSON.stringify(z))return;const Q=s==null?void 0:s({active:f,dragOverlay:h,...b}),B=h.node.animate(D,{duration:l,easing:i,fill:"forwards"});return new Promise(X=>{B.onfinish=()=>{Q==null||Q(),X()}})}}let rg=0;function vx(o){return N.useMemo(()=>{if(o!=null)return rg++,rg},[o])}const yx=qe.memo(o=>{let{adjustScale:l=!1,children:i,dropAnimation:s,style:u,transition:d,modifiers:f,wrapperElement:h="div",className:g,zIndex:b=999}=o;const{activatorEvent:y,active:x,activeNodeRect:E,containerNodeRect:D,draggableNodes:M,droppableContainers:z,dragOverlay:Q,over:B,measuringConfiguration:X,scrollableAncestors:K,scrollableAncestorRects:I,windowRect:V}=lm(),G=N.useContext(Dr),Y=vx(x==null?void 0:x.id),J=am(f,{activatorEvent:y,active:x,activeNodeRect:E,containerNodeRect:D,draggingNodeRect:Q.rect,over:B,overlayNodeRect:Q.rect,scrollableAncestors:K,scrollableAncestorRects:I,transform:G,windowRect:V}),ee=Au(E),de=mx({config:s,draggableNodes:M,droppableContainers:z,measuringConfiguration:X}),re=ee?Q.setRef:void 0;return qe.createElement(cx,null,qe.createElement(rx,{animation:de},x&&Y?qe.createElement(fx,{key:Y,id:x.id,ref:re,as:h,activatorEvent:y,adjustScale:l,className:g,transition:d,rect:ee,style:{zIndex:b,...u},transform:J},i):null))});function im(o,l,i){const s=o.slice();return s.splice(i<0?s.length+i:i,0,s.splice(l,1)[0]),s}function xx(o,l){return o.reduce((i,s,u)=>{const d=l.get(s);return d&&(i[u]=d),i},Array(o.length))}function or(o){return o!==null&&o>=0}function Sx(o,l){if(o===l)return!0;if(o.length!==l.length)return!1;for(let i=0;i<o.length;i++)if(o[i]!==l[i])return!1;return!0}function wx(o){return typeof o=="boolean"?{draggable:o,droppable:o}:o}const sm=o=>{let{rects:l,activeIndex:i,overIndex:s,index:u}=o;const d=im(l,s,i),f=l[u],h=d[u];return!h||!f?null:{x:h.left-f.left,y:h.top-f.top,scaleX:h.width/f.width,scaleY:h.height/f.height}},cr={scaleX:1,scaleY:1},Cx=o=>{var l;let{activeIndex:i,activeNodeRect:s,index:u,rects:d,overIndex:f}=o;const h=(l=d[i])!=null?l:s;if(!h)return null;if(u===i){const b=d[f];return b?{x:0,y:i<f?b.top+b.height-(h.top+h.height):b.top-h.top,...cr}:null}const g=Nx(d,u,i);return u>i&&u<=f?{x:0,y:-h.height-g,...cr}:u<i&&u>=f?{x:0,y:h.height+g,...cr}:{x:0,y:0,...cr}};function Nx(o,l,i){const s=o[l],u=o[l-1],d=o[l+1];return s?i<l?u?s.top-(u.top+u.height):d?d.top-(s.top+s.height):0:d?d.top-(s.top+s.height):u?s.top-(u.top+u.height):0:0}const rm="Sortable",om=qe.createContext({activeIndex:-1,containerId:rm,disableTransforms:!1,items:[],overIndex:-1,useDragOverlay:!1,sortedRects:[],strategy:sm,disabled:{draggable:!1,droppable:!1}});function Tx(o){let{children:l,id:i,items:s,strategy:u=sm,disabled:d=!1}=o;const{active:f,dragOverlay:h,droppableRects:g,over:b,measureDroppableContainers:y}=lm(),x=Yi(rm,i),E=h.rect!==null,D=N.useMemo(()=>s.map(G=>typeof G=="object"&&"id"in G?G.id:G),[s]),M=f!=null,z=f?D.indexOf(f.id):-1,Q=b?D.indexOf(b.id):-1,B=N.useRef(D),X=!Sx(D,B.current),K=Q!==-1&&z===-1||X,I=wx(d);on(()=>{X&&M&&y(D)},[X,D,M,y]),N.useEffect(()=>{B.current=D},[D]);const V=N.useMemo(()=>({activeIndex:z,containerId:x,disabled:I,disableTransforms:K,items:D,overIndex:Q,useDragOverlay:E,sortedRects:xx(D,g),strategy:u}),[z,x,I.draggable,I.droppable,K,D,Q,g,E,u]);return qe.createElement(om.Provider,{value:V},l)}const Ex=o=>{let{id:l,items:i,activeIndex:s,overIndex:u}=o;return im(i,s,u).indexOf(l)},Dx=o=>{let{containerId:l,isSorting:i,wasDragging:s,index:u,items:d,newIndex:f,previousItems:h,previousContainerId:g,transition:b}=o;return!b||!s||h!==d&&u===f?!1:i?!0:f!==u&&l===g},Ax={duration:200,easing:"ease"},cm="transform",kx=ba.Transition.toString({property:cm,duration:0,easing:"linear"}),Rx={roleDescription:"sortable"};function Ox(o){let{disabled:l,index:i,node:s,rect:u}=o;const[d,f]=N.useState(null),h=N.useRef(i);return on(()=>{if(!l&&i!==h.current&&s.current){const g=u.current;if(g){const b=zl(s.current,{ignoreTransform:!0}),y={x:g.left-b.left,y:g.top-b.top,scaleX:g.width/b.width,scaleY:g.height/b.height};(y.x||y.y)&&f(y)}}i!==h.current&&(h.current=i)},[l,i,s,u]),N.useEffect(()=>{d&&f(null)},[d]),d}function zx(o){let{animateLayoutChanges:l=Dx,attributes:i,disabled:s,data:u,getNewIndex:d=Ex,id:f,strategy:h,resizeObserverConfig:g,transition:b=Ax}=o;const{items:y,containerId:x,activeIndex:E,disabled:D,disableTransforms:M,sortedRects:z,overIndex:Q,useDragOverlay:B,strategy:X}=N.useContext(om),K=jx(s,D),I=y.indexOf(f),V=N.useMemo(()=>({sortable:{containerId:x,index:I,items:y},...u}),[x,u,I,y]),G=N.useMemo(()=>y.slice(y.indexOf(f)),[y,f]),{rect:Y,node:J,isOver:ee,setNodeRef:de}=sx({id:f,data:V,disabled:K.droppable,resizeObserverConfig:{updateMeasurementsFor:G,...g}}),{active:re,activatorEvent:me,activeNodeRect:Ge,attributes:He,setNodeRef:Fe,listeners:_,isDragging:q,over:$,setActivatorNodeRef:ae,transform:se}=ax({id:f,data:V,attributes:{...Rx,...i},disabled:K.draggable}),w=Hy(de,Fe),j=!!re,Z=j&&!M&&or(E)&&or(Q),F=!B&&q,le=F&&Z?se:null,be=Z?le??(h??X)({rects:z,activeNodeRect:Ge,activeIndex:E,overIndex:Q,index:I}):null,Ue=or(E)&&or(Q)?d({id:f,items:y,activeIndex:E,overIndex:Q}):I,we=re==null?void 0:re.id,ye=N.useRef({activeId:we,items:y,newIndex:Ue,containerId:x}),un=y!==ye.current.items,yt=l({active:re,containerId:x,isDragging:q,isSorting:j,id:f,index:I,items:y,newIndex:ye.current.newIndex,previousItems:ye.current.items,previousContainerId:ye.current.containerId,transition:b,wasDragging:ye.current.activeId!=null}),xn=Ox({disabled:!yt,index:I,node:J,rect:Y});return N.useEffect(()=>{j&&ye.current.newIndex!==Ue&&(ye.current.newIndex=Ue),x!==ye.current.containerId&&(ye.current.containerId=x),y!==ye.current.items&&(ye.current.items=y)},[j,Ue,x,y]),N.useEffect(()=>{if(we===ye.current.activeId)return;if(we!=null&&ye.current.activeId==null){ye.current.activeId=we;return}const dn=setTimeout(()=>{ye.current.activeId=we},50);return()=>clearTimeout(dn)},[we]),{active:re,activeIndex:E,attributes:He,data:V,rect:Y,index:I,newIndex:Ue,items:y,isOver:ee,isSorting:j,isDragging:q,listeners:_,node:J,overIndex:Q,over:$,setNodeRef:w,setActivatorNodeRef:ae,setDroppableNodeRef:de,setDraggableNodeRef:Fe,transform:xn??be,transition:it()};function it(){if(xn||un&&ye.current.newIndex===I)return kx;if(!(F&&!Tr(me)||!b)&&(j||yt))return ba.Transition.toString({...b,property:cm})}}function jx(o,l){var i,s;return typeof o=="boolean"?{draggable:o,droppable:!1}:{draggable:(i=o==null?void 0:o.draggable)!=null?i:l.draggable,droppable:(s=o==null?void 0:o.droppable)!=null?s:l.droppable}}Ne.Down,Ne.Right,Ne.Up,Ne.Left;function Mx({prd:o,projectId:l,onClose:i,onSave:s}){const[u,d]=N.useState((o==null?void 0:o.title)??""),[f,h]=N.useState((o==null?void 0:o.content)??""),g=N.useRef();function b(x){const E=x.target.files[0];if(!E)return;const D=E.name.replace(/\.md$/i,"").replace(/[-_]/g," "),M=new FileReader;M.onload=z=>{u||d(D),h(z.target.result)},M.readAsText(E)}function y(){const x=u.trim();x&&s({title:x,content:f})}return v.jsx("div",{className:"prd-editor-scrim",onClick:x=>x.target===x.currentTarget&&i(),children:v.jsxs("div",{className:"prd-editor-modal",children:[v.jsxs("div",{className:"prd-editor-header",children:[v.jsx("span",{className:"prd-editor-title",children:o?"Edit PRD":"New PRD"}),v.jsx("button",{className:"prd-editor-close",onClick:i,children:"✕"})]}),v.jsxs("div",{className:"prd-editor-body",children:[v.jsxs("div",{className:"prd-editor-field",children:[v.jsx("label",{className:"prd-editor-label",children:"Title"}),v.jsx("input",{className:"prd-editor-input",type:"text",placeholder:"e.g. Producer Filter Modal",value:u,onChange:x=>d(x.target.value),autoFocus:!0})]}),v.jsxs("div",{className:"prd-editor-field prd-editor-field--grow",children:[v.jsxs("div",{className:"prd-editor-label-row",children:[v.jsx("label",{className:"prd-editor-label",children:"Content"}),v.jsx("button",{className:"prd-editor-load-file",onClick:()=>g.current.click(),children:"Load from .md file"}),v.jsx("input",{ref:g,type:"file",accept:".md,.txt",style:{display:"none"},onChange:b})]}),v.jsx("textarea",{className:"prd-editor-textarea",placeholder:"Paste your PRD markdown here…",value:f,onChange:x=>h(x.target.value)})]})]}),v.jsxs("div",{className:"prd-editor-footer",children:[v.jsx("button",{className:"prd-editor-btn prd-editor-btn--cancel",onClick:i,children:"Cancel"}),v.jsx("button",{className:"prd-editor-btn prd-editor-btn--save",onClick:y,disabled:!u.trim(),children:o?"Save changes":"Create PRD"})]})]})})}function um(o){const l=Math.floor((Date.now()-new Date(o))/6e4);if(l<1)return"just now";if(l<60)return`${l}m ago`;const i=Math.floor(l/60);return i<24?`${i}h ago`:`${Math.floor(i/24)}d ago`}function _x({status:o}){return v.jsx("span",{className:`prd-status prd-status--${o}`,children:Lg[o]})}function Ux({prd:o,onEdit:l,onDelete:i,onOpen:s,isDragging:u}){const{attributes:d,listeners:f,setNodeRef:h,transform:g,transition:b}=zx({id:o.id}),y={transform:ba.Transform.toString(g),transition:b,opacity:u?.4:1};return v.jsxs("div",{ref:h,style:y,className:"kanban-card",...d,...f,children:[v.jsx("div",{className:"kanban-card-title",children:o.title}),v.jsx("div",{className:"kanban-card-meta",children:um(o.updatedAt)}),v.jsxs("div",{className:"kanban-card-actions",onPointerDown:x=>x.stopPropagation(),children:[v.jsx("button",{className:"kanban-card-btn",onClick:()=>s(o),children:"Open →"}),v.jsx("button",{className:"kanban-card-btn",onClick:()=>l(o),children:"Edit"}),v.jsx("button",{className:"kanban-card-btn kanban-card-btn--danger",onClick:()=>i(o.id),children:"Delete"})]})]})}function Lx({status:o,prds:l,onEdit:i,onDelete:s,onOpen:u,activeId:d}){return v.jsxs("div",{className:"kanban-col",children:[v.jsxs("div",{className:"kanban-col-header",children:[v.jsx("span",{className:"kanban-col-title",children:Lg[o]}),v.jsx("span",{className:"kanban-col-count",children:l.length})]}),v.jsx(Tx,{items:l.map(f=>f.id),strategy:Cx,children:v.jsxs("div",{className:"kanban-col-cards",children:[l.map(f=>v.jsx(Ux,{prd:f,onEdit:i,onDelete:s,onOpen:u,isDragging:d===f.id},f.id)),l.length===0&&v.jsx("div",{className:"kanban-col-empty",children:"Drop here"})]})})]})}function qx({projectId:o,prds:l,onNavigate:i,onCreatePrd:s,onUpdatePrd:u,onDeletePrd:d}){const f=qg(o),h=l.filter(V=>V.projectId===o),[g,b]=N.useState("kanban"),[y,x]=N.useState(!1),[E,D]=N.useState(null),[M,z]=N.useState(null),Q=e1(Py(Du,{activationConstraint:{distance:6}}));function B({active:V}){z(V.id)}function X({active:V,over:G}){if(z(null),!G||V.id===G.id)return;const Y=h.find(de=>de.id===V.id);if(!Y)return;const J=h.find(de=>de.id===G.id),ee=J?J.status:G.id;Kh.includes(ee)&&Y.status!==ee&&u(V.id,{status:ee})}function K({active:V,over:G}){if(!G)return;const Y=h.find(ee=>ee.id===V.id),J=h.find(ee=>ee.id===G.id);!Y||!J||Y.status!==J.status&&u(V.id,{status:J.status})}const I=M?h.find(V=>V.id===M):null;return v.jsxs("div",{className:"project-view",children:[v.jsxs("header",{className:"project-view-header",children:[v.jsx("button",{className:"project-back-btn",onClick:()=>i({page:"projects"}),children:"← Projects"}),v.jsxs("div",{className:"project-view-title",children:[v.jsx("span",{className:"project-view-icon",children:f==null?void 0:f.icon}),v.jsx("span",{className:"project-view-name",children:f==null?void 0:f.name})]}),v.jsxs("div",{className:"project-view-actions",children:[v.jsxs("div",{className:"view-toggle",children:[v.jsx("button",{className:`view-toggle-btn ${g==="list"?"active":""}`,onClick:()=>b("list"),children:"List"}),v.jsx("button",{className:`view-toggle-btn ${g==="kanban"?"active":""}`,onClick:()=>b("kanban"),children:"Kanban"})]}),v.jsx("button",{className:"new-prd-btn",onClick:()=>{D(null),x(!0)},children:"+ New PRD"})]})]}),v.jsx("div",{className:"project-view-body",children:g==="list"?v.jsx("div",{className:"prd-list",children:h.length===0?v.jsx("div",{className:"prd-list-empty",children:"No PRDs yet — create one to get started."}):v.jsxs("table",{className:"prd-table",children:[v.jsx("thead",{children:v.jsxs("tr",{children:[v.jsx("th",{children:"Title"}),v.jsx("th",{children:"Status"}),v.jsx("th",{children:"Updated"}),v.jsx("th",{})]})}),v.jsx("tbody",{children:h.map(V=>v.jsxs("tr",{children:[v.jsx("td",{className:"prd-table-title",children:V.title}),v.jsx("td",{children:v.jsx(_x,{status:V.status})}),v.jsx("td",{className:"prd-table-date",children:um(V.updatedAt)}),v.jsxs("td",{className:"prd-table-actions",children:[v.jsx("button",{className:"prd-action-btn",onClick:()=>i({page:"builder",prdId:V.id}),children:"Open →"}),v.jsx("button",{className:"prd-action-btn",onClick:()=>{D(V),x(!0)},children:"Edit"}),v.jsx("button",{className:"prd-action-btn prd-action-btn--danger",onClick:()=>d(V.id),children:"Delete"})]})]},V.id))})]})}):v.jsxs(ex,{sensors:Q,collisionDetection:s1,onDragStart:B,onDragOver:K,onDragEnd:X,children:[v.jsx("div",{className:"kanban-board",children:Kh.map(V=>v.jsx(Lx,{status:V,prds:h.filter(G=>G.status===V),onEdit:G=>{D(G),x(!0)},onDelete:G=>d(G),onOpen:G=>i({page:"builder",prdId:G.id}),activeId:M},V))}),v.jsx(yx,{children:I?v.jsx("div",{className:"kanban-card kanban-card--overlay",children:v.jsx("div",{className:"kanban-card-title",children:I.title})}):null})]})}),y&&v.jsx(Mx,{prd:E,projectId:o,onClose:()=>x(!1),onSave:V=>{E?u(E.id,V):s(o,V),x(!1)}})]})}const dm=o=>`ennabl_bs_${o}`;function fm(o){try{return JSON.parse(localStorage.getItem(dm(o)))||{}}catch{return{}}}function og(o,l){try{const i=fm(o);localStorage.setItem(dm(o),JSON.stringify({...i,...l}))}catch{}}function Hx(){const[o,l]=N.useState(()=>!!Ng()),[i,s]=N.useState(Zh),[u,d]=N.useState(!1),[f,h]=N.useState({page:"projects"}),[g,b]=N.useState([]),[y,x]=N.useState(!1),[E,D]=N.useState(null),[M,z]=N.useState(null),[Q,B]=N.useState([]),[X,K]=N.useState(null),[I,V]=N.useState(kv),[G,Y]=N.useState(0),J=i&&!u;N.useEffect(()=>{if(!o||!i&&!u)return;async function q(){if(J)try{const $=await Oy();b($)}catch{Ih(),b(iu())}else Ih(),b(iu());x(!0)}q()},[o,i,u]);function ee(q){if(q.page==="builder"&&q.prdId){const $=g.find(ae=>ae.id===q.prdId);$&&de($)}h(q)}function de(q){const $=fm(q.id);D({id:q.id,name:q.title,content:q.content}),B($.messages||[]),z($.code||null),K(Jv(q.title))}N.useEffect(()=>{E!=null&&E.id&&og(E.id,{messages:Q})},[Q,E==null?void 0:E.id]),N.useEffect(()=>{E!=null&&E.id&&M&&og(E.id,{code:M})},[M,E==null?void 0:E.id]);async function re(q,$){if(J){const ae=await zy({projectId:q,...$});b(se=>[ae,...se])}else{const ae={id:`prd-${Date.now()}`,projectId:q,status:"backlog",createdAt:new Date().toISOString(),updatedAt:new Date().toISOString(),...$};b(se=>{const w=[ae,...se];return ur(w),w})}}async function me(q,$){if(J){const ae=await jy(q,{...$,updated:new Date().toISOString()});b(se=>se.map(w=>w.id===q?ae:w))}else b(ae=>{const se=ae.map(w=>w.id===q?{...w,...$,updatedAt:new Date().toISOString()}:w);return ur(se),se})}async function Ge(q){J&&await My(q),b($=>{const ae=$.filter(se=>se.id!==q);return J||ur(ae),ae})}function He(q,$){if(z(q),E){const se=[Rv({prdName:E.name,code:q,iteration:((X==null?void 0:X.iterations)??0)+1}),...I].slice(0,50);if(V(se),Lh(se),$){const j=`**${new Date().toISOString().slice(0,10)} · iter ${((X==null?void 0:X.iterations)??0)+1}:** ${$}`,Z=g.find(te=>te.id===E.id),F=(Z==null?void 0:Z.content)||E.content||"",le=F.includes("## Build log")?F+`
`+j:F+`

## Build log

`+j;me(E.id,{content:le}),D(te=>te&&{...te,content:le})}}}function Fe({inputTokens:q,outputTokens:$,cacheReadTokens:ae,componentsUsed:se}){K(w=>{if(!w)return w;const j={...w,iterations:w.iterations+1,inputTokens:w.inputTokens+q,outputTokens:w.outputTokens+$,cacheReadTokens:w.cacheReadTokens+ae,componentsUsed:[...new Set([...w.componentsUsed,...se])]};return j.cost=Iv(j),nu(j),j})}function _(){V([]),Lh([])}return o?!i&&!u?v.jsx(_y,{onDone:()=>{Zh()?s(!0):d(!0)}}):y?f.page==="projects"?v.jsx(qy,{prds:g,onNavigate:ee}):f.page==="project"?v.jsx(qx,{projectId:f.projectId,prds:g,onNavigate:ee,onCreatePrd:re,onUpdatePrd:me,onDeletePrd:Ge}):v.jsxs("div",{className:"app",children:[v.jsxs("header",{className:"app-header",children:[v.jsxs("div",{className:"app-header-left",children:[v.jsx("button",{className:"app-back-btn",onClick:()=>ee({page:"projects"}),children:"← Projects"}),v.jsx("span",{className:"app-header-sep"}),v.jsx("span",{className:"app-logo",children:"ennabl"}),v.jsx("span",{className:"app-logo-suffix",children:"builder"}),E&&v.jsx("span",{className:"app-prd-badge",children:E.name})]}),v.jsx(Ly,{prds:g,onSelect:de})]}),v.jsxs("main",{className:"app-panels",children:[v.jsx(Uv,{code:M,prd:E,history:I,onHistoryClear:_,onInitDesign:()=>Y(q=>q+1)}),v.jsx("div",{className:"app-divider"}),v.jsx(uy,{prd:E,messages:Q,setMessages:B,onCodeGenerated:He,onIterationComplete:Fe,session:X,onSessionUpdate:K,initTrigger:G})]})]}):v.jsx("div",{style:{height:"100dvh",display:"flex",alignItems:"center",justifyContent:"center",background:"var(--bg)",color:"var(--text-muted)",fontSize:13},children:"Loading…"}):v.jsx(dy,{onDone:()=>l(!0)})}U0.createRoot(document.getElementById("root")).render(v.jsx(N.StrictMode,{children:v.jsx(Hx,{})}));
