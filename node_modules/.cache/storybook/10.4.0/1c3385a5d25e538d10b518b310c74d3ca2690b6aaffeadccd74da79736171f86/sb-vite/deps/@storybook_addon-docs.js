import { pt as __export, yt as definePreviewAddon10 } from "./blocks-3rOHsXmE.js";
import { t as DocsRenderer } from "./chunk-OATZR77O-BueOJYHf.js";
...
var excludeTags = Object.entries(globalThis.TAGS_OPTIONS ?? {}).reduce((acc, entry) => {
	...
	renderer: async () => {
		let { DocsRenderer } = await import("./DocsRenderer-LL677BLK-BcVCLX1A.js");
